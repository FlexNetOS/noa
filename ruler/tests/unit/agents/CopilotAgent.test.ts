...
describe( 'CopilotAgent', () =>
{
  ...
  it( 'should implement IAgent interface', () =>
  {
    ...
    expect( typeof agent.applyRulerconfigs ).toBe( 'function' );
  } );
  ...
  it( 'creates backups for AGENTS.md when it exists', async () =>
  {
    ...
    try
    {
      ...
      await agent.applyRulerconfigs( rules, projectRoot, null, undefined, true );
  ...
  it( 'respects --no-backup flag for AGENTS.md', async () =>
  {
    ...
    try
    {
      ...
      await agent.applyRulerconfigs( rules, projectRoot, null, undefined, false );
