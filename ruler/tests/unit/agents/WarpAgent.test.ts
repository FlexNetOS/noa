...
describe( 'WarpAgent', () =>
{
  ...
  it( 'should apply ruler configs to the default output path', async () =>
  {
    ...
    await agent.applyRulerconfigs( 'rules', base, null );
  ...
  it( 'should apply ruler configs to custom output path', async () =>
  {
    const backupFile = jest.spyOn( FileSystemUtils, 'backupFile' );
    const writeGeneratedFile = jest.spyOn(
      FileSystemUtils,
    ...
    await agent.applyRulerconfigs( 'rules', base, null, { outputPath: 'CUSTOM.md' } );
  ...
  describe( 'integration with backup and revert functionality', () =>
  {
    ...
    it( 'should create backup when overwriting existing WARP.md file', async () =>
    {
      ...
      await realAgent.applyRulerconfigs( newContent, tmpDir, null );
    ...
    it( 'should be properly reverted by revertAllAgentconfigss', async () =>
    {
      ...
      // Apply rules first
      await realAgent.applyRulerconfigs( rules, tmpDir, null );
