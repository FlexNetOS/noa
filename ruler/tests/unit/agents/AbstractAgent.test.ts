...
describe( 'AbstractAgent', () =>
{
  ...
  describe( 'applyRulerconfigs', () =>
  {
    ...
    it( 'creates parent directory if it does not exist', async () =>
    {
      ...
      await agent.applyRulerconfigs( rules, tmpDir, null, { outputPath: customPath } );
    ...
    it( 'backs up existing file', async () =>
    {
      ...
      await agent.applyRulerconfigs( newRules, tmpDir, null );
    ...
    it( 'resolves relative paths correctly', async () =>
    {
      ...
      await agent.applyRulerconfigs( rules, tmpDir, null, { outputPath: relativePath } );
    ...
    it( 'handles absolute paths correctly', async () =>
    {
      ...
      await agent.applyRulerconfigs( rules, tmpDir, null, { outputPath: absolutePath } );
