...
describe( 'Revert Core Functions', () =>
{
  ...
  describe( 'revertAllAgentconfigss', () =>
  {
    it( 'should throw error when .ruler directory not found', async () =>
    {
      ...
      {
        await expect(
          revertAllAgentconfigss( emptyDir, undefined, undefined, false, false, false, true ),
    ...
    it( 'should handle dry-run mode correctly', async () =>
    {
      ...
      await revertAllAgentconfigss( tmpDir, undefined, undefined, false, false, true );
    ...
    it( 'should handle verbose logging', async () =>
    {
      ...
      await revertAllAgentconfigss( tmpDir, undefined, undefined, false, true, false );
    ...
    it( 'should handle specific agents filter', async () =>
    {
      ...
      await revertAllAgentconfigss( tmpDir, [ 'claude' ], undefined, false, false, false );
    ...
    it( 'should handle keep-backups flag', async () =>
    {
      ...
      await revertAllAgentconfigss( tmpDir, undefined, undefined, true, false, false );
    ...
    it( 'should remove backup files when keep-backups is false', async () =>
    {
      ...
      await revertAllAgentconfigss( tmpDir, undefined, undefined, false, false, false );
  ...
  describe( 'dry-run logging patterns', () =>
  {
    ...
    it( 'should use [ruler:dry-run] prefix consistently when dryRun is true', async () =>
    {
      ...
      await revertAllAgentconfigss( tmpDir, undefined, undefined, false, false, true ); // dryRun=true
    ...
    it( 'should use [ruler] prefix consistently when dryRun is false', async () =>
    {
      ...
      await revertAllAgentconfigss( tmpDir, undefined, undefined, false, false, false ); // dryRun=false
