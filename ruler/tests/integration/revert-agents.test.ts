...
describe( 'Revert Agent Integration', () =>
{
  ...
  describe( 'Agent-Specific Revert', () =>
  {
    ...
    it( 'should revert multiple specific agents', async () =>
    {
      ...
      await revertAllAgentconfigss( tmpDir, [ 'claude', 'crush' ], undefined, false, false, false );
    ...
    it( 'should handle agent with multiple output paths (AiderAgent)', async () =>
    {
      ...
      await revertAllAgentconfigss( tmpDir, [ 'aider' ], undefined, false, false, false );
    ...
    it( 'should handle KiloCode agent files and directories', async () =>
    {
      ...
      await revertAllAgentconfigss( tmpDir, [ 'kilocode' ], undefined, false, false, false );
  ...
  {
    it( 'should handle MCP configsuration files', async () =>
    {
  ...
  describe( 'configsuration Integration', () =>
  {
    it( 'should handle basic configsuration loading', async () =>
    {
      await fs.writeFile( path.join( tmpDir, 'CLAUDE.md' ), 'Claude content' );
