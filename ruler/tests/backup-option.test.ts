...
describe( 'backup option', () =>
{
  ...
  describe( 'agents with custom applyRulerconfigs implementations', () =>
  {
    ...
    it( 'AiderAgent respects --no-backup flag for both AGENTS.md and .aider.conf.yml', async () =>
    {
      ...
      try
      {
        ...
        expect( aiderConfContent ).toContain( 'existing_file.md' ); // Preserved existing configs
      } finally
      {
        await teardownTestProject( testProject.projectRoot );
      }
