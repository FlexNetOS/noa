...
impl Default for UserPreferences {
    fn default() -> Self {
        Self {
            code_style: CodeStyle::Functional,
...
impl ConversationalAI {
    ...
    fn prepare_context(&self, conversation: &Conversation) -> String {
        ...
        // Add system context
        context.push_str("You are NOA UI, an AI assistant that helps users build UIs through conversation. ");
        context.push_str(
            "You can understand UI change requests and generate appropriate code modifications. ",
        );
