...
test_check "minio.yaml exists" "test -f $NOA_ROOT/config/minio.yaml"
test_check "database.yaml exists" "test -f $NOA_ROOT/config/database.yaml"
test_check "qdrant.yaml exists" "test -f $NOA_ROOT/config/qdrant.yaml"
test_check "quickwit.yaml exists" "test -f $NOA_ROOT/config/quickwit.yaml"
...
# CSV schemas
test_check "agent_directory.yaml exists" "test -f $NOA_ROOT/config/schemas/csv/agent_directory.yaml"
test_check "task_tables.yaml exists" "test -f $NOA_ROOT/config/schemas/csv/task_tables.yaml"
test_check "claims_evidence.yaml exists" "test -f $NOA_ROOT/config/schemas/csv/claims_evidence.yaml"
test_check "metrics_traces.yaml exists" "test -f $NOA_ROOT/config/schemas/csv/metrics_traces.yaml"

echo ""
echo "Testing configuration standards (T046-T049)..."
echo ""

test_check "config_schema.json exists" "test -f $NOA_ROOT/config/schemas/config_schema.json"
test_check "validator.rs exists" "test -f $NOA_ROOT/sys/core/src/config/validator.rs"
test_check "lineage.rs exists" "test -f $NOA_ROOT/sys/core/src/config/lineage.rs"
test_check "config templates directory exists" "test -d $NOA_ROOT/config/templates"
...
test_check "config/mod.rs exists" "test -f $NOA_ROOT/sys/core/src/config/mod.rs"
...
test_check "observability.yaml exists" "test -f $NOA_ROOT/config/observability.yaml"
