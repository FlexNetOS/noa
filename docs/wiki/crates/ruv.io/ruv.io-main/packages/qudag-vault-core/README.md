# ⚛️ @deflex.net/qudag-vault-core

> Quantum-resistant password vault library with post-quantum cryptography

[![npm version](https://img.shields.io/npm/v/@deflex.net/qudag-vault-core.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/qudag-vault-core)
[![npm downloads](https://img.shields.io/npm/dm/@deflex.net/qudag-vault-core.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/qudag-vault-core)
[![license](https://img.shields.io/npm/l/@deflex.net/qudag-vault-core.svg?style=flat-square)](https://github.com/flexnetos/deflex.net/blob/main/LICENSE)
...
`@deflex.net/qudag-vault-core` is a high-performance Node.js native addon that provides TypeScript bindings for the [`qudag-vault-core`](https://crates.io/crates/qudag-vault-core) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
- **License**: MIT
- **Rust Crate**: [qudag-vault-core](https://crates.io/crates/qudag-vault-core)
...
```bash
npm install @deflex.net/qudag-vault-core
```

### Using yarn

```bash
yarn add @deflex.net/qudag-vault-core
```

### Using pnpm

```bash
pnpm add @deflex.net/qudag-vault-core
```
...
- **Linux x64**: `@deflex.net/qudag-vault-core-linux-x64-gnu`
- **Linux ARM64**: `@deflex.net/qudag-vault-core-linux-arm64-gnu`
- **macOS x64**: `@deflex.net/qudag-vault-core-darwin-x64`
- **macOS ARM64**: `@deflex.net/qudag-vault-core-darwin-arm64`
- **Windows x64**: `@deflex.net/qudag-vault-core-win32-x64-msvc`
- **WebAssembly**: `@deflex.net/qudag-vault-core-wasm32` (fallback)
...
```typescript
import { QudagVaultCore } from '@deflex.net/qudag-vault-core'

// Create an instance
const client = new QudagVaultCore({
...
```typescript
import { QudagVaultCore, Config } from '@deflex.net/qudag-vault-core'
...
const client = new QudagVaultCore(config)
```
...
// CommonJS
const { QudagVaultCore } = require('@deflex.net/qudag-vault-core')
```
...
try {
  ...
  if (error instanceof QudagVaultCoreError) {
...
Creates a new instance of `QudagVaultCore`.

**Parameters:**
- `config` (optional): Configuration object

**Returns:**
- Instance of `QudagVaultCore`
...
```typescript
class QudagVaultCoreError extends Error {
  code: string
  details?: any
}
```
...
```typescript
import { QudagVaultCore, QudagVaultCoreError } from '@deflex.net/qudag-vault-core'
...
```typescript
import { QudagVaultCore, Config, LogLevel } from '@deflex.net/qudag-vault-core'
...
cd deflex.net/packages/qudag-vault-core
...
- **NPM Package**: [@deflex.net/qudag-vault-core](https://www.npmjs.com/package/@deflex.net/qudag-vault-core)
- **GitHub Repository**: [flexnetos/deflex.net](https://github.com/flexnetos/deflex.net)
- **Rust Crate**: [qudag-vault-core](https://crates.io/crates/qudag-vault-core)
- **Documentation**: [docs.deflex.net/qudag-vault-core](https://docs.deflex.net/qudag-vault-core)
...
- Original crate by the [qudag-vault-core](https://crates.io/crates/qudag-vault-core) authors

---

## 📊 Stats

![NPM](https://nodei.co/npm/@deflex.net/qudag-vault-core.png?downloads=true&downloadRank=true&stars=true)
