# ⏰ @deflex.net/nanosecond-scheduler

> Ultra-low latency nanosecond-precision scheduler for temporal consciousness applications

[![npm version](https://img.shields.io/npm/v/@deflex.net/nanosecond-scheduler.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/nanosecond-scheduler)
[![npm downloads](https://img.shields.io/npm/dm/@deflex.net/nanosecond-scheduler.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/nanosecond-scheduler)
[![license](https://img.shields.io/npm/l/@deflex.net/nanosecond-scheduler.svg?style=flat-square)](https://github.com/flexnetos/deflex.net/blob/main/LICENSE)
...
`@deflex.net/nanosecond-scheduler` is a high-performance Node.js native addon that provides TypeScript bindings for the [`nanosecond-scheduler`](https://crates.io/crates/nanosecond-scheduler) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
- **License**: MIT
- **Rust Crate**: [nanosecond-scheduler](https://crates.io/crates/nanosecond-scheduler)
...
```bash
npm install @deflex.net/nanosecond-scheduler
```

### Using yarn

```bash
yarn add @deflex.net/nanosecond-scheduler
```

### Using pnpm

```bash
pnpm add @deflex.net/nanosecond-scheduler
```
...
- **Linux x64**: `@deflex.net/nanosecond-scheduler-linux-x64-gnu`
- **Linux ARM64**: `@deflex.net/nanosecond-scheduler-linux-arm64-gnu`
- **macOS x64**: `@deflex.net/nanosecond-scheduler-darwin-x64`
- **macOS ARM64**: `@deflex.net/nanosecond-scheduler-darwin-arm64`
- **Windows x64**: `@deflex.net/nanosecond-scheduler-win32-x64-msvc`
- **WebAssembly**: `@deflex.net/nanosecond-scheduler-wasm32` (fallback)
...
```typescript
import { NanosecondScheduler } from '@deflex.net/nanosecond-scheduler'

// Create an instance
const client = new NanosecondScheduler({
...
```typescript
import { NanosecondScheduler, Config } from '@deflex.net/nanosecond-scheduler'
...
const client = new NanosecondScheduler(config)
```
...
// CommonJS
const { NanosecondScheduler } = require('@deflex.net/nanosecond-scheduler')
```
...
try {
  ...
  if (error instanceof NanosecondSchedulerError) {
...
### Main Class: `NanosecondScheduler`
...
Creates a new instance of `NanosecondScheduler`.

**Parameters:**
- `config` (optional): Configuration object

**Returns:**
- Instance of `NanosecondScheduler`
...
#### `NanosecondSchedulerError`

Base error class for all errors thrown by this package.

```typescript
class NanosecondSchedulerError extends Error {
  code: string
  details?: any
}
```
...
```typescript
import { NanosecondScheduler, NanosecondSchedulerError } from '@deflex.net/nanosecond-scheduler'
...
```typescript
import { NanosecondScheduler, Config, LogLevel } from '@deflex.net/nanosecond-scheduler'
...
cd deflex.net/packages/nanosecond-scheduler
...
- **NPM Package**: [@deflex.net/nanosecond-scheduler](https://www.npmjs.com/package/@deflex.net/nanosecond-scheduler)
- **GitHub Repository**: [flexnetos/deflex.net](https://github.com/flexnetos/deflex.net)
- **Rust Crate**: [nanosecond-scheduler](https://crates.io/crates/nanosecond-scheduler)
- **Documentation**: [docs.deflex.net/nanosecond-scheduler](https://docs.deflex.net/nanosecond-scheduler)
...
- Original crate by the [nanosecond-scheduler](https://crates.io/crates/nanosecond-scheduler) authors

---

## 📊 Stats

![NPM](https://nodei.co/npm/@deflex.net/nanosecond-scheduler.png?downloads=true&downloadRank=true&stars=true)
