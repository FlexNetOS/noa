# 📦 @deflex.net/daa-economy

> Economic engine for DAA system with token management

[![npm version](https://img.shields.io/npm/v/@deflex.net/daa-economy.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/daa-economy)
[![npm downloads](https://img.shields.io/npm/dm/@deflex.net/daa-economy.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/daa-economy)
[![license](https://img.shields.io/npm/l/@deflex.net/daa-economy.svg?style=flat-square)](https://github.com/flexnetos/deflex.net/blob/main/LICENSE)
...
`@deflex.net/daa-economy` is a high-performance Node.js native addon that provides TypeScript bindings for the [`daa-economy`](https://crates.io/crates/daa-economy) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
- **Categories**: General
- **License**: MIT
- **Rust Crate**: [daa-economy](https://crates.io/crates/daa-economy)
...
```bash
npm install @deflex.net/daa-economy
```

### Using yarn

```bash
yarn add @deflex.net/daa-economy
```

### Using pnpm

```bash
pnpm add @deflex.net/daa-economy
```
...
- **Linux x64**: `@deflex.net/daa-economy-linux-x64-gnu`
- **Linux ARM64**: `@deflex.net/daa-economy-linux-arm64-gnu`
- **macOS x64**: `@deflex.net/daa-economy-darwin-x64`
- **macOS ARM64**: `@deflex.net/daa-economy-darwin-arm64`
- **Windows x64**: `@deflex.net/daa-economy-win32-x64-msvc`
- **WebAssembly**: `@deflex.net/daa-economy-wasm32` (fallback)
...
```typescript
import { DaaEconomy } from '@deflex.net/daa-economy'

// Create an instance
const client = new DaaEconomy({
...
```typescript
import { DaaEconomy, Config } from '@deflex.net/daa-economy'
...
const client = new DaaEconomy(config)
```
...
// CommonJS
const { DaaEconomy } = require('@deflex.net/daa-economy')
```
...
try {
  ...
  if (error instanceof DaaEconomyError) {
...
Creates a new instance of `DaaEconomy`.

**Parameters:**
- `config` (optional): Configuration object

**Returns:**
- Instance of `DaaEconomy`
...
```typescript
class DaaEconomyError extends Error {
  code: string
  details?: any
}
```
...
```typescript
import { DaaEconomy, DaaEconomyError } from '@deflex.net/daa-economy'
...
```typescript
import { DaaEconomy, Config, LogLevel } from '@deflex.net/daa-economy'
...
cd deflex.net/packages/daa-economy
...
- **NPM Package**: [@deflex.net/daa-economy](https://www.npmjs.com/package/@deflex.net/daa-economy)
- **GitHub Repository**: [flexnetos/deflex.net](https://github.com/flexnetos/deflex.net)
- **Rust Crate**: [daa-economy](https://crates.io/crates/daa-economy)
- **Documentation**: [docs.deflex.net/daa-economy](https://docs.deflex.net/daa-economy)
...
- Original crate by the [daa-economy](https://crates.io/crates/daa-economy) authors

---

## 📊 Stats

![NPM](https://nodei.co/npm/@deflex.net/daa-economy.png?downloads=true&downloadRank=true&stars=true)
