# 📐 @deflex.net/geometric-langlands
...
[![npm version](https://img.shields.io/npm/v/@deflex.net/geometric-langlands.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/geometric-langlands)
[![npm downloads](https://img.shields.io/npm/dm/@deflex.net/geometric-langlands.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/geometric-langlands)
[![license](https://img.shields.io/npm/l/@deflex.net/geometric-langlands.svg?style=flat-square)](https://github.com/flexnetos/deflex.net/blob/main/LICENSE)
...
`@deflex.net/geometric-langlands` is a high-performance Node.js native addon that provides TypeScript bindings for the [`geometric-langlands`](https://crates.io/crates/geometric-langlands) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
- **License**: MIT
- **Rust Crate**: [geometric-langlands](https://crates.io/crates/geometric-langlands)
...
```bash
npm install @deflex.net/geometric-langlands
```

### Using yarn

```bash
yarn add @deflex.net/geometric-langlands
```

### Using pnpm

```bash
pnpm add @deflex.net/geometric-langlands
```
...
- **Linux x64**: `@deflex.net/geometric-langlands-linux-x64-gnu`
- **Linux ARM64**: `@deflex.net/geometric-langlands-linux-arm64-gnu`
- **macOS x64**: `@deflex.net/geometric-langlands-darwin-x64`
- **macOS ARM64**: `@deflex.net/geometric-langlands-darwin-arm64`
- **Windows x64**: `@deflex.net/geometric-langlands-win32-x64-msvc`
- **WebAssembly**: `@deflex.net/geometric-langlands-wasm32` (fallback)
...
```typescript
import { GeometricLanglands } from '@deflex.net/geometric-langlands'
...
```typescript
import { GeometricLanglands, Config } from '@deflex.net/geometric-langlands'
...
const client = new GeometricLanglands(config)
```
...
// CommonJS
const { GeometricLanglands } = require('@deflex.net/geometric-langlands')
```
...
try {
  ...
  if (error instanceof GeometricLanglandsError) {
...
Creates a new instance of `GeometricLanglands`.

**Parameters:**
- `config` (optional): Configuration object

**Returns:**
- Instance of `GeometricLanglands`
...
```typescript
class GeometricLanglandsError extends Error {
  code: string
  details?: any
}
```
...
```typescript
import { GeometricLanglands, GeometricLanglandsError } from '@deflex.net/geometric-langlands'
...
```typescript
import { GeometricLanglands, Config, LogLevel } from '@deflex.net/geometric-langlands'
...
cd deflex.net/packages/geometric-langlands
...
- **NPM Package**: [@deflex.net/geometric-langlands](https://www.npmjs.com/package/@deflex.net/geometric-langlands)
- **GitHub Repository**: [flexnetos/deflex.net](https://github.com/flexnetos/deflex.net)
- **Rust Crate**: [geometric-langlands](https://crates.io/crates/geometric-langlands)
- **Documentation**: [docs.deflex.net/geometric-langlands](https://docs.deflex.net/geometric-langlands)
...
- Original crate by the [geometric-langlands](https://crates.io/crates/geometric-langlands) authors

---

## 📊 Stats

![NPM](https://nodei.co/npm/@deflex.net/geometric-langlands.png?downloads=true&downloadRank=true&stars=true)
