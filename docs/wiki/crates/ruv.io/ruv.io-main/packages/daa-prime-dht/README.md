# 🗄️ @deflex.net/daa-prime-dht

> Kademlia-based distributed hash table implementation for Prime distributed ML framework

[![npm version](https://img.shields.io/npm/v/@deflex.net/daa-prime-dht.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/daa-prime-dht)
[![npm downloads](https://img.shields.io/npm/dm/@deflex.net/daa-prime-dht.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/daa-prime-dht)
[![license](https://img.shields.io/npm/l/@deflex.net/daa-prime-dht.svg?style=flat-square)](https://github.com/flexnetos/deflex.net/blob/main/LICENSE)
...
`@deflex.net/daa-prime-dht` is a high-performance Node.js native addon that provides TypeScript bindings for the [`daa-prime-dht`](https://crates.io/crates/daa-prime-dht) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
- **License**: MIT
- **Rust Crate**: [daa-prime-dht](https://crates.io/crates/daa-prime-dht)
...
```bash
npm install @deflex.net/daa-prime-dht
```

### Using yarn

```bash
yarn add @deflex.net/daa-prime-dht
```

### Using pnpm

```bash
pnpm add @deflex.net/daa-prime-dht
```
...
- **Linux x64**: `@deflex.net/daa-prime-dht-linux-x64-gnu`
- **Linux ARM64**: `@deflex.net/daa-prime-dht-linux-arm64-gnu`
- **macOS x64**: `@deflex.net/daa-prime-dht-darwin-x64`
- **macOS ARM64**: `@deflex.net/daa-prime-dht-darwin-arm64`
- **Windows x64**: `@deflex.net/daa-prime-dht-win32-x64-msvc`
- **WebAssembly**: `@deflex.net/daa-prime-dht-wasm32` (fallback)
...
```typescript
import { DaaPrimeDht } from '@deflex.net/daa-prime-dht'

// Create an instance
const client = new DaaPrimeDht({
...
```typescript
import { DaaPrimeDht, Config } from '@deflex.net/daa-prime-dht'
...
const client = new DaaPrimeDht(config)
```
...
// CommonJS
const { DaaPrimeDht } = require('@deflex.net/daa-prime-dht')
```
...
try {
  ...
  if (error instanceof DaaPrimeDhtError) {
...
Creates a new instance of `DaaPrimeDht`.

**Parameters:**
- `config` (optional): Configuration object

**Returns:**
- Instance of `DaaPrimeDht`
...
```typescript
class DaaPrimeDhtError extends Error {
  code: string
  details?: any
}
```
...
```typescript
import { DaaPrimeDht, DaaPrimeDhtError } from '@deflex.net/daa-prime-dht'
...
```typescript
import { DaaPrimeDht, Config, LogLevel } from '@deflex.net/daa-prime-dht'
...
cd deflex.net/packages/daa-prime-dht
...
- **NPM Package**: [@deflex.net/daa-prime-dht](https://www.npmjs.com/package/@deflex.net/daa-prime-dht)
- **GitHub Repository**: [flexnetos/deflex.net](https://github.com/flexnetos/deflex.net)
- **Rust Crate**: [daa-prime-dht](https://crates.io/crates/daa-prime-dht)
- **Documentation**: [docs.deflex.net/daa-prime-dht](https://docs.deflex.net/daa-prime-dht)
...
- Original crate by the [daa-prime-dht](https://crates.io/crates/daa-prime-dht) authors

---

## 📊 Stats

![NPM](https://nodei.co/npm/@deflex.net/daa-prime-dht.png?downloads=true&downloadRank=true&stars=true)
