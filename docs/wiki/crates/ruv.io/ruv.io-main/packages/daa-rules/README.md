# 📦 @deflex.net/daa-rules

> Rules engine for DAA system providing policy enforcement and decision automation

[![npm version](https://img.shields.io/npm/v/@deflex.net/daa-rules.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/daa-rules)
[![npm downloads](https://img.shields.io/npm/dm/@deflex.net/daa-rules.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/daa-rules)
[![license](https://img.shields.io/npm/l/@deflex.net/daa-rules.svg?style=flat-square)](https://github.com/flexnetos/deflex.net/blob/main/LICENSE)
...
`@deflex.net/daa-rules` is a high-performance Node.js native addon that provides TypeScript bindings for the [`daa-rules`](https://crates.io/crates/daa-rules) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
- **Categories**: General
- **License**: MIT
- **Rust Crate**: [daa-rules](https://crates.io/crates/daa-rules)
...
```bash
npm install @deflex.net/daa-rules
```

### Using yarn

```bash
yarn add @deflex.net/daa-rules
```

### Using pnpm

```bash
pnpm add @deflex.net/daa-rules
```
...
- **Linux x64**: `@deflex.net/daa-rules-linux-x64-gnu`
- **Linux ARM64**: `@deflex.net/daa-rules-linux-arm64-gnu`
- **macOS x64**: `@deflex.net/daa-rules-darwin-x64`
- **macOS ARM64**: `@deflex.net/daa-rules-darwin-arm64`
- **Windows x64**: `@deflex.net/daa-rules-win32-x64-msvc`
- **WebAssembly**: `@deflex.net/daa-rules-wasm32` (fallback)
...
```typescript
import { DaaRules } from '@deflex.net/daa-rules'

// Create an instance
const client = new DaaRules({
...
```typescript
import { DaaRules, Config } from '@deflex.net/daa-rules'
...
const client = new DaaRules(config)
```
...
// CommonJS
const { DaaRules } = require('@deflex.net/daa-rules')
```
...
try {
  ...
  if (error instanceof DaaRulesError) {
...
Creates a new instance of `DaaRules`.

**Parameters:**
- `config` (optional): Configuration object

**Returns:**
- Instance of `DaaRules`
...
```typescript
class DaaRulesError extends Error {
  code: string
  details?: any
}
```
...
```typescript
import { DaaRules, DaaRulesError } from '@deflex.net/daa-rules'
...
```typescript
import { DaaRules, Config, LogLevel } from '@deflex.net/daa-rules'
...
cd deflex.net/packages/daa-rules
...
- **NPM Package**: [@deflex.net/daa-rules](https://www.npmjs.com/package/@deflex.net/daa-rules)
- **GitHub Repository**: [flexnetos/deflex.net](https://github.com/flexnetos/deflex.net)
- **Rust Crate**: [daa-rules](https://crates.io/crates/daa-rules)
- **Documentation**: [docs.deflex.net/daa-rules](https://docs.deflex.net/daa-rules)
...
- Original crate by the [daa-rules](https://crates.io/crates/daa-rules) authors

---

## 📊 Stats

![NPM](https://nodei.co/npm/@deflex.net/daa-rules.png?downloads=true&downloadRank=true&stars=true)
