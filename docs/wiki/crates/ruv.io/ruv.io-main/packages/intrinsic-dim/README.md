# 📐 @deflex.net/intrinsic-dim

> Fast intrinsic dimensionality estimation for ML model optimization

[![npm version](https://img.shields.io/npm/v/@deflex.net/intrinsic-dim.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/intrinsic-dim)
[![npm downloads](https://img.shields.io/npm/dm/@deflex.net/intrinsic-dim.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/intrinsic-dim)
[![license](https://img.shields.io/npm/l/@deflex.net/intrinsic-dim.svg?style=flat-square)](https://github.com/flexnetos/deflex.net/blob/main/LICENSE)
...
`@deflex.net/intrinsic-dim` is a high-performance Node.js native addon that provides TypeScript bindings for the [`intrinsic-dim`](https://crates.io/crates/intrinsic-dim) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
- **License**: MIT
- **Rust Crate**: [intrinsic-dim](https://crates.io/crates/intrinsic-dim)
...
```bash
npm install @deflex.net/intrinsic-dim
```

### Using yarn

```bash
yarn add @deflex.net/intrinsic-dim
```

### Using pnpm

```bash
pnpm add @deflex.net/intrinsic-dim
```
...
- **Linux x64**: `@deflex.net/intrinsic-dim-linux-x64-gnu`
- **Linux ARM64**: `@deflex.net/intrinsic-dim-linux-arm64-gnu`
- **macOS x64**: `@deflex.net/intrinsic-dim-darwin-x64`
- **macOS ARM64**: `@deflex.net/intrinsic-dim-darwin-arm64`
- **Windows x64**: `@deflex.net/intrinsic-dim-win32-x64-msvc`
- **WebAssembly**: `@deflex.net/intrinsic-dim-wasm32` (fallback)
...
```typescript
import { IntrinsicDim } from '@deflex.net/intrinsic-dim'

// Create an instance
const client = new IntrinsicDim({
...
```typescript
import { IntrinsicDim, Config } from '@deflex.net/intrinsic-dim'
...
const client = new IntrinsicDim(config)
```
...
// CommonJS
const { IntrinsicDim } = require('@deflex.net/intrinsic-dim')
```
...
try {
  ...
  if (error instanceof IntrinsicDimError) {
...
Creates a new instance of `IntrinsicDim`.

**Parameters:**
- `config` (optional): Configuration object

**Returns:**
- Instance of `IntrinsicDim`
...
```typescript
class IntrinsicDimError extends Error {
  code: string
  details?: any
}
```
...
```typescript
import { IntrinsicDim, IntrinsicDimError } from '@deflex.net/intrinsic-dim'
...
```typescript
import { IntrinsicDim, Config, LogLevel } from '@deflex.net/intrinsic-dim'
...
cd deflex.net/packages/intrinsic-dim
...
- **NPM Package**: [@deflex.net/intrinsic-dim](https://www.npmjs.com/package/@deflex.net/intrinsic-dim)
- **GitHub Repository**: [flexnetos/deflex.net](https://github.com/flexnetos/deflex.net)
- **Rust Crate**: [intrinsic-dim](https://crates.io/crates/intrinsic-dim)
- **Documentation**: [docs.deflex.net/intrinsic-dim](https://docs.deflex.net/intrinsic-dim)
...
- Original crate by the [intrinsic-dim](https://crates.io/crates/intrinsic-dim) authors

---

## 📊 Stats

![NPM](https://nodei.co/npm/@deflex.net/intrinsic-dim.png?downloads=true&downloadRank=true&stars=true)
