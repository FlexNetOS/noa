# ⚛️ @deflex.net/qudag-wasm

> WASM bindings for QuDAG - Quantum Ultra-Fast Distributed Acyclic Graph

[![npm version](https://img.shields.io/npm/v/@deflex.net/qudag-wasm.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/qudag-wasm)
[![npm downloads](https://img.shields.io/npm/dm/@deflex.net/qudag-wasm.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/qudag-wasm)
[![license](https://img.shields.io/npm/l/@deflex.net/qudag-wasm.svg?style=flat-square)](https://github.com/flexnetos/deflex.net/blob/main/LICENSE)
...
`@deflex.net/qudag-wasm` is a high-performance Node.js native addon that provides TypeScript bindings for the [`qudag-wasm`](https://crates.io/crates/qudag-wasm) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.

**Key Information:**
- **Version**: 0.1.0
- **Downloads**: 507+
- **Categories**: Wasm Bindings, Blockchain Crypto, Quantum Computing
- **License**: MIT
- **Rust Crate**: [qudag-wasm](https://crates.io/crates/qudag-wasm)
...
```bash
npm install @deflex.net/qudag-wasm
```

### Using yarn

```bash
yarn add @deflex.net/qudag-wasm
```

### Using pnpm

```bash
pnpm add @deflex.net/qudag-wasm
```
...
- **Linux x64**: `@deflex.net/qudag-wasm-linux-x64-gnu`
- **Linux ARM64**: `@deflex.net/qudag-wasm-linux-arm64-gnu`
- **macOS x64**: `@deflex.net/qudag-wasm-darwin-x64`
- **macOS ARM64**: `@deflex.net/qudag-wasm-darwin-arm64`
- **Windows x64**: `@deflex.net/qudag-wasm-win32-x64-msvc`
- **WebAssembly**: `@deflex.net/qudag-wasm-wasm32` (fallback)
...
```typescript
import { QudagWasm } from '@deflex.net/qudag-wasm'

// Create an instance
const client = new QudagWasm({
...
```typescript
import { QudagWasm, Config } from '@deflex.net/qudag-wasm'
...
const client = new QudagWasm(config)
```
...
// CommonJS
const { QudagWasm } = require('@deflex.net/qudag-wasm')
```
...
try {
  ...
  if (error instanceof QudagWasmError) {
...
Creates a new instance of `QudagWasm`.

**Parameters:**
- `config` (optional): Configuration object

**Returns:**
- Instance of `QudagWasm`
...
```typescript
class QudagWasmError extends Error {
  code: string
  details?: any
}
```
...
```typescript
import { QudagWasm, QudagWasmError } from '@deflex.net/qudag-wasm'
...
```typescript
import { QudagWasm, Config, LogLevel } from '@deflex.net/qudag-wasm'
...
cd deflex.net/packages/qudag-wasm
...
- **NPM Package**: [@deflex.net/qudag-wasm](https://www.npmjs.com/package/@deflex.net/qudag-wasm)
- **GitHub Repository**: [flexnetos/deflex.net](https://github.com/flexnetos/deflex.net)
- **Rust Crate**: [qudag-wasm](https://crates.io/crates/qudag-wasm)
- **Documentation**: [docs.deflex.net/qudag-wasm](https://docs.deflex.net/qudag-wasm)
...
- Original crate by the [qudag-wasm](https://crates.io/crates/qudag-wasm) authors

---

## 📊 Stats

![NPM](https://nodei.co/npm/@deflex.net/qudag-wasm.png?downloads=true&downloadRank=true&stars=true)
