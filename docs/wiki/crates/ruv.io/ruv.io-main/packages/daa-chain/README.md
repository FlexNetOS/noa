# 📦 @deflex.net/daa-chain

> Blockchain abstraction layer for DAA system with multi-chain support

[![npm version](https://img.shields.io/npm/v/@deflex.net/daa-chain.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/daa-chain)
[![npm downloads](https://img.shields.io/npm/dm/@deflex.net/daa-chain.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/daa-chain)
[![license](https://img.shields.io/npm/l/@deflex.net/daa-chain.svg?style=flat-square)](https://github.com/flexnetos/deflex.net/blob/main/LICENSE)
...
`@deflex.net/daa-chain` is a high-performance Node.js native addon that provides TypeScript bindings for the [`daa-chain`](https://crates.io/crates/daa-chain) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
- **Categories**: General
- **License**: MIT
- **Rust Crate**: [daa-chain](https://crates.io/crates/daa-chain)
...
```bash
npm install @deflex.net/daa-chain
```

### Using yarn

```bash
yarn add @deflex.net/daa-chain
```

### Using pnpm

```bash
pnpm add @deflex.net/daa-chain
```
...
- **Linux x64**: `@deflex.net/daa-chain-linux-x64-gnu`
- **Linux ARM64**: `@deflex.net/daa-chain-linux-arm64-gnu`
- **macOS x64**: `@deflex.net/daa-chain-darwin-x64`
- **macOS ARM64**: `@deflex.net/daa-chain-darwin-arm64`
- **Windows x64**: `@deflex.net/daa-chain-win32-x64-msvc`
- **WebAssembly**: `@deflex.net/daa-chain-wasm32` (fallback)
...
```typescript
import { DaaChain } from '@deflex.net/daa-chain'

// Create an instance
const client = new DaaChain({
...
```typescript
import { DaaChain, Config } from '@deflex.net/daa-chain'
...
const client = new DaaChain(config)
```
...
// CommonJS
const { DaaChain } = require('@deflex.net/daa-chain')
```
...
try {
  ...
  if (error instanceof DaaChainError) {
...
Creates a new instance of `DaaChain`.

**Parameters:**
- `config` (optional): Configuration object

**Returns:**
- Instance of `DaaChain`
...
```typescript
class DaaChainError extends Error {
  code: string
  details?: any
}
```
...
```typescript
import { DaaChain, DaaChainError } from '@deflex.net/daa-chain'
...
```typescript
import { DaaChain, Config, LogLevel } from '@deflex.net/daa-chain'
...
cd deflex.net/packages/daa-chain
...
- **NPM Package**: [@deflex.net/daa-chain](https://www.npmjs.com/package/@deflex.net/daa-chain)
- **GitHub Repository**: [flexnetos/deflex.net](https://github.com/flexnetos/deflex.net)
- **Rust Crate**: [daa-chain](https://crates.io/crates/daa-chain)
- **Documentation**: [docs.deflex.net/daa-chain](https://docs.deflex.net/daa-chain)
...
- Original crate by the [daa-chain](https://crates.io/crates/daa-chain) authors

---

## 📊 Stats

![NPM](https://nodei.co/npm/@deflex.net/daa-chain.png?downloads=true&downloadRank=true&stars=true)
