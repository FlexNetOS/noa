# 🧠 @deflex.net/micro_core

> Core no_std Semantic Cartan Matrix implementation for rUv-FANN

[![npm version](https://img.shields.io/npm/v/@deflex.net/micro_core.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/micro_core)
[![npm downloads](https://img.shields.io/npm/dm/@deflex.net/micro_core.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/micro_core)
[![license](https://img.shields.io/npm/l/@deflex.net/micro_core.svg?style=flat-square)](https://github.com/flexnetos/deflex.net/blob/main/LICENSE)
...
`@deflex.net/micro_core` is a high-performance Node.js native addon that provides TypeScript bindings for the [`micro_core`](https://crates.io/crates/micro_core) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
- **License**: MIT
- **Rust Crate**: [micro_core](https://crates.io/crates/micro_core)
...
```bash
npm install @deflex.net/micro_core
```

### Using yarn

```bash
yarn add @deflex.net/micro_core
```

### Using pnpm

```bash
pnpm add @deflex.net/micro_core
```
...
- **Linux x64**: `@deflex.net/micro_core-linux-x64-gnu`
- **Linux ARM64**: `@deflex.net/micro_core-linux-arm64-gnu`
- **macOS x64**: `@deflex.net/micro_core-darwin-x64`
- **macOS ARM64**: `@deflex.net/micro_core-darwin-arm64`
- **Windows x64**: `@deflex.net/micro_core-win32-x64-msvc`
- **WebAssembly**: `@deflex.net/micro_core-wasm32` (fallback)
...
```typescript
import { Micro_core } from '@deflex.net/micro_core'

// Create an instance
const client = new Micro_core({
...
```typescript
import { Micro_core, Config } from '@deflex.net/micro_core'
...
const client = new Micro_core(config)
```
...
// CommonJS
const { Micro_core } = require('@deflex.net/micro_core')
```
...
try {
  ...
  if (error instanceof Micro_coreError) {
...
Creates a new instance of `Micro_core`.

**Parameters:**
- `config` (optional): Configuration object

**Returns:**
- Instance of `Micro_core`
...
```typescript
class Micro_coreError extends Error {
  code: string
  details?: any
}
```
...
```typescript
import { Micro_core, Micro_coreError } from '@deflex.net/micro_core'
...
```typescript
import { Micro_core, Config, LogLevel } from '@deflex.net/micro_core'
...
cd deflex.net/packages/micro_core
...
- **NPM Package**: [@deflex.net/micro_core](https://www.npmjs.com/package/@deflex.net/micro_core)
- **GitHub Repository**: [flexnetos/deflex.net](https://github.com/flexnetos/deflex.net)
- **Rust Crate**: [micro_core](https://crates.io/crates/micro_core)
- **Documentation**: [docs.deflex.net/micro_core](https://docs.deflex.net/micro_core)
...
- Original crate by the [micro_core](https://crates.io/crates/micro_core) authors

---

## 📊 Stats

![NPM](https://nodei.co/npm/@deflex.net/micro_core.png?downloads=true&downloadRank=true&stars=true)
