...
[![npm version](https://img.shields.io/npm/v/@deflex.net/daa-cli.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/daa-cli)
[![npm downloads](https://img.shields.io/npm/dm/@deflex.net/daa-cli.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/daa-cli)
[![license](https://img.shields.io/npm/l/@deflex.net/daa-cli.svg?style=flat-square)](https://github.com/flexnetos/deflex.net/blob/main/LICENSE)
...
`@deflex.net/daa-cli` is a high-performance Node.js native addon that provides TypeScript bindings for the [`daa-cli`](https://crates.io/crates/daa-cli) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
- **License**: MIT
- **Rust Crate**: [daa-cli](https://crates.io/crates/daa-cli)
...
```bash
npm install @deflex.net/daa-cli
```

### Using yarn

```bash
yarn add @deflex.net/daa-cli
```

### Using pnpm

```bash
pnpm add @deflex.net/daa-cli
```
...
- **Linux x64**: `@deflex.net/daa-cli-linux-x64-gnu`
- **Linux ARM64**: `@deflex.net/daa-cli-linux-arm64-gnu`
- **macOS x64**: `@deflex.net/daa-cli-darwin-x64`
- **macOS ARM64**: `@deflex.net/daa-cli-darwin-arm64`
- **Windows x64**: `@deflex.net/daa-cli-win32-x64-msvc`
- **WebAssembly**: `@deflex.net/daa-cli-wasm32` (fallback)
...
```typescript
import { DaaCli } from '@deflex.net/daa-cli'

// Create an instance
const client = new DaaCli({
...
```typescript
import { DaaCli, Config } from '@deflex.net/daa-cli'
...
const client = new DaaCli(config)
```
...
// CommonJS
const { DaaCli } = require('@deflex.net/daa-cli')
```
...
try {
  ...
  if (error instanceof DaaCliError) {
...
Creates a new instance of `DaaCli`.
...
```typescript
class DaaCliError extends Error {
  code: string
  details?: any
}
```
...
```typescript
import { DaaCli, DaaCliError } from '@deflex.net/daa-cli'
...
```typescript
import { DaaCli, Config, LogLevel } from '@deflex.net/daa-cli'
...
cd deflex.net/packages/daa-cli
...
- **NPM Package**: [@deflex.net/daa-cli](https://www.npmjs.com/package/@deflex.net/daa-cli)
- **GitHub Repository**: [flexnetos/deflex.net](https://github.com/flexnetos/deflex.net)
- **Rust Crate**: [daa-cli](https://crates.io/crates/daa-cli)
- **Documentation**: [docs.deflex.net/daa-cli](https://docs.deflex.net/daa-cli)
...
- Original crate by the [daa-cli](https://crates.io/crates/daa-cli) authors

---

## 📊 Stats

![NPM](https://nodei.co/npm/@deflex.net/daa-cli.png?downloads=true&downloadRank=true&stars=true)
