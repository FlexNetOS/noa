# 🧠 @deflex.net/micro_cartan_attn

> Complete Cartan matrix attention mechanisms with proper Lie algebra structures

[![npm version](https://img.shields.io/npm/v/@deflex.net/micro_cartan_attn.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/micro_cartan_attn)
[![npm downloads](https://img.shields.io/npm/dm/@deflex.net/micro_cartan_attn.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/micro_cartan_attn)
[![license](https://img.shields.io/npm/l/@deflex.net/micro_cartan_attn.svg?style=flat-square)](https://github.com/flexnetos/deflex.net/blob/main/LICENSE)
...
`@deflex.net/micro_cartan_attn` is a high-performance Node.js native addon that provides TypeScript bindings for the [`micro_cartan_attn`](https://crates.io/crates/micro_cartan_attn) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.

**Key Information:**
- **Version**: 0.2.0
- **Downloads**: 722+
- **Categories**: Neural Networks, Mathematical
- **License**: MIT
- **Rust Crate**: [micro_cartan_attn](https://crates.io/crates/micro_cartan_attn)
...
```bash
npm install @deflex.net/micro_cartan_attn
```

### Using yarn

```bash
yarn add @deflex.net/micro_cartan_attn
```

### Using pnpm

```bash
pnpm add @deflex.net/micro_cartan_attn
```
...
- **Linux x64**: `@deflex.net/micro_cartan_attn-linux-x64-gnu`
- **Linux ARM64**: `@deflex.net/micro_cartan_attn-linux-arm64-gnu`
- **macOS x64**: `@deflex.net/micro_cartan_attn-darwin-x64`
- **macOS ARM64**: `@deflex.net/micro_cartan_attn-darwin-arm64`
- **Windows x64**: `@deflex.net/micro_cartan_attn-win32-x64-msvc`
- **WebAssembly**: `@deflex.net/micro_cartan_attn-wasm32` (fallback)
...
```typescript
import { Micro_cartan_attn } from '@deflex.net/micro_cartan_attn'

// Create an instance
const client = new Micro_cartan_attn({
...
```typescript
import { Micro_cartan_attn, Config } from '@deflex.net/micro_cartan_attn'
...
const client = new Micro_cartan_attn(config)
```
...
// Train a model
const model = new Micro_cartan_attn({
  layers: [64, 128, 64],
  activation: 'relu'
})
...
// CommonJS
const { Micro_cartan_attn } = require('@deflex.net/micro_cartan_attn')
```
...
try {
  ...
  if (error instanceof Micro_cartan_attnError) {
...
Creates a new instance of `Micro_cartan_attn`.

**Parameters:**
- `config` (optional): Configuration object

**Returns:**
- Instance of `Micro_cartan_attn`
...
#### `Micro_cartan_attnError`

Base error class for all errors thrown by this package.

```typescript
class Micro_cartan_attnError extends Error {
  code: string
  details?: any
}
```
...
```typescript
import { Micro_cartan_attn, Micro_cartan_attnError } from '@deflex.net/micro_cartan_attn'
...
```typescript
import { Micro_cartan_attn, Config, LogLevel } from '@deflex.net/micro_cartan_attn'
...
cd deflex.net/packages/micro_cartan_attn
...
- **NPM Package**: [@deflex.net/micro_cartan_attn](https://www.npmjs.com/package/@deflex.net/micro_cartan_attn)
- **GitHub Repository**: [flexnetos/deflex.net](https://github.com/flexnetos/deflex.net)
- **Rust Crate**: [micro_cartan_attn](https://crates.io/crates/micro_cartan_attn)
- **Documentation**: [docs.deflex.net/micro_cartan_attn](https://docs.deflex.net/micro_cartan_attn)
...
- Original crate by the [micro_cartan_attn](https://crates.io/crates/micro_cartan_attn) authors

---

## 📊 Stats

![NPM](https://nodei.co/npm/@deflex.net/micro_cartan_attn.png?downloads=true&downloadRank=true&stars=true)
