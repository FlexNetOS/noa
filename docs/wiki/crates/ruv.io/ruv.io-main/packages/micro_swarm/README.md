# 🐝 @deflex.net/micro_swarm

> Swarm orchestration and coordination for micro-neural networks

[![npm version](https://img.shields.io/npm/v/@deflex.net/micro_swarm.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/micro_swarm)
[![npm downloads](https://img.shields.io/npm/dm/@deflex.net/micro_swarm.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/micro_swarm)
[![license](https://img.shields.io/npm/l/@deflex.net/micro_swarm.svg?style=flat-square)](https://github.com/flexnetos/deflex.net/blob/main/LICENSE)
...
`@deflex.net/micro_swarm` is a high-performance Node.js native addon that provides TypeScript bindings for the [`micro_swarm`](https://crates.io/crates/micro_swarm) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.

**Key Information:**
- **Version**: 0.2.0
- **Downloads**: 734+
- **Categories**: Swarm Orchestration, Neural Networks
- **License**: MIT
- **Rust Crate**: [micro_swarm](https://crates.io/crates/micro_swarm)
...
```bash
npm install @deflex.net/micro_swarm
```

### Using yarn

```bash
yarn add @deflex.net/micro_swarm
```

### Using pnpm

```bash
pnpm add @deflex.net/micro_swarm
```
...
- **Linux x64**: `@deflex.net/micro_swarm-linux-x64-gnu`
- **Linux ARM64**: `@deflex.net/micro_swarm-linux-arm64-gnu`
- **macOS x64**: `@deflex.net/micro_swarm-darwin-x64`
- **macOS ARM64**: `@deflex.net/micro_swarm-darwin-arm64`
- **Windows x64**: `@deflex.net/micro_swarm-win32-x64-msvc`
- **WebAssembly**: `@deflex.net/micro_swarm-wasm32` (fallback)
...
```typescript
import { Micro_swarm } from '@deflex.net/micro_swarm'
...
try {
  ...
  if (error instanceof Micro_swarmError) {
...
```typescript
class Micro_swarmError extends Error {
  code: string
  details?: any
}
```
...
```typescript
import { Micro_swarm, Micro_swarmError } from '@deflex.net/micro_swarm'
...
cd deflex.net/packages/micro_swarm
...
- **NPM Package**: [@deflex.net/micro_swarm](https://www.npmjs.com/package/@deflex.net/micro_swarm)
- **GitHub Repository**: [flexnetos/deflex.net](https://github.com/flexnetos/deflex.net)
- **Rust Crate**: [micro_swarm](https://crates.io/crates/micro_swarm)
- **Documentation**: [docs.deflex.net/micro_swarm](https://docs.deflex.net/micro_swarm)
...
- Original crate by the [micro_swarm](https://crates.io/crates/micro_swarm) authors

---

## 📊 Stats

![NPM](https://nodei.co/npm/@deflex.net/micro_swarm.png?downloads=true&downloadRank=true&stars=true)
