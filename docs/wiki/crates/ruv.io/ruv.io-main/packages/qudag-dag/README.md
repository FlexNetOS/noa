# ⚛️ @deflex.net/qudag-dag

> DAG consensus implementation for QuDAG - QR-Avalanche algorithm with Byzantine fault tolerance

[![npm version](https://img.shields.io/npm/v/@deflex.net/qudag-dag.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/qudag-dag)
[![npm downloads](https://img.shields.io/npm/dm/@deflex.net/qudag-dag.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/qudag-dag)
[![license](https://img.shields.io/npm/l/@deflex.net/qudag-dag.svg?style=flat-square)](https://github.com/flexnetos/deflex.net/blob/main/LICENSE)
...
`@deflex.net/qudag-dag` is a high-performance Node.js native addon that provides TypeScript bindings for the [`qudag-dag`](https://crates.io/crates/qudag-dag) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
- **License**: MIT
- **Rust Crate**: [qudag-dag](https://crates.io/crates/qudag-dag)
...
```bash
npm install @deflex.net/qudag-dag
```

### Using yarn

```bash
yarn add @deflex.net/qudag-dag
```

### Using pnpm

```bash
pnpm add @deflex.net/qudag-dag
```
...
- **Linux x64**: `@deflex.net/qudag-dag-linux-x64-gnu`
- **Linux ARM64**: `@deflex.net/qudag-dag-linux-arm64-gnu`
- **macOS x64**: `@deflex.net/qudag-dag-darwin-x64`
- **macOS ARM64**: `@deflex.net/qudag-dag-darwin-arm64`
- **Windows x64**: `@deflex.net/qudag-dag-win32-x64-msvc`
- **WebAssembly**: `@deflex.net/qudag-dag-wasm32` (fallback)
...
```typescript
import { QudagDag } from '@deflex.net/qudag-dag'

// Create an instance
const client = new QudagDag({
...
```typescript
import { QudagDag, Config } from '@deflex.net/qudag-dag'
...
const client = new QudagDag(config)
```
...
// CommonJS
const { QudagDag } = require('@deflex.net/qudag-dag')
```
...
try {
  ...
  if (error instanceof QudagDagError) {
...
Creates a new instance of `QudagDag`.

**Parameters:**
- `config` (optional): Configuration object

**Returns:**
- Instance of `QudagDag`
...
```typescript
class QudagDagError extends Error {
  code: string
  details?: any
}
```
...
```typescript
import { QudagDag, QudagDagError } from '@deflex.net/qudag-dag'
...
```typescript
import { QudagDag, Config, LogLevel } from '@deflex.net/qudag-dag'
...
cd deflex.net/packages/qudag-dag
...
- **NPM Package**: [@deflex.net/qudag-dag](https://www.npmjs.com/package/@deflex.net/qudag-dag)
- **GitHub Repository**: [flexnetos/deflex.net](https://github.com/flexnetos/deflex.net)
- **Rust Crate**: [qudag-dag](https://crates.io/crates/qudag-dag)
- **Documentation**: [docs.deflex.net/qudag-dag](https://docs.deflex.net/qudag-dag)
...
- Original crate by the [qudag-dag](https://crates.io/crates/qudag-dag) authors

---

## 📊 Stats

![NPM](https://nodei.co/npm/@deflex.net/qudag-dag.png?downloads=true&downloadRank=true&stars=true)
