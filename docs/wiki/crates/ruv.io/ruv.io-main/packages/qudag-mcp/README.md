# ⚛️ @deflex.net/qudag-mcp

> Model Context Protocol (MCP) server for QuDAG - Integrates vault, exchange, and quantum-resistant operations

[![npm version](https://img.shields.io/npm/v/@deflex.net/qudag-mcp.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/qudag-mcp)
[![npm downloads](https://img.shields.io/npm/dm/@deflex.net/qudag-mcp.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/qudag-mcp)
[![license](https://img.shields.io/npm/l/@deflex.net/qudag-mcp.svg?style=flat-square)](https://github.com/flexnetos/deflex.net/blob/main/LICENSE)
...
`@deflex.net/qudag-mcp` is a high-performance Node.js native addon that provides TypeScript bindings for the [`qudag-mcp`](https://crates.io/crates/qudag-mcp) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.

**Key Information:**
- **Version**: 0.5.0
- **Downloads**: 2,314+
- **Categories**: Mcp Protocol, Blockchain Crypto, Quantum Computing
- **License**: MIT
- **Rust Crate**: [qudag-mcp](https://crates.io/crates/qudag-mcp)
...
```bash
npm install @deflex.net/qudag-mcp
```

### Using yarn

```bash
yarn add @deflex.net/qudag-mcp
```

### Using pnpm

```bash
pnpm add @deflex.net/qudag-mcp
```
...
- **Linux x64**: `@deflex.net/qudag-mcp-linux-x64-gnu`
- **Linux ARM64**: `@deflex.net/qudag-mcp-linux-arm64-gnu`
- **macOS x64**: `@deflex.net/qudag-mcp-darwin-x64`
- **macOS ARM64**: `@deflex.net/qudag-mcp-darwin-arm64`
- **Windows x64**: `@deflex.net/qudag-mcp-win32-x64-msvc`
- **WebAssembly**: `@deflex.net/qudag-mcp-wasm32` (fallback)
...
```typescript
import { QudagMcp } from '@deflex.net/qudag-mcp'

// Create an instance
const client = new QudagMcp({
...
```typescript
import { QudagMcp, Config } from '@deflex.net/qudag-mcp'
...
const client = new QudagMcp(config)
```
...
// CommonJS
const { QudagMcp } = require('@deflex.net/qudag-mcp')
```
...
try {
  ...
  if (error instanceof QudagMcpError) {
...
Creates a new instance of `QudagMcp`.

**Parameters:**
- `config` (optional): Configuration object

**Returns:**
- Instance of `QudagMcp`
...
```typescript
class QudagMcpError extends Error {
  code: string
  details?: any
}
```
...
```typescript
import { QudagMcp, QudagMcpError } from '@deflex.net/qudag-mcp'
...
```typescript
import { QudagMcp, Config, LogLevel } from '@deflex.net/qudag-mcp'
...
cd deflex.net/packages/qudag-mcp
...
- **NPM Package**: [@deflex.net/qudag-mcp](https://www.npmjs.com/package/@deflex.net/qudag-mcp)
- **GitHub Repository**: [flexnetos/deflex.net](https://github.com/flexnetos/deflex.net)
- **Rust Crate**: [qudag-mcp](https://crates.io/crates/qudag-mcp)
- **Documentation**: [docs.deflex.net/qudag-mcp](https://docs.deflex.net/qudag-mcp)
...
- Original crate by the [qudag-mcp](https://crates.io/crates/qudag-mcp) authors

---

## 📊 Stats

![NPM](https://nodei.co/npm/@deflex.net/qudag-mcp.png?downloads=true&downloadRank=true&stars=true)
