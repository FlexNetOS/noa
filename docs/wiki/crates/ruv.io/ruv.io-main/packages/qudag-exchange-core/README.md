# ⚛️ @deflex.net/qudag-exchange-core

> Core QuDAG Exchange library with quantum-resistant rUv token system

[![npm version](https://img.shields.io/npm/v/@deflex.net/qudag-exchange-core.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/qudag-exchange-core)
[![npm downloads](https://img.shields.io/npm/dm/@deflex.net/qudag-exchange-core.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/qudag-exchange-core)
[![license](https://img.shields.io/npm/l/@deflex.net/qudag-exchange-core.svg?style=flat-square)](https://github.com/flexnetos/deflex.net/blob/main/LICENSE)
...
`@deflex.net/qudag-exchange-core` is a high-performance Node.js native addon that provides TypeScript bindings for the [`qudag-exchange-core`](https://crates.io/crates/qudag-exchange-core) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
- **License**: MIT
- **Rust Crate**: [qudag-exchange-core](https://crates.io/crates/qudag-exchange-core)
...
```bash
npm install @deflex.net/qudag-exchange-core
```

### Using yarn

```bash
yarn add @deflex.net/qudag-exchange-core
```

### Using pnpm

```bash
pnpm add @deflex.net/qudag-exchange-core
```
...
- **Linux x64**: `@deflex.net/qudag-exchange-core-linux-x64-gnu`
- **Linux ARM64**: `@deflex.net/qudag-exchange-core-linux-arm64-gnu`
- **macOS x64**: `@deflex.net/qudag-exchange-core-darwin-x64`
- **macOS ARM64**: `@deflex.net/qudag-exchange-core-darwin-arm64`
- **Windows x64**: `@deflex.net/qudag-exchange-core-win32-x64-msvc`
- **WebAssembly**: `@deflex.net/qudag-exchange-core-wasm32` (fallback)
...
```typescript
import { QudagExchangeCore } from '@deflex.net/qudag-exchange-core'

// Create an instance
const client = new QudagExchangeCore({
...
```typescript
import { QudagExchangeCore, Config } from '@deflex.net/qudag-exchange-core'
...
const client = new QudagExchangeCore(config)
```
...
// CommonJS
const { QudagExchangeCore } = require('@deflex.net/qudag-exchange-core')
```
...
try {
  ...
  if (error instanceof QudagExchangeCoreError) {
...
Creates a new instance of `QudagExchangeCore`.

**Parameters:**
- `config` (optional): Configuration object

**Returns:**
- Instance of `QudagExchangeCore`
...
#### `QudagExchangeCoreError`

Base error class for all errors thrown by this package.

```typescript
class QudagExchangeCoreError extends Error {
  code: string
  details?: any
}
```
...
```typescript
import { QudagExchangeCore, QudagExchangeCoreError } from '@deflex.net/qudag-exchange-core'
...
```typescript
import { QudagExchangeCore, Config, LogLevel } from '@deflex.net/qudag-exchange-core'
...
cd deflex.net/packages/qudag-exchange-core
...
- **NPM Package**: [@deflex.net/qudag-exchange-core](https://www.npmjs.com/package/@deflex.net/qudag-exchange-core)
- **GitHub Repository**: [flexnetos/deflex.net](https://github.com/flexnetos/deflex.net)
- **Rust Crate**: [qudag-exchange-core](https://crates.io/crates/qudag-exchange-core)
- **Documentation**: [docs.deflex.net/qudag-exchange-core](https://docs.deflex.net/qudag-exchange-core)
...
- Original crate by the [qudag-exchange-core](https://crates.io/crates/qudag-exchange-core) authors

---

## 📊 Stats

![NPM](https://nodei.co/npm/@deflex.net/qudag-exchange-core.png?downloads=true&downloadRank=true&stars=true)
