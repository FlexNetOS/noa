# ⏰ @deflex.net/midstreamer-temporal-compare

> Temporal sequence comparison and pattern matching

[![npm version](https://img.shields.io/npm/v/@deflex.net/midstreamer-temporal-compare.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/midstreamer-temporal-compare)
[![npm downloads](https://img.shields.io/npm/dm/@deflex.net/midstreamer-temporal-compare.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/midstreamer-temporal-compare)
[![license](https://img.shields.io/npm/l/@deflex.net/midstreamer-temporal-compare.svg?style=flat-square)](https://github.com/flexnetos/deflex.net/blob/main/LICENSE)
...
`@deflex.net/midstreamer-temporal-compare` is a high-performance Node.js native addon that provides TypeScript bindings for the [`midstreamer-temporal-compare`](https://crates.io/crates/midstreamer-temporal-compare) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
- **License**: MIT
- **Rust Crate**: [midstreamer-temporal-compare](https://crates.io/crates/midstreamer-temporal-compare)
...
```bash
npm install @deflex.net/midstreamer-temporal-compare
```

### Using yarn

```bash
yarn add @deflex.net/midstreamer-temporal-compare
```

### Using pnpm

```bash
pnpm add @deflex.net/midstreamer-temporal-compare
```
...
- **Linux x64**: `@deflex.net/midstreamer-temporal-compare-linux-x64-gnu`
- **Linux ARM64**: `@deflex.net/midstreamer-temporal-compare-linux-arm64-gnu`
- **macOS x64**: `@deflex.net/midstreamer-temporal-compare-darwin-x64`
- **macOS ARM64**: `@deflex.net/midstreamer-temporal-compare-darwin-arm64`
- **Windows x64**: `@deflex.net/midstreamer-temporal-compare-win32-x64-msvc`
- **WebAssembly**: `@deflex.net/midstreamer-temporal-compare-wasm32` (fallback)
...
```typescript
import { MidstreamerTemporalCompare } from '@deflex.net/midstreamer-temporal-compare'

// Create an instance
const client = new MidstreamerTemporalCompare({
...
```typescript
import { MidstreamerTemporalCompare, Config } from '@deflex.net/midstreamer-temporal-compare'
...
const client = new MidstreamerTemporalCompare(config)
```
...
// CommonJS
const { MidstreamerTemporalCompare } = require('@deflex.net/midstreamer-temporal-compare')
```
...
try {
  ...
  if (error instanceof MidstreamerTemporalCompareError) {
...
### Main Class: `MidstreamerTemporalCompare`
...
Creates a new instance of `MidstreamerTemporalCompare`.

**Parameters:**
- `config` (optional): Configuration object

**Returns:**
- Instance of `MidstreamerTemporalCompare`
...
#### `MidstreamerTemporalCompareError`

Base error class for all errors thrown by this package.

```typescript
class MidstreamerTemporalCompareError extends Error {
  code: string
  details?: any
}
```
...
```typescript
import { MidstreamerTemporalCompare, MidstreamerTemporalCompareError } from '@deflex.net/midstreamer-temporal-compare'
...
```typescript
import { MidstreamerTemporalCompare, Config, LogLevel } from '@deflex.net/midstreamer-temporal-compare'
...
cd deflex.net/packages/midstreamer-temporal-compare
...
- **NPM Package**: [@deflex.net/midstreamer-temporal-compare](https://www.npmjs.com/package/@deflex.net/midstreamer-temporal-compare)
- **GitHub Repository**: [flexnetos/deflex.net](https://github.com/flexnetos/deflex.net)
- **Rust Crate**: [midstreamer-temporal-compare](https://crates.io/crates/midstreamer-temporal-compare)
- **Documentation**: [docs.deflex.net/midstreamer-temporal-compare](https://docs.deflex.net/midstreamer-temporal-compare)
...
- Original crate by the [midstreamer-temporal-compare](https://crates.io/crates/midstreamer-temporal-compare) authors

---

## 📊 Stats

![NPM](https://nodei.co/npm/@deflex.net/midstreamer-temporal-compare.png?downloads=true&downloadRank=true&stars=true)
