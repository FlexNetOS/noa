# ⚛️ @deflex.net/qudag-cli

> Command-line interface for QuDAG - Manage nodes, peers, dark addresses, rUv token exchange, and business plan payouts

[![npm version](https://img.shields.io/npm/v/@deflex.net/qudag-cli.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/qudag-cli)
[![npm downloads](https://img.shields.io/npm/dm/@deflex.net/qudag-cli.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/qudag-cli)
[![license](https://img.shields.io/npm/l/@deflex.net/qudag-cli.svg?style=flat-square)](https://github.com/flexnetos/deflex.net/blob/main/LICENSE)
...
`@deflex.net/qudag-cli` is a high-performance Node.js native addon that provides TypeScript bindings for the [`qudag-cli`](https://crates.io/crates/qudag-cli) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
- **License**: MIT
- **Rust Crate**: [qudag-cli](https://crates.io/crates/qudag-cli)
...
```bash
npm install @deflex.net/qudag-cli
```

### Using yarn

```bash
yarn add @deflex.net/qudag-cli
```

### Using pnpm

```bash
pnpm add @deflex.net/qudag-cli
```
...
- **Linux x64**: `@deflex.net/qudag-cli-linux-x64-gnu`
- **Linux ARM64**: `@deflex.net/qudag-cli-linux-arm64-gnu`
- **macOS x64**: `@deflex.net/qudag-cli-darwin-x64`
- **macOS ARM64**: `@deflex.net/qudag-cli-darwin-arm64`
- **Windows x64**: `@deflex.net/qudag-cli-win32-x64-msvc`
- **WebAssembly**: `@deflex.net/qudag-cli-wasm32` (fallback)
...
```typescript
import { QudagCli } from '@deflex.net/qudag-cli'

// Create an instance
const client = new QudagCli({
...
```typescript
import { QudagCli, Config } from '@deflex.net/qudag-cli'
...
const client = new QudagCli(config)
```
...
// CommonJS
const { QudagCli } = require('@deflex.net/qudag-cli')
```
...
try {
  ...
  if (error instanceof QudagCliError) {
...
Creates a new instance of `QudagCli`.

**Parameters:**
- `config` (optional): Configuration object

**Returns:**
- Instance of `QudagCli`
...
```typescript
class QudagCliError extends Error {
  code: string
  details?: any
}
```
...
```typescript
import { QudagCli, QudagCliError } from '@deflex.net/qudag-cli'
...
```typescript
import { QudagCli, Config, LogLevel } from '@deflex.net/qudag-cli'
...
cd deflex.net/packages/qudag-cli
...
- **NPM Package**: [@deflex.net/qudag-cli](https://www.npmjs.com/package/@deflex.net/qudag-cli)
- **GitHub Repository**: [flexnetos/deflex.net](https://github.com/flexnetos/deflex.net)
- **Rust Crate**: [qudag-cli](https://crates.io/crates/qudag-cli)
- **Documentation**: [docs.deflex.net/qudag-cli](https://docs.deflex.net/qudag-cli)
...
- Original crate by the [qudag-cli](https://crates.io/crates/qudag-cli) authors

---

## 📊 Stats

![NPM](https://nodei.co/npm/@deflex.net/qudag-cli.png?downloads=true&downloadRank=true&stars=true)
