# 👁️ @deflex.net/opencv-core

> OpenCV Core module - fundamental data structures and operations

[![npm version](https://img.shields.io/npm/v/@deflex.net/opencv-core.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/opencv-core)
[![npm downloads](https://img.shields.io/npm/dm/@deflex.net/opencv-core.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/opencv-core)
[![license](https://img.shields.io/npm/l/@deflex.net/opencv-core.svg?style=flat-square)](https://github.com/flexnetos/deflex.net/blob/main/LICENSE)
...
`@deflex.net/opencv-core` is a high-performance Node.js native addon that provides TypeScript bindings for the [`opencv-core`](https://crates.io/crates/opencv-core) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
- **License**: MIT
- **Rust Crate**: [opencv-core](https://crates.io/crates/opencv-core)
...
```bash
npm install @deflex.net/opencv-core
```

### Using yarn

```bash
yarn add @deflex.net/opencv-core
```

### Using pnpm

```bash
pnpm add @deflex.net/opencv-core
```
...
- **Linux x64**: `@deflex.net/opencv-core-linux-x64-gnu`
- **Linux ARM64**: `@deflex.net/opencv-core-linux-arm64-gnu`
- **macOS x64**: `@deflex.net/opencv-core-darwin-x64`
- **macOS ARM64**: `@deflex.net/opencv-core-darwin-arm64`
- **Windows x64**: `@deflex.net/opencv-core-win32-x64-msvc`
- **WebAssembly**: `@deflex.net/opencv-core-wasm32` (fallback)
...
```typescript
import { OpencvCore } from '@deflex.net/opencv-core'

// Create an instance
const client = new OpencvCore({
...
```typescript
import { OpencvCore, Config } from '@deflex.net/opencv-core'
...
const client = new OpencvCore(config)
```
...
// CommonJS
const { OpencvCore } = require('@deflex.net/opencv-core')
```
...
try {
  ...
  if (error instanceof OpencvCoreError) {
...
Creates a new instance of `OpencvCore`.

**Parameters:**
- `config` (optional): Configuration object

**Returns:**
- Instance of `OpencvCore`
...
```typescript
class OpencvCoreError extends Error {
  code: string
  details?: any
}
```
...
```typescript
import { OpencvCore, OpencvCoreError } from '@deflex.net/opencv-core'
...
```typescript
import { OpencvCore, Config, LogLevel } from '@deflex.net/opencv-core'
...
cd deflex.net/packages/opencv-core
...
- **NPM Package**: [@deflex.net/opencv-core](https://www.npmjs.com/package/@deflex.net/opencv-core)
- **GitHub Repository**: [flexnetos/deflex.net](https://github.com/flexnetos/deflex.net)
- **Rust Crate**: [opencv-core](https://crates.io/crates/opencv-core)
- **Documentation**: [docs.deflex.net/opencv-core](https://docs.deflex.net/opencv-core)
...
- Original crate by the [opencv-core](https://crates.io/crates/opencv-core) authors

---

## 📊 Stats

![NPM](https://nodei.co/npm/@deflex.net/opencv-core.png?downloads=true&downloadRank=true&stars=true)
