...
[![npm version](https://img.shields.io/npm/v/@deflex.net/daa-ai.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/daa-ai)
[![npm downloads](https://img.shields.io/npm/dm/@deflex.net/daa-ai.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/daa-ai)
[![license](https://img.shields.io/npm/l/@deflex.net/daa-ai.svg?style=flat-square)](https://github.com/flexnetos/deflex.net/blob/main/LICENSE)
...
`@deflex.net/daa-ai` is a high-performance Node.js native addon that provides TypeScript bindings for the [`daa-ai`](https://crates.io/crates/daa-ai) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.

**Key Information:**
- **Version**: 0.2.1
- **Downloads**: 1,650+
- **Categories**: Ai Ml Systems, Mcp Protocol
- **License**: MIT
- **Rust Crate**: [daa-ai](https://crates.io/crates/daa-ai)
...
```bash
npm install @deflex.net/daa-ai
```

### Using yarn

```bash
yarn add @deflex.net/daa-ai
```

### Using pnpm

```bash
pnpm add @deflex.net/daa-ai
```
...
- **Linux x64**: `@deflex.net/daa-ai-linux-x64-gnu`
- **Linux ARM64**: `@deflex.net/daa-ai-linux-arm64-gnu`
- **macOS x64**: `@deflex.net/daa-ai-darwin-x64`
- **macOS ARM64**: `@deflex.net/daa-ai-darwin-arm64`
- **Windows x64**: `@deflex.net/daa-ai-win32-x64-msvc`
- **WebAssembly**: `@deflex.net/daa-ai-wasm32` (fallback)
...
```typescript
import { DaaAi } from '@deflex.net/daa-ai'

// Create an instance
const client = new DaaAi({
...
```typescript
import { DaaAi, Config } from '@deflex.net/daa-ai'
...
// CommonJS
const { DaaAi } = require('@deflex.net/daa-ai')
```
...
try {
  ...
  if (error instanceof DaaAiError) {
...
Creates a new instance of `DaaAi`.
...
```typescript
class DaaAiError extends Error {
  code: string
  details?: any
}
```
...
```typescript
import { DaaAi, DaaAiError } from '@deflex.net/daa-ai'
...
```typescript
import { DaaAi, Config, LogLevel } from '@deflex.net/daa-ai'
...
- **NPM Package**: [@deflex.net/daa-ai](https://www.npmjs.com/package/@deflex.net/daa-ai)
- **GitHub Repository**: [flexnetos/deflex.net](https://github.com/flexnetos/deflex.net)
- **Rust Crate**: [daa-ai](https://crates.io/crates/daa-ai)
- **Documentation**: [docs.deflex.net/daa-ai](https://docs.deflex.net/daa-ai)
...
- Original crate by the [daa-ai](https://crates.io/crates/daa-ai) authors

---

## 📊 Stats

![NPM](https://nodei.co/npm/@deflex.net/daa-ai.png?downloads=true&downloadRank=true&stars=true)
