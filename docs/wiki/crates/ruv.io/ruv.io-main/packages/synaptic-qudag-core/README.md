# ⚛️ @deflex.net/synaptic-qudag-core

> QuDAG core networking for Synaptic Neural Mesh - DAG-based consensus and P2P networking

[![npm version](https://img.shields.io/npm/v/@deflex.net/synaptic-qudag-core.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/synaptic-qudag-core)
[![npm downloads](https://img.shields.io/npm/dm/@deflex.net/synaptic-qudag-core.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/synaptic-qudag-core)
[![license](https://img.shields.io/npm/l/@deflex.net/synaptic-qudag-core.svg?style=flat-square)](https://github.com/flexnetos/deflex.net/blob/main/LICENSE)
...
`@deflex.net/synaptic-qudag-core` is a high-performance Node.js native addon that provides TypeScript bindings for the [`synaptic-qudag-core`](https://crates.io/crates/synaptic-qudag-core) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
- **License**: MIT
- **Rust Crate**: [synaptic-qudag-core](https://crates.io/crates/synaptic-qudag-core)
...
```bash
npm install @deflex.net/synaptic-qudag-core
```

### Using yarn

```bash
yarn add @deflex.net/synaptic-qudag-core
```

### Using pnpm

```bash
pnpm add @deflex.net/synaptic-qudag-core
```
...
- **Linux x64**: `@deflex.net/synaptic-qudag-core-linux-x64-gnu`
- **Linux ARM64**: `@deflex.net/synaptic-qudag-core-linux-arm64-gnu`
- **macOS x64**: `@deflex.net/synaptic-qudag-core-darwin-x64`
- **macOS ARM64**: `@deflex.net/synaptic-qudag-core-darwin-arm64`
- **Windows x64**: `@deflex.net/synaptic-qudag-core-win32-x64-msvc`
- **WebAssembly**: `@deflex.net/synaptic-qudag-core-wasm32` (fallback)
...
```typescript
import { SynapticQudagCore } from '@deflex.net/synaptic-qudag-core'

// Create an instance
const client = new SynapticQudagCore({
...
```typescript
import { SynapticQudagCore, configs } from '@deflex.net/synaptic-qudag-core'
...
const client = new SynapticQudagCore(configs)
```
...
// CommonJS
const { SynapticQudagCore } = require('@deflex.net/synaptic-qudag-core')
```
...
try {
  ...
  if (error instanceof SynapticQudagCoreError) {
...
Creates a new instance of `SynapticQudagCore`.

**Parameters:**
- `configs` (optional): configsuration object

**Returns:**
- Instance of `SynapticQudagCore`
...
#### `SynapticQudagCoreError`

Base error class for all errors thrown by this package.

```typescript
class SynapticQudagCoreError extends Error {
  code: string
  details?: any
}
```
...
```typescript
import { SynapticQudagCore, SynapticQudagCoreError } from '@deflex.net/synaptic-qudag-core'
...
```typescript
import { SynapticQudagCore, configs, LogLevel } from '@deflex.net/synaptic-qudag-core'
...
cd deflex.net/packages/synaptic-qudag-core
...
- **NPM Package**: [@deflex.net/synaptic-qudag-core](https://www.npmjs.com/package/@deflex.net/synaptic-qudag-core)
- **GitHub Repository**: [flexnetos/deflex.net](https://github.com/flexnetos/deflex.net)
- **Rust Crate**: [synaptic-qudag-core](https://crates.io/crates/synaptic-qudag-core)
- **Documentation**: [docs.deflex.net/synaptic-qudag-core](https://docs.deflex.net/synaptic-qudag-core)
...
- Original crate by the [synaptic-qudag-core](https://crates.io/crates/synaptic-qudag-core) authors

---

## 📊 Stats

![NPM](https://nodei.co/npm/@deflex.net/synaptic-qudag-core.png?downloads=true&downloadRank=true&stars=true)
