...
```typescript
import { SynapticQudagCore, Config } from '@deflex.net/synaptic-qudag-core'
...
const client = new SynapticQudagCore(config)
```
...
```typescript
import { SynapticQudagCore, Config, LogLevel } from '@deflex.net/synaptic-qudag-core'
