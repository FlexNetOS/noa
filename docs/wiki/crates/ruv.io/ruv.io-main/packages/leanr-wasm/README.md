# 📝 @deflex.net/leanr-wasm

> WebAssembly bindings for lean-agentic: hash-consed dependent types in the browser

[![npm version](https://img.shields.io/npm/v/@deflex.net/leanr-wasm.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/leanr-wasm)
[![npm downloads](https://img.shields.io/npm/dm/@deflex.net/leanr-wasm.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/leanr-wasm)
[![license](https://img.shields.io/npm/l/@deflex.net/leanr-wasm.svg?style=flat-square)](https://github.com/flexnetos/deflex.net/blob/main/LICENSE)
...
`@deflex.net/leanr-wasm` is a high-performance Node.js native addon that provides TypeScript bindings for the [`leanr-wasm`](https://crates.io/crates/leanr-wasm) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.

**Key Information:**
- **Version**: 0.1.0
- **Downloads**: 159+
- **Categories**: Wasm Bindings, Type Systems
- **License**: MIT
- **Rust Crate**: [leanr-wasm](https://crates.io/crates/leanr-wasm)
...
```bash
npm install @deflex.net/leanr-wasm
```

### Using yarn

```bash
yarn add @deflex.net/leanr-wasm
```

### Using pnpm

```bash
pnpm add @deflex.net/leanr-wasm
```
...
- **Linux x64**: `@deflex.net/leanr-wasm-linux-x64-gnu`
- **Linux ARM64**: `@deflex.net/leanr-wasm-linux-arm64-gnu`
- **macOS x64**: `@deflex.net/leanr-wasm-darwin-x64`
- **macOS ARM64**: `@deflex.net/leanr-wasm-darwin-arm64`
- **Windows x64**: `@deflex.net/leanr-wasm-win32-x64-msvc`
- **WebAssembly**: `@deflex.net/leanr-wasm-wasm32` (fallback)
...
```typescript
import { LeanrWasm } from '@deflex.net/leanr-wasm'

// Create an instance
const client = new LeanrWasm({
...
```typescript
import { LeanrWasm, configs } from '@deflex.net/leanr-wasm'
...
const client = new LeanrWasm(configs)
```
...
// CommonJS
const { LeanrWasm } = require('@deflex.net/leanr-wasm')
```
...
try {
  ...
  if (error instanceof LeanrWasmError) {
...
Creates a new instance of `LeanrWasm`.

**Parameters:**
- `configs` (optional): configsuration object

**Returns:**
- Instance of `LeanrWasm`
...
```typescript
class LeanrWasmError extends Error {
  code: string
  details?: any
}
```
...
```typescript
import { LeanrWasm, LeanrWasmError } from '@deflex.net/leanr-wasm'
...
```typescript
import { LeanrWasm, configs, LogLevel } from '@deflex.net/leanr-wasm'
...
cd deflex.net/packages/leanr-wasm
...
- **NPM Package**: [@deflex.net/leanr-wasm](https://www.npmjs.com/package/@deflex.net/leanr-wasm)
- **GitHub Repository**: [flexnetos/deflex.net](https://github.com/flexnetos/deflex.net)
- **Rust Crate**: [leanr-wasm](https://crates.io/crates/leanr-wasm)
- **Documentation**: [docs.deflex.net/leanr-wasm](https://docs.deflex.net/leanr-wasm)
...
- Original crate by the [leanr-wasm](https://crates.io/crates/leanr-wasm) authors

---

## 📊 Stats

![NPM](https://nodei.co/npm/@deflex.net/leanr-wasm.png?downloads=true&downloadRank=true&stars=true)
