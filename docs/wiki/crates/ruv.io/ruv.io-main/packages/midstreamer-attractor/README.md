# ⏰ @deflex.net/midstreamer-attractor

> Dynamical systems and strange attractors analysis

[![npm version](https://img.shields.io/npm/v/@deflex.net/midstreamer-attractor.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/midstreamer-attractor)
[![npm downloads](https://img.shields.io/npm/dm/@deflex.net/midstreamer-attractor.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/midstreamer-attractor)
[![license](https://img.shields.io/npm/l/@deflex.net/midstreamer-attractor.svg?style=flat-square)](https://github.com/flexnetos/deflex.net/blob/main/LICENSE)
...
`@deflex.net/midstreamer-attractor` is a high-performance Node.js native addon that provides TypeScript bindings for the [`midstreamer-attractor`](https://crates.io/crates/midstreamer-attractor) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
- **License**: MIT
- **Rust Crate**: [midstreamer-attractor](https://crates.io/crates/midstreamer-attractor)
...
```bash
npm install @deflex.net/midstreamer-attractor
```

### Using yarn

```bash
yarn add @deflex.net/midstreamer-attractor
```

### Using pnpm

```bash
pnpm add @deflex.net/midstreamer-attractor
```
...
- **Linux x64**: `@deflex.net/midstreamer-attractor-linux-x64-gnu`
- **Linux ARM64**: `@deflex.net/midstreamer-attractor-linux-arm64-gnu`
- **macOS x64**: `@deflex.net/midstreamer-attractor-darwin-x64`
- **macOS ARM64**: `@deflex.net/midstreamer-attractor-darwin-arm64`
- **Windows x64**: `@deflex.net/midstreamer-attractor-win32-x64-msvc`
- **WebAssembly**: `@deflex.net/midstreamer-attractor-wasm32` (fallback)
...
```typescript
import { MidstreamerAttractor } from '@deflex.net/midstreamer-attractor'

// Create an instance
const client = new MidstreamerAttractor({
...
```typescript
import { MidstreamerAttractor, Config } from '@deflex.net/midstreamer-attractor'
...
const client = new MidstreamerAttractor(config)
```
...
// CommonJS
const { MidstreamerAttractor } = require('@deflex.net/midstreamer-attractor')
```
...
try {
  ...
  if (error instanceof MidstreamerAttractorError) {
...
### Main Class: `MidstreamerAttractor`
...
Creates a new instance of `MidstreamerAttractor`.

**Parameters:**
- `config` (optional): Configuration object

**Returns:**
- Instance of `MidstreamerAttractor`
...
#### `MidstreamerAttractorError`

Base error class for all errors thrown by this package.

```typescript
class MidstreamerAttractorError extends Error {
  code: string
  details?: any
}
```
...
```typescript
import { MidstreamerAttractor, MidstreamerAttractorError } from '@deflex.net/midstreamer-attractor'
...
```typescript
import { MidstreamerAttractor, Config, LogLevel } from '@deflex.net/midstreamer-attractor'
...
cd deflex.net/packages/midstreamer-attractor
...
- **NPM Package**: [@deflex.net/midstreamer-attractor](https://www.npmjs.com/package/@deflex.net/midstreamer-attractor)
- **GitHub Repository**: [flexnetos/deflex.net](https://github.com/flexnetos/deflex.net)
- **Rust Crate**: [midstreamer-attractor](https://crates.io/crates/midstreamer-attractor)
- **Documentation**: [docs.deflex.net/midstreamer-attractor](https://docs.deflex.net/midstreamer-attractor)
...
- Original crate by the [midstreamer-attractor](https://crates.io/crates/midstreamer-attractor) authors

---

## 📊 Stats

![NPM](https://nodei.co/npm/@deflex.net/midstreamer-attractor.png?downloads=true&downloadRank=true&stars=true)
