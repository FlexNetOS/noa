# 🐝 @deflex.net/ruv-swarm-persistence

> Persistence layer with SQLite and ORM for RUV-Swarm

[![npm version](https://img.shields.io/npm/v/@deflex.net/ruv-swarm-persistence.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/ruv-swarm-persistence)
[![npm downloads](https://img.shields.io/npm/dm/@deflex.net/ruv-swarm-persistence.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/ruv-swarm-persistence)
[![license](https://img.shields.io/npm/l/@deflex.net/ruv-swarm-persistence.svg?style=flat-square)](https://github.com/flexnetos/deflex.net/blob/main/LICENSE)
...
`@deflex.net/ruv-swarm-persistence` is a high-performance Node.js native addon that provides TypeScript bindings for the [`ruv-swarm-persistence`](https://crates.io/crates/ruv-swarm-persistence) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.

**Key Information:**
- **Version**: 1.0.5
- **Downloads**: 1,313+
- **Categories**: Swarm Orchestration, Databases
- **License**: MIT
- **Rust Crate**: [ruv-swarm-persistence](https://crates.io/crates/ruv-swarm-persistence)
...
```bash
npm install @deflex.net/ruv-swarm-persistence
```

### Using yarn

```bash
yarn add @deflex.net/ruv-swarm-persistence
```

### Using pnpm

```bash
pnpm add @deflex.net/ruv-swarm-persistence
```
...
- **Linux x64**: `@deflex.net/ruv-swarm-persistence-linux-x64-gnu`
- **Linux ARM64**: `@deflex.net/ruv-swarm-persistence-linux-arm64-gnu`
- **macOS x64**: `@deflex.net/ruv-swarm-persistence-darwin-x64`
- **macOS ARM64**: `@deflex.net/ruv-swarm-persistence-darwin-arm64`
- **Windows x64**: `@deflex.net/ruv-swarm-persistence-win32-x64-msvc`
- **WebAssembly**: `@deflex.net/ruv-swarm-persistence-wasm32` (fallback)
...
```typescript
import { RuvSwarmPersistence } from '@deflex.net/ruv-swarm-persistence'
...
const client = new RuvSwarmPersistence(config)
```
...
// CommonJS
const { RuvSwarmPersistence } = require('@deflex.net/ruv-swarm-persistence')
```
...
try {
  ...
  if (error instanceof RuvSwarmPersistenceError) {
...
### Main Class: `RuvSwarmPersistence`
...
Creates a new instance of `RuvSwarmPersistence`.

**Parameters:**
- `config` (optional): Configuration object

**Returns:**
- Instance of `RuvSwarmPersistence`
...
#### `RuvSwarmPersistenceError`

Base error class for all errors thrown by this package.

```typescript
class RuvSwarmPersistenceError extends Error {
  code: string
  details?: any
}
```
...
```typescript
import { RuvSwarmPersistence, RuvSwarmPersistenceError } from '@deflex.net/ruv-swarm-persistence'
...
```typescript
import { RuvSwarmPersistence, Config, LogLevel } from '@deflex.net/ruv-swarm-persistence'
...
cd deflex.net/packages/ruv-swarm-persistence
...
- **NPM Package**: [@deflex.net/ruv-swarm-persistence](https://www.npmjs.com/package/@deflex.net/ruv-swarm-persistence)
- **GitHub Repository**: [flexnetos/deflex.net](https://github.com/flexnetos/deflex.net)
- **Rust Crate**: [ruv-swarm-persistence](https://crates.io/crates/ruv-swarm-persistence)
- **Documentation**: [docs.deflex.net/ruv-swarm-persistence](https://docs.deflex.net/ruv-swarm-persistence)
...
- Original crate by the [ruv-swarm-persistence](https://crates.io/crates/ruv-swarm-persistence) authors

---

## 📊 Stats

![NPM](https://nodei.co/npm/@deflex.net/ruv-swarm-persistence.png?downloads=true&downloadRank=true&stars=true)
