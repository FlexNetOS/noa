# 🧠 @deflex.net/neuro-divergent-models

> Neural forecasting models implemented using ruv-FANN for time series forecasting

[![npm version](https://img.shields.io/npm/v/@deflex.net/neuro-divergent-models.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/neuro-divergent-models)
[![npm downloads](https://img.shields.io/npm/dm/@deflex.net/neuro-divergent-models.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/neuro-divergent-models)
[![license](https://img.shields.io/npm/l/@deflex.net/neuro-divergent-models.svg?style=flat-square)](https://github.com/flexnetos/deflex.net/blob/main/LICENSE)
...
`@deflex.net/neuro-divergent-models` is a high-performance Node.js native addon that provides TypeScript bindings for the [`neuro-divergent-models`](https://crates.io/crates/neuro-divergent-models) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
- **License**: MIT
- **Rust Crate**: [neuro-divergent-models](https://crates.io/crates/neuro-divergent-models)
...
```bash
npm install @deflex.net/neuro-divergent-models
```

### Using yarn

```bash
yarn add @deflex.net/neuro-divergent-models
```

### Using pnpm

```bash
pnpm add @deflex.net/neuro-divergent-models
```
...
- **Linux x64**: `@deflex.net/neuro-divergent-models-linux-x64-gnu`
- **Linux ARM64**: `@deflex.net/neuro-divergent-models-linux-arm64-gnu`
- **macOS x64**: `@deflex.net/neuro-divergent-models-darwin-x64`
- **macOS ARM64**: `@deflex.net/neuro-divergent-models-darwin-arm64`
- **Windows x64**: `@deflex.net/neuro-divergent-models-win32-x64-msvc`
- **WebAssembly**: `@deflex.net/neuro-divergent-models-wasm32` (fallback)
...
```typescript
import { NeuroDivergentModels } from '@deflex.net/neuro-divergent-models'

// Create an instance
const client = new NeuroDivergentModels({
...
```typescript
import { NeuroDivergentModels, Config } from '@deflex.net/neuro-divergent-models'
...
const client = new NeuroDivergentModels(config)
```
...
// Train a model
const model = new NeuroDivergentModels({
  layers: [64, 128, 64],
  activation: 'relu'
})
...
// CommonJS
const { NeuroDivergentModels } = require('@deflex.net/neuro-divergent-models')
```
...
try {
  ...
  if (error instanceof NeuroDivergentModelsError) {
...
### Main Class: `NeuroDivergentModels`
...
Creates a new instance of `NeuroDivergentModels`.

**Parameters:**
- `config` (optional): Configuration object

**Returns:**
- Instance of `NeuroDivergentModels`
...
#### `NeuroDivergentModelsError`

Base error class for all errors thrown by this package.

```typescript
class NeuroDivergentModelsError extends Error {
  code: string
  details?: any
}
```
...
```typescript
import { NeuroDivergentModels, NeuroDivergentModelsError } from '@deflex.net/neuro-divergent-models'
...
```typescript
import { NeuroDivergentModels, Config, LogLevel } from '@deflex.net/neuro-divergent-models'
...
cd deflex.net/packages/neuro-divergent-models
...
- **NPM Package**: [@deflex.net/neuro-divergent-models](https://www.npmjs.com/package/@deflex.net/neuro-divergent-models)
- **GitHub Repository**: [flexnetos/deflex.net](https://github.com/flexnetos/deflex.net)
- **Rust Crate**: [neuro-divergent-models](https://crates.io/crates/neuro-divergent-models)
- **Documentation**: [docs.deflex.net/neuro-divergent-models](https://docs.deflex.net/neuro-divergent-models)
...
- Original crate by the [neuro-divergent-models](https://crates.io/crates/neuro-divergent-models) authors

---

## 📊 Stats

![NPM](https://nodei.co/npm/@deflex.net/neuro-divergent-models.png?downloads=true&downloadRank=true&stars=true)
