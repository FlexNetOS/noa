...
[![npm version](https://img.shields.io/npm/v/@deflex.net/goalie.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/goalie)
[![npm downloads](https://img.shields.io/npm/dm/@deflex.net/goalie.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/goalie)
[![license](https://img.shields.io/npm/l/@deflex.net/goalie.svg?style=flat-square)](https://github.com/flexnetos/deflex.net/blob/main/LICENSE)
...
`@deflex.net/goalie` is a high-performance Node.js native addon that provides TypeScript bindings for the [`goalie`](https://crates.io/crates/goalie) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
- **License**: MIT
- **Rust Crate**: [goalie](https://crates.io/crates/goalie)
...
```bash
npm install @deflex.net/goalie
```

### Using yarn

```bash
yarn add @deflex.net/goalie
```

### Using pnpm

```bash
pnpm add @deflex.net/goalie
```
...
- **Linux x64**: `@deflex.net/goalie-linux-x64-gnu`
- **Linux ARM64**: `@deflex.net/goalie-linux-arm64-gnu`
- **macOS x64**: `@deflex.net/goalie-darwin-x64`
- **macOS ARM64**: `@deflex.net/goalie-darwin-arm64`
- **Windows x64**: `@deflex.net/goalie-win32-x64-msvc`
- **WebAssembly**: `@deflex.net/goalie-wasm32` (fallback)
...
```typescript
import { Goalie } from '@deflex.net/goalie'
...
```typescript
import { Goalie, Config } from '@deflex.net/goalie'
...
// CommonJS
const { Goalie } = require('@deflex.net/goalie')
```
...
```typescript
class GoalieError extends Error {
  code: string
  details?: any
}
```
...
```typescript
import { Goalie, GoalieError } from '@deflex.net/goalie'
...
```typescript
import { Goalie, Config, LogLevel } from '@deflex.net/goalie'
...
- **NPM Package**: [@deflex.net/goalie](https://www.npmjs.com/package/@deflex.net/goalie)
- **GitHub Repository**: [flexnetos/deflex.net](https://github.com/flexnetos/deflex.net)
- **Rust Crate**: [goalie](https://crates.io/crates/goalie)
- **Documentation**: [docs.deflex.net/goalie](https://docs.deflex.net/goalie)
...
- Original crate by the [goalie](https://crates.io/crates/goalie) authors

---

## 📊 Stats

![NPM](https://nodei.co/npm/@deflex.net/goalie.png?downloads=true&downloadRank=true&stars=true)
