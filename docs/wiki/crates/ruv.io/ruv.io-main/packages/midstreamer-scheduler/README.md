# ⏰ @deflex.net/midstreamer-scheduler

> Ultra-low-latency real-time task scheduler

[![npm version](https://img.shields.io/npm/v/@deflex.net/midstreamer-scheduler.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/midstreamer-scheduler)
[![npm downloads](https://img.shields.io/npm/dm/@deflex.net/midstreamer-scheduler.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/midstreamer-scheduler)
[![license](https://img.shields.io/npm/l/@deflex.net/midstreamer-scheduler.svg?style=flat-square)](https://github.com/flexnetos/deflex.net/blob/main/LICENSE)
...
`@deflex.net/midstreamer-scheduler` is a high-performance Node.js native addon that provides TypeScript bindings for the [`midstreamer-scheduler`](https://crates.io/crates/midstreamer-scheduler) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
- **License**: MIT
- **Rust Crate**: [midstreamer-scheduler](https://crates.io/crates/midstreamer-scheduler)
...
```bash
npm install @deflex.net/midstreamer-scheduler
```

### Using yarn

```bash
yarn add @deflex.net/midstreamer-scheduler
```

### Using pnpm

```bash
pnpm add @deflex.net/midstreamer-scheduler
```
...
- **Linux x64**: `@deflex.net/midstreamer-scheduler-linux-x64-gnu`
- **Linux ARM64**: `@deflex.net/midstreamer-scheduler-linux-arm64-gnu`
- **macOS x64**: `@deflex.net/midstreamer-scheduler-darwin-x64`
- **macOS ARM64**: `@deflex.net/midstreamer-scheduler-darwin-arm64`
- **Windows x64**: `@deflex.net/midstreamer-scheduler-win32-x64-msvc`
- **WebAssembly**: `@deflex.net/midstreamer-scheduler-wasm32` (fallback)
...
```typescript
import { MidstreamerScheduler } from '@deflex.net/midstreamer-scheduler'

// Create an instance
const client = new MidstreamerScheduler({
...
```typescript
import { MidstreamerScheduler, Config } from '@deflex.net/midstreamer-scheduler'
...
const client = new MidstreamerScheduler(config)
```
...
// CommonJS
const { MidstreamerScheduler } = require('@deflex.net/midstreamer-scheduler')
```
...
try {
  ...
  if (error instanceof MidstreamerSchedulerError) {
...
### Main Class: `MidstreamerScheduler`
...
Creates a new instance of `MidstreamerScheduler`.

**Parameters:**
- `config` (optional): Configuration object

**Returns:**
- Instance of `MidstreamerScheduler`
...
#### `MidstreamerSchedulerError`

Base error class for all errors thrown by this package.

```typescript
class MidstreamerSchedulerError extends Error {
  code: string
  details?: any
}
```
...
```typescript
import { MidstreamerScheduler, MidstreamerSchedulerError } from '@deflex.net/midstreamer-scheduler'
...
```typescript
import { MidstreamerScheduler, Config, LogLevel } from '@deflex.net/midstreamer-scheduler'
...
cd deflex.net/packages/midstreamer-scheduler
...
- **NPM Package**: [@deflex.net/midstreamer-scheduler](https://www.npmjs.com/package/@deflex.net/midstreamer-scheduler)
- **GitHub Repository**: [flexnetos/deflex.net](https://github.com/flexnetos/deflex.net)
- **Rust Crate**: [midstreamer-scheduler](https://crates.io/crates/midstreamer-scheduler)
- **Documentation**: [docs.deflex.net/midstreamer-scheduler](https://docs.deflex.net/midstreamer-scheduler)
...
- Original crate by the [midstreamer-scheduler](https://crates.io/crates/midstreamer-scheduler) authors

---

## 📊 Stats

![NPM](https://nodei.co/npm/@deflex.net/midstreamer-scheduler.png?downloads=true&downloadRank=true&stars=true)
