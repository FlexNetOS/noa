# ⏰ @deflex.net/midstreamer-strange-loop

> Self-referential systems and meta-learning

[![npm version](https://img.shields.io/npm/v/@deflex.net/midstreamer-strange-loop.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/midstreamer-strange-loop)
[![npm downloads](https://img.shields.io/npm/dm/@deflex.net/midstreamer-strange-loop.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/midstreamer-strange-loop)
[![license](https://img.shields.io/npm/l/@deflex.net/midstreamer-strange-loop.svg?style=flat-square)](https://github.com/flexnetos/deflex.net/blob/main/LICENSE)
...
`@deflex.net/midstreamer-strange-loop` is a high-performance Node.js native addon that provides TypeScript bindings for the [`midstreamer-strange-loop`](https://crates.io/crates/midstreamer-strange-loop) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
- **License**: MIT
- **Rust Crate**: [midstreamer-strange-loop](https://crates.io/crates/midstreamer-strange-loop)
...
```bash
npm install @deflex.net/midstreamer-strange-loop
```

### Using yarn

```bash
yarn add @deflex.net/midstreamer-strange-loop
```

### Using pnpm

```bash
pnpm add @deflex.net/midstreamer-strange-loop
```
...
- **Linux x64**: `@deflex.net/midstreamer-strange-loop-linux-x64-gnu`
- **Linux ARM64**: `@deflex.net/midstreamer-strange-loop-linux-arm64-gnu`
- **macOS x64**: `@deflex.net/midstreamer-strange-loop-darwin-x64`
- **macOS ARM64**: `@deflex.net/midstreamer-strange-loop-darwin-arm64`
- **Windows x64**: `@deflex.net/midstreamer-strange-loop-win32-x64-msvc`
- **WebAssembly**: `@deflex.net/midstreamer-strange-loop-wasm32` (fallback)
...
```typescript
import { MidstreamerStrangeLoop } from '@deflex.net/midstreamer-strange-loop'
...
```typescript
import { MidstreamerStrangeLoop, Config } from '@deflex.net/midstreamer-strange-loop'
...
const client = new MidstreamerStrangeLoop(config)
```
...
// CommonJS
const { MidstreamerStrangeLoop } = require('@deflex.net/midstreamer-strange-loop')
```
...
try {
  ...
  if (error instanceof MidstreamerStrangeLoopError) {
...
### Main Class: `MidstreamerStrangeLoop`
...
Creates a new instance of `MidstreamerStrangeLoop`.

**Parameters:**
- `config` (optional): Configuration object

**Returns:**
- Instance of `MidstreamerStrangeLoop`
...
#### `MidstreamerStrangeLoopError`

Base error class for all errors thrown by this package.

```typescript
class MidstreamerStrangeLoopError extends Error {
  code: string
  details?: any
}
```
...
```typescript
import { MidstreamerStrangeLoop, MidstreamerStrangeLoopError } from '@deflex.net/midstreamer-strange-loop'
...
```typescript
import { MidstreamerStrangeLoop, Config, LogLevel } from '@deflex.net/midstreamer-strange-loop'
...
cd deflex.net/packages/midstreamer-strange-loop
...
- **NPM Package**: [@deflex.net/midstreamer-strange-loop](https://www.npmjs.com/package/@deflex.net/midstreamer-strange-loop)
- **GitHub Repository**: [flexnetos/deflex.net](https://github.com/flexnetos/deflex.net)
- **Rust Crate**: [midstreamer-strange-loop](https://crates.io/crates/midstreamer-strange-loop)
- **Documentation**: [docs.deflex.net/midstreamer-strange-loop](https://docs.deflex.net/midstreamer-strange-loop)
...
- Original crate by the [midstreamer-strange-loop](https://crates.io/crates/midstreamer-strange-loop) authors

---

## 📊 Stats

![NPM](https://nodei.co/npm/@deflex.net/midstreamer-strange-loop.png?downloads=true&downloadRank=true&stars=true)
