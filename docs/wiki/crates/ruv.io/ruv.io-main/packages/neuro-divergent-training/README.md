# 🧠 @deflex.net/neuro-divergent-training

> Comprehensive training infrastructure for neural forecasting models

[![npm version](https://img.shields.io/npm/v/@deflex.net/neuro-divergent-training.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/neuro-divergent-training)
[![npm downloads](https://img.shields.io/npm/dm/@deflex.net/neuro-divergent-training.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/neuro-divergent-training)
[![license](https://img.shields.io/npm/l/@deflex.net/neuro-divergent-training.svg?style=flat-square)](https://github.com/flexnetos/deflex.net/blob/main/LICENSE)
...
`@deflex.net/neuro-divergent-training` is a high-performance Node.js native addon that provides TypeScript bindings for the [`neuro-divergent-training`](https://crates.io/crates/neuro-divergent-training) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
- **License**: MIT
- **Rust Crate**: [neuro-divergent-training](https://crates.io/crates/neuro-divergent-training)
...
```bash
npm install @deflex.net/neuro-divergent-training
```

### Using yarn

```bash
yarn add @deflex.net/neuro-divergent-training
```

### Using pnpm

```bash
pnpm add @deflex.net/neuro-divergent-training
```
...
- **Linux x64**: `@deflex.net/neuro-divergent-training-linux-x64-gnu`
- **Linux ARM64**: `@deflex.net/neuro-divergent-training-linux-arm64-gnu`
- **macOS x64**: `@deflex.net/neuro-divergent-training-darwin-x64`
- **macOS ARM64**: `@deflex.net/neuro-divergent-training-darwin-arm64`
- **Windows x64**: `@deflex.net/neuro-divergent-training-win32-x64-msvc`
- **WebAssembly**: `@deflex.net/neuro-divergent-training-wasm32` (fallback)
...
```typescript
import { NeuroDivergentTraining } from '@deflex.net/neuro-divergent-training'

// Create an instance
const client = new NeuroDivergentTraining({
...
```typescript
import { NeuroDivergentTraining, Config } from '@deflex.net/neuro-divergent-training'
...
const client = new NeuroDivergentTraining(config)
```
...
// Train a model
const model = new NeuroDivergentTraining({
  layers: [64, 128, 64],
  activation: 'relu'
})
...
// CommonJS
const { NeuroDivergentTraining } = require('@deflex.net/neuro-divergent-training')
```
...
try {
  ...
  if (error instanceof NeuroDivergentTrainingError) {
...
### Main Class: `NeuroDivergentTraining`
...
Creates a new instance of `NeuroDivergentTraining`.

**Parameters:**
- `config` (optional): Configuration object

**Returns:**
- Instance of `NeuroDivergentTraining`
...
#### `NeuroDivergentTrainingError`

Base error class for all errors thrown by this package.

```typescript
class NeuroDivergentTrainingError extends Error {
  code: string
  details?: any
}
```
...
```typescript
import { NeuroDivergentTraining, NeuroDivergentTrainingError } from '@deflex.net/neuro-divergent-training'
...
```typescript
import { NeuroDivergentTraining, Config, LogLevel } from '@deflex.net/neuro-divergent-training'
...
cd deflex.net/packages/neuro-divergent-training
...
- **NPM Package**: [@deflex.net/neuro-divergent-training](https://www.npmjs.com/package/@deflex.net/neuro-divergent-training)
- **GitHub Repository**: [flexnetos/deflex.net](https://github.com/flexnetos/deflex.net)
- **Rust Crate**: [neuro-divergent-training](https://crates.io/crates/neuro-divergent-training)
- **Documentation**: [docs.deflex.net/neuro-divergent-training](https://docs.deflex.net/neuro-divergent-training)
...
- Original crate by the [neuro-divergent-training](https://crates.io/crates/neuro-divergent-training) authors

---

## 📊 Stats

![NPM](https://nodei.co/npm/@deflex.net/neuro-divergent-training.png?downloads=true&downloadRank=true&stars=true)
