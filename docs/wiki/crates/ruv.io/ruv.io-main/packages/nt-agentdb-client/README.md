# 🗄️ @deflex.net/nt-agentdb-client

> AgentDB client for Neural Trader - vector database integration and agent memory management

[![npm version](https://img.shields.io/npm/v/@deflex.net/nt-agentdb-client.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/nt-agentdb-client)
[![npm downloads](https://img.shields.io/npm/dm/@deflex.net/nt-agentdb-client.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/nt-agentdb-client)
[![license](https://img.shields.io/npm/l/@deflex.net/nt-agentdb-client.svg?style=flat-square)](https://github.com/flexnetos/deflex.net/blob/main/LICENSE)
...
`@deflex.net/nt-agentdb-client` is a high-performance Node.js native addon that provides TypeScript bindings for the [`nt-agentdb-client`](https://crates.io/crates/nt-agentdb-client) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.

**Key Information:**
- **Version**: 1.0.0
- **Downloads**: 0+
- **Categories**: Cli Tools, Trading Finance, Databases
- **License**: MIT
- **Rust Crate**: [nt-agentdb-client](https://crates.io/crates/nt-agentdb-client)
...
```bash
npm install @deflex.net/nt-agentdb-client
```

### Using yarn

```bash
yarn add @deflex.net/nt-agentdb-client
```

### Using pnpm

```bash
pnpm add @deflex.net/nt-agentdb-client
```
...
- **Linux x64**: `@deflex.net/nt-agentdb-client-linux-x64-gnu`
- **Linux ARM64**: `@deflex.net/nt-agentdb-client-linux-arm64-gnu`
- **macOS x64**: `@deflex.net/nt-agentdb-client-darwin-x64`
- **macOS ARM64**: `@deflex.net/nt-agentdb-client-darwin-arm64`
- **Windows x64**: `@deflex.net/nt-agentdb-client-win32-x64-msvc`
- **WebAssembly**: `@deflex.net/nt-agentdb-client-wasm32` (fallback)
...
```typescript
import { NtAgentdbClient } from '@deflex.net/nt-agentdb-client'

// Create an instance
const client = new NtAgentdbClient({
...
```typescript
import { NtAgentdbClient, Config } from '@deflex.net/nt-agentdb-client'
...
const client = new NtAgentdbClient(config)
```
...
// CommonJS
const { NtAgentdbClient } = require('@deflex.net/nt-agentdb-client')
```
...
try {
  ...
  if (error instanceof NtAgentdbClientError) {
...
Creates a new instance of `NtAgentdbClient`.

**Parameters:**
- `config` (optional): Configuration object

**Returns:**
- Instance of `NtAgentdbClient`
...
#### `NtAgentdbClientError`

Base error class for all errors thrown by this package.

```typescript
class NtAgentdbClientError extends Error {
  code: string
  details?: any
}
```
...
```typescript
import { NtAgentdbClient, NtAgentdbClientError } from '@deflex.net/nt-agentdb-client'
...
```typescript
import { NtAgentdbClient, Config, LogLevel } from '@deflex.net/nt-agentdb-client'
...
cd deflex.net/packages/nt-agentdb-client
...
- **NPM Package**: [@deflex.net/nt-agentdb-client](https://www.npmjs.com/package/@deflex.net/nt-agentdb-client)
- **GitHub Repository**: [flexnetos/deflex.net](https://github.com/flexnetos/deflex.net)
- **Rust Crate**: [nt-agentdb-client](https://crates.io/crates/nt-agentdb-client)
- **Documentation**: [docs.deflex.net/nt-agentdb-client](https://docs.deflex.net/nt-agentdb-client)
...
- Original crate by the [nt-agentdb-client](https://crates.io/crates/nt-agentdb-client) authors

---

## 📊 Stats

![NPM](https://nodei.co/npm/@deflex.net/nt-agentdb-client.png?downloads=true&downloadRank=true&stars=true)
