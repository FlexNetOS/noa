# 🛠️ @deflex.net/fact-tools

> FACT (Fast Augmented Context Tools) - High-performance context processing engine for AI applications

[![npm version](https://img.shields.io/npm/v/@deflex.net/fact-tools.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/fact-tools)
[![npm downloads](https://img.shields.io/npm/dm/@deflex.net/fact-tools.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/fact-tools)
[![license](https://img.shields.io/npm/l/@deflex.net/fact-tools.svg?style=flat-square)](https://github.com/flexnetos/deflex.net/blob/main/LICENSE)
...
`@deflex.net/fact-tools` is a high-performance Node.js native addon that provides TypeScript bindings for the [`fact-tools`](https://crates.io/crates/fact-tools) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
- **License**: MIT
- **Rust Crate**: [fact-tools](https://crates.io/crates/fact-tools)
...
```bash
npm install @deflex.net/fact-tools
```

### Using yarn

```bash
yarn add @deflex.net/fact-tools
```

### Using pnpm

```bash
pnpm add @deflex.net/fact-tools
```
...
- **Linux x64**: `@deflex.net/fact-tools-linux-x64-gnu`
- **Linux ARM64**: `@deflex.net/fact-tools-linux-arm64-gnu`
- **macOS x64**: `@deflex.net/fact-tools-darwin-x64`
- **macOS ARM64**: `@deflex.net/fact-tools-darwin-arm64`
- **Windows x64**: `@deflex.net/fact-tools-win32-x64-msvc`
- **WebAssembly**: `@deflex.net/fact-tools-wasm32` (fallback)
...
```typescript
import { FactTools } from '@deflex.net/fact-tools'

// Create an instance
const client = new FactTools({
...
```typescript
import { FactTools, Config } from '@deflex.net/fact-tools'
...
const client = new FactTools(config)
```
...
// CommonJS
const { FactTools } = require('@deflex.net/fact-tools')
```
...
try {
  ...
  if (error instanceof FactToolsError) {
...
Creates a new instance of `FactTools`.

**Parameters:**
- `config` (optional): Configuration object

**Returns:**
- Instance of `FactTools`
...
```typescript
class FactToolsError extends Error {
  code: string
  details?: any
}
```
...
```typescript
import { FactTools, FactToolsError } from '@deflex.net/fact-tools'
...
```typescript
import { FactTools, Config, LogLevel } from '@deflex.net/fact-tools'
...
cd deflex.net/packages/fact-tools
...
- **NPM Package**: [@deflex.net/fact-tools](https://www.npmjs.com/package/@deflex.net/fact-tools)
- **GitHub Repository**: [flexnetos/deflex.net](https://github.com/flexnetos/deflex.net)
- **Rust Crate**: [fact-tools](https://crates.io/crates/fact-tools)
- **Documentation**: [docs.deflex.net/fact-tools](https://docs.deflex.net/fact-tools)
...
- Original crate by the [fact-tools](https://crates.io/crates/fact-tools) authors

---

## 📊 Stats

![NPM](https://nodei.co/npm/@deflex.net/fact-tools.png?downloads=true&downloadRank=true&stars=true)
