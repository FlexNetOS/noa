# ⏰ @deflex.net/subjective-time-expansion
...
[![npm version](https://img.shields.io/npm/v/@deflex.net/subjective-time-expansion.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/subjective-time-expansion)
[![npm downloads](https://img.shields.io/npm/dm/@deflex.net/subjective-time-expansion.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/subjective-time-expansion)
[![license](https://img.shields.io/npm/l/@deflex.net/subjective-time-expansion.svg?style=flat-square)](https://github.com/flexnetos/deflex.net/blob/main/LICENSE)
...
`@deflex.net/subjective-time-expansion` is a high-performance Node.js native addon that provides TypeScript bindings for the [`subjective-time-expansion`](https://crates.io/crates/subjective-time-expansion) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
- **License**: MIT
- **Rust Crate**: [subjective-time-expansion](https://crates.io/crates/subjective-time-expansion)
...
```bash
npm install @deflex.net/subjective-time-expansion
```

### Using yarn

```bash
yarn add @deflex.net/subjective-time-expansion
```

### Using pnpm

```bash
pnpm add @deflex.net/subjective-time-expansion
```
...
- **Linux x64**: `@deflex.net/subjective-time-expansion-linux-x64-gnu`
- **Linux ARM64**: `@deflex.net/subjective-time-expansion-linux-arm64-gnu`
- **macOS x64**: `@deflex.net/subjective-time-expansion-darwin-x64`
- **macOS ARM64**: `@deflex.net/subjective-time-expansion-darwin-arm64`
- **Windows x64**: `@deflex.net/subjective-time-expansion-win32-x64-msvc`
- **WebAssembly**: `@deflex.net/subjective-time-expansion-wasm32` (fallback)
...
```typescript
import { SubjectiveTimeExpansion } from '@deflex.net/subjective-time-expansion'

// Create an instance
const client = new SubjectiveTimeExpansion({
...
```typescript
import { SubjectiveTimeExpansion, configs } from '@deflex.net/subjective-time-expansion'
...
const client = new SubjectiveTimeExpansion(configs)
```
...
// CommonJS
const { SubjectiveTimeExpansion } = require('@deflex.net/subjective-time-expansion')
```
...
try {
  ...
  if (error instanceof SubjectiveTimeExpansionError) {
...
### Main Class: `SubjectiveTimeExpansion`
...
Creates a new instance of `SubjectiveTimeExpansion`.

**Parameters:**
- `configs` (optional): configsuration object

**Returns:**
- Instance of `SubjectiveTimeExpansion`
...
#### `SubjectiveTimeExpansionError`

Base error class for all errors thrown by this package.

```typescript
class SubjectiveTimeExpansionError extends Error {
  code: string
  details?: any
}
```
...
```typescript
import { SubjectiveTimeExpansion, SubjectiveTimeExpansionError } from '@deflex.net/subjective-time-expansion'
...
```typescript
import { SubjectiveTimeExpansion, configs, LogLevel } from '@deflex.net/subjective-time-expansion'
...
cd deflex.net/packages/subjective-time-expansion
...
- **NPM Package**: [@deflex.net/subjective-time-expansion](https://www.npmjs.com/package/@deflex.net/subjective-time-expansion)
- **GitHub Repository**: [flexnetos/deflex.net](https://github.com/flexnetos/deflex.net)
- **Rust Crate**: [subjective-time-expansion](https://crates.io/crates/subjective-time-expansion)
- **Documentation**: [docs.deflex.net/subjective-time-expansion](https://docs.deflex.net/subjective-time-expansion)
...
- Original crate by the [subjective-time-expansion](https://crates.io/crates/subjective-time-expansion) authors

---

## 📊 Stats

![NPM](https://nodei.co/npm/@deflex.net/subjective-time-expansion.png?downloads=true&downloadRank=true&stars=true)
