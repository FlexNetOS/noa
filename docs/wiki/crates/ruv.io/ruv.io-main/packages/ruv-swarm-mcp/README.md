# 🐝 @deflex.net/ruv-swarm-mcp

> Model Context Protocol (MCP) integration for RUV Swarm

[![npm version](https://img.shields.io/npm/v/@deflex.net/ruv-swarm-mcp.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/ruv-swarm-mcp)
[![npm downloads](https://img.shields.io/npm/dm/@deflex.net/ruv-swarm-mcp.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/ruv-swarm-mcp)
[![license](https://img.shields.io/npm/l/@deflex.net/ruv-swarm-mcp.svg?style=flat-square)](https://github.com/flexnetos/deflex.net/blob/main/LICENSE)
...
`@deflex.net/ruv-swarm-mcp` is a high-performance Node.js native addon that provides TypeScript bindings for the [`ruv-swarm-mcp`](https://crates.io/crates/ruv-swarm-mcp) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.

**Key Information:**
- **Version**: 0.2.0
- **Downloads**: 886+
- **Categories**: Swarm Orchestration, Mcp Protocol
- **License**: MIT
- **Rust Crate**: [ruv-swarm-mcp](https://crates.io/crates/ruv-swarm-mcp)
...
```bash
npm install @deflex.net/ruv-swarm-mcp
```

### Using yarn

```bash
yarn add @deflex.net/ruv-swarm-mcp
```

### Using pnpm

```bash
pnpm add @deflex.net/ruv-swarm-mcp
```
...
- **Linux x64**: `@deflex.net/ruv-swarm-mcp-linux-x64-gnu`
- **Linux ARM64**: `@deflex.net/ruv-swarm-mcp-linux-arm64-gnu`
- **macOS x64**: `@deflex.net/ruv-swarm-mcp-darwin-x64`
- **macOS ARM64**: `@deflex.net/ruv-swarm-mcp-darwin-arm64`
- **Windows x64**: `@deflex.net/ruv-swarm-mcp-win32-x64-msvc`
- **WebAssembly**: `@deflex.net/ruv-swarm-mcp-wasm32` (fallback)
...
```typescript
import { RuvSwarmMcp } from '@deflex.net/ruv-swarm-mcp'
...
```typescript
import { RuvSwarmMcp, configs } from '@deflex.net/ruv-swarm-mcp'
...
const client = new RuvSwarmMcp(configs)
```
...
// CommonJS
const { RuvSwarmMcp } = require('@deflex.net/ruv-swarm-mcp')
```
...
try {
  ...
  if (error instanceof RuvSwarmMcpError) {
...
Creates a new instance of `RuvSwarmMcp`.

**Parameters:**
- `configs` (optional): configsuration object

**Returns:**
- Instance of `RuvSwarmMcp`
...
```typescript
class RuvSwarmMcpError extends Error {
  code: string
  details?: any
}
```
...
```typescript
import { RuvSwarmMcp, RuvSwarmMcpError } from '@deflex.net/ruv-swarm-mcp'
...
```typescript
import { RuvSwarmMcp, configs, LogLevel } from '@deflex.net/ruv-swarm-mcp'
...
cd deflex.net/packages/ruv-swarm-mcp
...
- **NPM Package**: [@deflex.net/ruv-swarm-mcp](https://www.npmjs.com/package/@deflex.net/ruv-swarm-mcp)
- **GitHub Repository**: [flexnetos/deflex.net](https://github.com/flexnetos/deflex.net)
- **Rust Crate**: [ruv-swarm-mcp](https://crates.io/crates/ruv-swarm-mcp)
- **Documentation**: [docs.deflex.net/ruv-swarm-mcp](https://docs.deflex.net/ruv-swarm-mcp)
...
- Original crate by the [ruv-swarm-mcp](https://crates.io/crates/ruv-swarm-mcp) authors

---

## 📊 Stats

![NPM](https://nodei.co/npm/@deflex.net/ruv-swarm-mcp.png?downloads=true&downloadRank=true&stars=true)
