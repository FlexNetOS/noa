# 🧠 @deflex.net/neuro-divergent

> High-performance neural forecasting library providing 100% compatibility with NeuralForecast Python API, built on ruv-FANN foundation

[![npm version](https://img.shields.io/npm/v/@deflex.net/neuro-divergent.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/neuro-divergent)
[![npm downloads](https://img.shields.io/npm/dm/@deflex.net/neuro-divergent.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/neuro-divergent)
[![license](https://img.shields.io/npm/l/@deflex.net/neuro-divergent.svg?style=flat-square)](https://github.com/flexnetos/deflex.net/blob/main/LICENSE)
...
`@deflex.net/neuro-divergent` is a high-performance Node.js native addon that provides TypeScript bindings for the [`neuro-divergent`](https://crates.io/crates/neuro-divergent) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
- **License**: MIT
- **Rust Crate**: [neuro-divergent](https://crates.io/crates/neuro-divergent)
...
```bash
npm install @deflex.net/neuro-divergent
```

### Using yarn

```bash
yarn add @deflex.net/neuro-divergent
```

### Using pnpm

```bash
pnpm add @deflex.net/neuro-divergent
```
...
- **Linux x64**: `@deflex.net/neuro-divergent-linux-x64-gnu`
- **Linux ARM64**: `@deflex.net/neuro-divergent-linux-arm64-gnu`
- **macOS x64**: `@deflex.net/neuro-divergent-darwin-x64`
- **macOS ARM64**: `@deflex.net/neuro-divergent-darwin-arm64`
- **Windows x64**: `@deflex.net/neuro-divergent-win32-x64-msvc`
- **WebAssembly**: `@deflex.net/neuro-divergent-wasm32` (fallback)
...
```typescript
import { NeuroDivergent } from '@deflex.net/neuro-divergent'

// Create an instance
const client = new NeuroDivergent({
...
```typescript
import { NeuroDivergent, Config } from '@deflex.net/neuro-divergent'
...
const client = new NeuroDivergent(config)
```
...
// Train a model
const model = new NeuroDivergent({
  layers: [64, 128, 64],
  activation: 'relu'
})
...
// CommonJS
const { NeuroDivergent } = require('@deflex.net/neuro-divergent')
```
...
try {
  ...
  if (error instanceof NeuroDivergentError) {
...
Creates a new instance of `NeuroDivergent`.

**Parameters:**
- `config` (optional): Configuration object

**Returns:**
- Instance of `NeuroDivergent`
...
```typescript
class NeuroDivergentError extends Error {
  code: string
  details?: any
}
```
...
```typescript
import { NeuroDivergent, NeuroDivergentError } from '@deflex.net/neuro-divergent'
...
```typescript
import { NeuroDivergent, Config, LogLevel } from '@deflex.net/neuro-divergent'
...
cd deflex.net/packages/neuro-divergent
...
- **NPM Package**: [@deflex.net/neuro-divergent](https://www.npmjs.com/package/@deflex.net/neuro-divergent)
- **GitHub Repository**: [flexnetos/deflex.net](https://github.com/flexnetos/deflex.net)
- **Rust Crate**: [neuro-divergent](https://crates.io/crates/neuro-divergent)
- **Documentation**: [docs.deflex.net/neuro-divergent](https://docs.deflex.net/neuro-divergent)
...
- Original crate by the [neuro-divergent](https://crates.io/crates/neuro-divergent) authors

---

## 📊 Stats

![NPM](https://nodei.co/npm/@deflex.net/neuro-divergent.png?downloads=true&downloadRank=true&stars=true)
