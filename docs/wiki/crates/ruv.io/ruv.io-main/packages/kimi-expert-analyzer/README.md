# 📦 @deflex.net/kimi-expert-analyzer

> Expert analysis tool for Kimi-K2 to Rust-WASM conversion

[![npm version](https://img.shields.io/npm/v/@deflex.net/kimi-expert-analyzer.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/kimi-expert-analyzer)
[![npm downloads](https://img.shields.io/npm/dm/@deflex.net/kimi-expert-analyzer.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/kimi-expert-analyzer)
[![license](https://img.shields.io/npm/l/@deflex.net/kimi-expert-analyzer.svg?style=flat-square)](https://github.com/flexnetos/deflex.net/blob/main/LICENSE)
...
`@deflex.net/kimi-expert-analyzer` is a high-performance Node.js native addon that provides TypeScript bindings for the [`kimi-expert-analyzer`](https://crates.io/crates/kimi-expert-analyzer) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
- **License**: MIT
- **Rust Crate**: [kimi-expert-analyzer](https://crates.io/crates/kimi-expert-analyzer)
...
```bash
npm install @deflex.net/kimi-expert-analyzer
```

### Using yarn

```bash
yarn add @deflex.net/kimi-expert-analyzer
```

### Using pnpm

```bash
pnpm add @deflex.net/kimi-expert-analyzer
```
...
- **Linux x64**: `@deflex.net/kimi-expert-analyzer-linux-x64-gnu`
- **Linux ARM64**: `@deflex.net/kimi-expert-analyzer-linux-arm64-gnu`
- **macOS x64**: `@deflex.net/kimi-expert-analyzer-darwin-x64`
- **macOS ARM64**: `@deflex.net/kimi-expert-analyzer-darwin-arm64`
- **Windows x64**: `@deflex.net/kimi-expert-analyzer-win32-x64-msvc`
- **WebAssembly**: `@deflex.net/kimi-expert-analyzer-wasm32` (fallback)
...
```typescript
import { KimiExpertAnalyzer } from '@deflex.net/kimi-expert-analyzer'

// Create an instance
const client = new KimiExpertAnalyzer({
...
```typescript
import { KimiExpertAnalyzer, Config } from '@deflex.net/kimi-expert-analyzer'
...
const client = new KimiExpertAnalyzer(config)
```
...
// CommonJS
const { KimiExpertAnalyzer } = require('@deflex.net/kimi-expert-analyzer')
```
...
try {
  ...
  if (error instanceof KimiExpertAnalyzerError) {
...
Creates a new instance of `KimiExpertAnalyzer`.

**Parameters:**
- `config` (optional): Configuration object

**Returns:**
- Instance of `KimiExpertAnalyzer`
...
#### `KimiExpertAnalyzerError`

Base error class for all errors thrown by this package.

```typescript
class KimiExpertAnalyzerError extends Error {
  code: string
  details?: any
}
```
...
```typescript
import { KimiExpertAnalyzer, KimiExpertAnalyzerError } from '@deflex.net/kimi-expert-analyzer'
...
```typescript
import { KimiExpertAnalyzer, Config, LogLevel } from '@deflex.net/kimi-expert-analyzer'
...
cd deflex.net/packages/kimi-expert-analyzer
...
- **NPM Package**: [@deflex.net/kimi-expert-analyzer](https://www.npmjs.com/package/@deflex.net/kimi-expert-analyzer)
- **GitHub Repository**: [flexnetos/deflex.net](https://github.com/flexnetos/deflex.net)
- **Rust Crate**: [kimi-expert-analyzer](https://crates.io/crates/kimi-expert-analyzer)
- **Documentation**: [docs.deflex.net/kimi-expert-analyzer](https://docs.deflex.net/kimi-expert-analyzer)
...
- Original crate by the [kimi-expert-analyzer](https://crates.io/crates/kimi-expert-analyzer) authors

---

## 📊 Stats

![NPM](https://nodei.co/npm/@deflex.net/kimi-expert-analyzer.png?downloads=true&downloadRank=true&stars=true)
