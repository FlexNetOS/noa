# ⚛️ @deflex.net/qudag-exchange-standalone-cli

> Standalone command-line interface for QuDAG Exchange with rUv tokens

[![npm version](https://img.shields.io/npm/v/@deflex.net/qudag-exchange-standalone-cli.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/qudag-exchange-standalone-cli)
[![npm downloads](https://img.shields.io/npm/dm/@deflex.net/qudag-exchange-standalone-cli.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/qudag-exchange-standalone-cli)
[![license](https://img.shields.io/npm/l/@deflex.net/qudag-exchange-standalone-cli.svg?style=flat-square)](https://github.com/flexnetos/deflex.net/blob/main/LICENSE)
...
`@deflex.net/qudag-exchange-standalone-cli` is a high-performance Node.js native addon that provides TypeScript bindings for the [`qudag-exchange-standalone-cli`](https://crates.io/crates/qudag-exchange-standalone-cli) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.

**Key Information:**
- **Version**: 0.3.1
- **Downloads**: 1,218+
- **Categories**: Cli Tools, Blockchain Crypto, Quantum Computing
- **License**: MIT
- **Rust Crate**: [qudag-exchange-standalone-cli](https://crates.io/crates/qudag-exchange-standalone-cli)
...
```bash
npm install @deflex.net/qudag-exchange-standalone-cli
```

### Using yarn

```bash
yarn add @deflex.net/qudag-exchange-standalone-cli
```

### Using pnpm

```bash
pnpm add @deflex.net/qudag-exchange-standalone-cli
```
...
- **Linux x64**: `@deflex.net/qudag-exchange-standalone-cli-linux-x64-gnu`
- **Linux ARM64**: `@deflex.net/qudag-exchange-standalone-cli-linux-arm64-gnu`
- **macOS x64**: `@deflex.net/qudag-exchange-standalone-cli-darwin-x64`
- **macOS ARM64**: `@deflex.net/qudag-exchange-standalone-cli-darwin-arm64`
- **Windows x64**: `@deflex.net/qudag-exchange-standalone-cli-win32-x64-msvc`
- **WebAssembly**: `@deflex.net/qudag-exchange-standalone-cli-wasm32` (fallback)
...
```typescript
import { QudagExchangeStandaloneCli } from '@deflex.net/qudag-exchange-standalone-cli'

// Create an instance
const client = new QudagExchangeStandaloneCli({
...
```typescript
import { QudagExchangeStandaloneCli, Config } from '@deflex.net/qudag-exchange-standalone-cli'
...
const client = new QudagExchangeStandaloneCli(config)
```
...
// CommonJS
const { QudagExchangeStandaloneCli } = require('@deflex.net/qudag-exchange-standalone-cli')
```
...
try {
  ...
  if (error instanceof QudagExchangeStandaloneCliError) {
...
### Main Class: `QudagExchangeStandaloneCli`
...
Creates a new instance of `QudagExchangeStandaloneCli`.

**Parameters:**
- `config` (optional): Configuration object

**Returns:**
- Instance of `QudagExchangeStandaloneCli`
...
#### `QudagExchangeStandaloneCliError`

Base error class for all errors thrown by this package.

```typescript
class QudagExchangeStandaloneCliError extends Error {
  code: string
  details?: any
}
```
...
```typescript
import { QudagExchangeStandaloneCli, QudagExchangeStandaloneCliError } from '@deflex.net/qudag-exchange-standalone-cli'
...
```typescript
import { QudagExchangeStandaloneCli, Config, LogLevel } from '@deflex.net/qudag-exchange-standalone-cli'
...
cd deflex.net/packages/qudag-exchange-standalone-cli
...
- **NPM Package**: [@deflex.net/qudag-exchange-standalone-cli](https://www.npmjs.com/package/@deflex.net/qudag-exchange-standalone-cli)
- **GitHub Repository**: [flexnetos/deflex.net](https://github.com/flexnetos/deflex.net)
- **Rust Crate**: [qudag-exchange-standalone-cli](https://crates.io/crates/qudag-exchange-standalone-cli)
- **Documentation**: [docs.deflex.net/qudag-exchange-standalone-cli](https://docs.deflex.net/qudag-exchange-standalone-cli)
...
- Original crate by the [qudag-exchange-standalone-cli](https://crates.io/crates/qudag-exchange-standalone-cli) authors

---

## 📊 Stats

![NPM](https://nodei.co/npm/@deflex.net/qudag-exchange-standalone-cli.png?downloads=true&downloadRank=true&stars=true)
