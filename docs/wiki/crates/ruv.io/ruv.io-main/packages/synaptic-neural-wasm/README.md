...
```typescript
import { SynapticNeuralWasm, Config } from '@deflex.net/synaptic-neural-wasm'
...
const client = new SynapticNeuralWasm(config)
```
...
```typescript
import { SynapticNeuralWasm, Config, LogLevel } from '@deflex.net/synaptic-neural-wasm'
