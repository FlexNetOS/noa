# 🧠 @deflex.net/synaptic-neural-wasm

> WASM-optimized neural network engine for Synaptic Neural Mesh with SIMD acceleration

[![npm version](https://img.shields.io/npm/v/@deflex.net/synaptic-neural-wasm.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/synaptic-neural-wasm)
[![npm downloads](https://img.shields.io/npm/dm/@deflex.net/synaptic-neural-wasm.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/synaptic-neural-wasm)
[![license](https://img.shields.io/npm/l/@deflex.net/synaptic-neural-wasm.svg?style=flat-square)](https://github.com/flexnetos/deflex.net/blob/main/LICENSE)
...
`@deflex.net/synaptic-neural-wasm` is a high-performance Node.js native addon that provides TypeScript bindings for the [`synaptic-neural-wasm`](https://crates.io/crates/synaptic-neural-wasm) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.

**Key Information:**
- **Version**: 0.1.0
- **Downloads**: 534+
- **Categories**: Wasm Bindings, Neural Networks
- **License**: MIT
- **Rust Crate**: [synaptic-neural-wasm](https://crates.io/crates/synaptic-neural-wasm)
...
```bash
npm install @deflex.net/synaptic-neural-wasm
```

### Using yarn

```bash
yarn add @deflex.net/synaptic-neural-wasm
```

### Using pnpm

```bash
pnpm add @deflex.net/synaptic-neural-wasm
```
...
- **Linux x64**: `@deflex.net/synaptic-neural-wasm-linux-x64-gnu`
- **Linux ARM64**: `@deflex.net/synaptic-neural-wasm-linux-arm64-gnu`
- **macOS x64**: `@deflex.net/synaptic-neural-wasm-darwin-x64`
- **macOS ARM64**: `@deflex.net/synaptic-neural-wasm-darwin-arm64`
- **Windows x64**: `@deflex.net/synaptic-neural-wasm-win32-x64-msvc`
- **WebAssembly**: `@deflex.net/synaptic-neural-wasm-wasm32` (fallback)
...
```typescript
import { SynapticNeuralWasm } from '@deflex.net/synaptic-neural-wasm'

// Create an instance
const client = new SynapticNeuralWasm({
...
```typescript
import { SynapticNeuralWasm, configs } from '@deflex.net/synaptic-neural-wasm'
...
const client = new SynapticNeuralWasm(configs)
```
...
// Train a model
const model = new SynapticNeuralWasm({
  layers: [64, 128, 64],
  activation: 'relu'
})
...
// CommonJS
const { SynapticNeuralWasm } = require('@deflex.net/synaptic-neural-wasm')
```
...
try {
  ...
  if (error instanceof SynapticNeuralWasmError) {
...
Creates a new instance of `SynapticNeuralWasm`.

**Parameters:**
- `configs` (optional): configsuration object

**Returns:**
- Instance of `SynapticNeuralWasm`
...
#### `SynapticNeuralWasmError`

Base error class for all errors thrown by this package.

```typescript
class SynapticNeuralWasmError extends Error {
  code: string
  details?: any
}
```
...
```typescript
import { SynapticNeuralWasm, SynapticNeuralWasmError } from '@deflex.net/synaptic-neural-wasm'
...
```typescript
import { SynapticNeuralWasm, configs, LogLevel } from '@deflex.net/synaptic-neural-wasm'
...
cd deflex.net/packages/synaptic-neural-wasm
...
- **NPM Package**: [@deflex.net/synaptic-neural-wasm](https://www.npmjs.com/package/@deflex.net/synaptic-neural-wasm)
- **GitHub Repository**: [flexnetos/deflex.net](https://github.com/flexnetos/deflex.net)
- **Rust Crate**: [synaptic-neural-wasm](https://crates.io/crates/synaptic-neural-wasm)
- **Documentation**: [docs.deflex.net/synaptic-neural-wasm](https://docs.deflex.net/synaptic-neural-wasm)
...
- Original crate by the [synaptic-neural-wasm](https://crates.io/crates/synaptic-neural-wasm) authors

---

## 📊 Stats

![NPM](https://nodei.co/npm/@deflex.net/synaptic-neural-wasm.png?downloads=true&downloadRank=true&stars=true)
