# ⏰ @deflex.net/temporal-attractor-studio

> Temporal Attractor Studio - Real FTLE calculation and temporal dynamics prediction with VP-tree optimization

[![npm version](https://img.shields.io/npm/v/@deflex.net/temporal-attractor-studio.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/temporal-attractor-studio)
[![npm downloads](https://img.shields.io/npm/dm/@deflex.net/temporal-attractor-studio.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/temporal-attractor-studio)
[![license](https://img.shields.io/npm/l/@deflex.net/temporal-attractor-studio.svg?style=flat-square)](https://github.com/flexnetos/deflex.net/blob/main/LICENSE)
...
`@deflex.net/temporal-attractor-studio` is a high-performance Node.js native addon that provides TypeScript bindings for the [`temporal-attractor-studio`](https://crates.io/crates/temporal-attractor-studio) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
- **License**: MIT
- **Rust Crate**: [temporal-attractor-studio](https://crates.io/crates/temporal-attractor-studio)
...
```bash
npm install @deflex.net/temporal-attractor-studio
```

### Using yarn

```bash
yarn add @deflex.net/temporal-attractor-studio
```

### Using pnpm

```bash
pnpm add @deflex.net/temporal-attractor-studio
```
...
- **Linux x64**: `@deflex.net/temporal-attractor-studio-linux-x64-gnu`
- **Linux ARM64**: `@deflex.net/temporal-attractor-studio-linux-arm64-gnu`
- **macOS x64**: `@deflex.net/temporal-attractor-studio-darwin-x64`
- **macOS ARM64**: `@deflex.net/temporal-attractor-studio-darwin-arm64`
- **Windows x64**: `@deflex.net/temporal-attractor-studio-win32-x64-msvc`
- **WebAssembly**: `@deflex.net/temporal-attractor-studio-wasm32` (fallback)
...
```typescript
import { TemporalAttractorStudio } from '@deflex.net/temporal-attractor-studio'

// Create an instance
const client = new TemporalAttractorStudio({
...
```typescript
import { TemporalAttractorStudio, configs } from '@deflex.net/temporal-attractor-studio'
...
const client = new TemporalAttractorStudio(configs)
```
...
// CommonJS
const { TemporalAttractorStudio } = require('@deflex.net/temporal-attractor-studio')
```
...
try {
  ...
  if (error instanceof TemporalAttractorStudioError) {
...
### Main Class: `TemporalAttractorStudio`
...
Creates a new instance of `TemporalAttractorStudio`.

**Parameters:**
- `configs` (optional): configsuration object

**Returns:**
- Instance of `TemporalAttractorStudio`
...
#### `TemporalAttractorStudioError`

Base error class for all errors thrown by this package.

```typescript
class TemporalAttractorStudioError extends Error {
  code: string
  details?: any
}
```
...
```typescript
import { TemporalAttractorStudio, TemporalAttractorStudioError } from '@deflex.net/temporal-attractor-studio'
...
```typescript
import { TemporalAttractorStudio, configs, LogLevel } from '@deflex.net/temporal-attractor-studio'
...
cd deflex.net/packages/temporal-attractor-studio
...
- **NPM Package**: [@deflex.net/temporal-attractor-studio](https://www.npmjs.com/package/@deflex.net/temporal-attractor-studio)
- **GitHub Repository**: [flexnetos/deflex.net](https://github.com/flexnetos/deflex.net)
- **Rust Crate**: [temporal-attractor-studio](https://crates.io/crates/temporal-attractor-studio)
- **Documentation**: [docs.deflex.net/temporal-attractor-studio](https://docs.deflex.net/temporal-attractor-studio)
...
- Original crate by the [temporal-attractor-studio](https://crates.io/crates/temporal-attractor-studio) authors

---

## 📊 Stats

![NPM](https://nodei.co/npm/@deflex.net/temporal-attractor-studio.png?downloads=true&downloadRank=true&stars=true)
