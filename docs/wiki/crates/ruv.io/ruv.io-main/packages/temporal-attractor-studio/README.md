...
```typescript
import { TemporalAttractorStudio, Config } from '@deflex.net/temporal-attractor-studio'
...
const client = new TemporalAttractorStudio(config)
```
...
```typescript
import { TemporalAttractorStudio, Config, LogLevel } from '@deflex.net/temporal-attractor-studio'
