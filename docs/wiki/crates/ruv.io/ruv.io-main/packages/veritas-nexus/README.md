...
[![npm version](https://img.shields.io/npm/v/@deflex.net/veritas-nexus.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/veritas-nexus)
[![npm downloads](https://img.shields.io/npm/dm/@deflex.net/veritas-nexus.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/veritas-nexus)
[![license](https://img.shields.io/npm/l/@deflex.net/veritas-nexus.svg?style=flat-square)](https://github.com/flexnetos/deflex.net/blob/main/LICENSE)
...
`@deflex.net/veritas-nexus` is a high-performance Node.js native addon that provides TypeScript bindings for the [`veritas-nexus`](https://crates.io/crates/veritas-nexus) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
- **License**: MIT
- **Rust Crate**: [veritas-nexus](https://crates.io/crates/veritas-nexus)
...
```bash
npm install @deflex.net/veritas-nexus
```

### Using yarn

```bash
yarn add @deflex.net/veritas-nexus
```

### Using pnpm

```bash
pnpm add @deflex.net/veritas-nexus
```
...
- **Linux x64**: `@deflex.net/veritas-nexus-linux-x64-gnu`
- **Linux ARM64**: `@deflex.net/veritas-nexus-linux-arm64-gnu`
- **macOS x64**: `@deflex.net/veritas-nexus-darwin-x64`
- **macOS ARM64**: `@deflex.net/veritas-nexus-darwin-arm64`
- **Windows x64**: `@deflex.net/veritas-nexus-win32-x64-msvc`
- **WebAssembly**: `@deflex.net/veritas-nexus-wasm32` (fallback)
...
```typescript
import { VeritasNexus } from '@deflex.net/veritas-nexus'
...
try {
  ...
  if (error instanceof VeritasNexusError) {
...
```typescript
class VeritasNexusError extends Error {
  code: string
  details?: any
}
```
...
```typescript
import { VeritasNexus, VeritasNexusError } from '@deflex.net/veritas-nexus'
...
cd deflex.net/packages/veritas-nexus
...
- **NPM Package**: [@deflex.net/veritas-nexus](https://www.npmjs.com/package/@deflex.net/veritas-nexus)
- **GitHub Repository**: [flexnetos/deflex.net](https://github.com/flexnetos/deflex.net)
- **Rust Crate**: [veritas-nexus](https://crates.io/crates/veritas-nexus)
- **Documentation**: [docs.deflex.net/veritas-nexus](https://docs.deflex.net/veritas-nexus)
...
- Original crate by the [veritas-nexus](https://crates.io/crates/veritas-nexus) authors

---

## 📊 Stats

![NPM](https://nodei.co/npm/@deflex.net/veritas-nexus.png?downloads=true&downloadRank=true&stars=true)
