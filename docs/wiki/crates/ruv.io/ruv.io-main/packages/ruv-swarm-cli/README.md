# 🐝 @deflex.net/ruv-swarm-cli

> Distributed swarm orchestration CLI with cognitive diversity

[![npm version](https://img.shields.io/npm/v/@deflex.net/ruv-swarm-cli.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/ruv-swarm-cli)
[![npm downloads](https://img.shields.io/npm/dm/@deflex.net/ruv-swarm-cli.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/ruv-swarm-cli)
[![license](https://img.shields.io/npm/l/@deflex.net/ruv-swarm-cli.svg?style=flat-square)](https://github.com/flexnetos/deflex.net/blob/main/LICENSE)
...
`@deflex.net/ruv-swarm-cli` is a high-performance Node.js native addon that provides TypeScript bindings for the [`ruv-swarm-cli`](https://crates.io/crates/ruv-swarm-cli) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.

**Key Information:**
- **Version**: 0.2.0
- **Downloads**: 930+
- **Categories**: Swarm Orchestration, Cli Tools
- **License**: MIT
- **Rust Crate**: [ruv-swarm-cli](https://crates.io/crates/ruv-swarm-cli)
...
```bash
npm install @deflex.net/ruv-swarm-cli
```

### Using yarn

```bash
yarn add @deflex.net/ruv-swarm-cli
```

### Using pnpm

```bash
pnpm add @deflex.net/ruv-swarm-cli
```
...
- **Linux x64**: `@deflex.net/ruv-swarm-cli-linux-x64-gnu`
- **Linux ARM64**: `@deflex.net/ruv-swarm-cli-linux-arm64-gnu`
- **macOS x64**: `@deflex.net/ruv-swarm-cli-darwin-x64`
- **macOS ARM64**: `@deflex.net/ruv-swarm-cli-darwin-arm64`
- **Windows x64**: `@deflex.net/ruv-swarm-cli-win32-x64-msvc`
- **WebAssembly**: `@deflex.net/ruv-swarm-cli-wasm32` (fallback)
...
```typescript
import { RuvSwarmCli } from '@deflex.net/ruv-swarm-cli'

// Create an instance
const client = new RuvSwarmCli({
...
```typescript
import { RuvSwarmCli, Config } from '@deflex.net/ruv-swarm-cli'
...
const client = new RuvSwarmCli(config)
```
...
// CommonJS
const { RuvSwarmCli } = require('@deflex.net/ruv-swarm-cli')
```
...
try {
  ...
  if (error instanceof RuvSwarmCliError) {
...
Creates a new instance of `RuvSwarmCli`.

**Parameters:**
- `config` (optional): Configuration object

**Returns:**
- Instance of `RuvSwarmCli`
...
```typescript
class RuvSwarmCliError extends Error {
  code: string
  details?: any
}
```
...
```typescript
import { RuvSwarmCli, RuvSwarmCliError } from '@deflex.net/ruv-swarm-cli'
...
```typescript
import { RuvSwarmCli, Config, LogLevel } from '@deflex.net/ruv-swarm-cli'
...
cd deflex.net/packages/ruv-swarm-cli
...
- **NPM Package**: [@deflex.net/ruv-swarm-cli](https://www.npmjs.com/package/@deflex.net/ruv-swarm-cli)
- **GitHub Repository**: [flexnetos/deflex.net](https://github.com/flexnetos/deflex.net)
- **Rust Crate**: [ruv-swarm-cli](https://crates.io/crates/ruv-swarm-cli)
- **Documentation**: [docs.deflex.net/ruv-swarm-cli](https://docs.deflex.net/ruv-swarm-cli)
...
- Original crate by the [ruv-swarm-cli](https://crates.io/crates/ruv-swarm-cli) authors

---

## 📊 Stats

![NPM](https://nodei.co/npm/@deflex.net/ruv-swarm-cli.png?downloads=true&downloadRank=true&stars=true)
