# 📦 @deflex.net/daa-prime-cli

> Command-line interface for Prime distributed ML operations

[![npm version](https://img.shields.io/npm/v/@deflex.net/daa-prime-cli.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/daa-prime-cli)
[![npm downloads](https://img.shields.io/npm/dm/@deflex.net/daa-prime-cli.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/daa-prime-cli)
[![license](https://img.shields.io/npm/l/@deflex.net/daa-prime-cli.svg?style=flat-square)](https://github.com/flexnetos/deflex.net/blob/main/LICENSE)
...
`@deflex.net/daa-prime-cli` is a high-performance Node.js native addon that provides TypeScript bindings for the [`daa-prime-cli`](https://crates.io/crates/daa-prime-cli) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
```bash
npm install @deflex.net/daa-prime-cli
```

### Using yarn

```bash
yarn add @deflex.net/daa-prime-cli
```

### Using pnpm

```bash
pnpm add @deflex.net/daa-prime-cli
```
...
- **Linux x64**: `@deflex.net/daa-prime-cli-linux-x64-gnu`
- **Linux ARM64**: `@deflex.net/daa-prime-cli-linux-arm64-gnu`
- **macOS x64**: `@deflex.net/daa-prime-cli-darwin-x64`
- **macOS ARM64**: `@deflex.net/daa-prime-cli-darwin-arm64`
- **Windows x64**: `@deflex.net/daa-prime-cli-win32-x64-msvc`
- **WebAssembly**: `@deflex.net/daa-prime-cli-wasm32` (fallback)
...
```typescript
import { DaaPrimeCli } from '@deflex.net/daa-prime-cli'
...
```typescript
import { DaaPrimeCli, Config } from '@deflex.net/daa-prime-cli'
...
// CommonJS
const { DaaPrimeCli } = require('@deflex.net/daa-prime-cli')
```
...
```typescript
import { DaaPrimeCli, DaaPrimeCliError } from '@deflex.net/daa-prime-cli'
...
```typescript
import { DaaPrimeCli, Config, LogLevel } from '@deflex.net/daa-prime-cli'
...
cd deflex.net/packages/daa-prime-cli
...
- **NPM Package**: [@deflex.net/daa-prime-cli](https://www.npmjs.com/package/@deflex.net/daa-prime-cli)
- **GitHub Repository**: [flexnetos/deflex.net](https://github.com/flexnetos/deflex.net)
- **Rust Crate**: [daa-prime-cli](https://crates.io/crates/daa-prime-cli)
- **Documentation**: [docs.deflex.net/daa-prime-cli](https://docs.deflex.net/daa-prime-cli)
...
![NPM](https://nodei.co/npm/@deflex.net/daa-prime-cli.png?downloads=true&downloadRank=true&stars=true)
