# ⚛️ @deflex.net/qudag-exchange

> QuDAG Exchange: Quantum-resistant token exchange with rUv (Resource Utilization Voucher) system

[![npm version](https://img.shields.io/npm/v/@deflex.net/qudag-exchange.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/qudag-exchange)
[![npm downloads](https://img.shields.io/npm/dm/@deflex.net/qudag-exchange.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/qudag-exchange)
[![license](https://img.shields.io/npm/l/@deflex.net/qudag-exchange.svg?style=flat-square)](https://github.com/flexnetos/deflex.net/blob/main/LICENSE)
...
`@deflex.net/qudag-exchange` is a high-performance Node.js native addon that provides TypeScript bindings for the [`qudag-exchange`](https://crates.io/crates/qudag-exchange) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
- **License**: MIT
- **Rust Crate**: [qudag-exchange](https://crates.io/crates/qudag-exchange)
...
```bash
npm install @deflex.net/qudag-exchange
```

### Using yarn

```bash
yarn add @deflex.net/qudag-exchange
```

### Using pnpm

```bash
pnpm add @deflex.net/qudag-exchange
```
...
- **Linux x64**: `@deflex.net/qudag-exchange-linux-x64-gnu`
- **Linux ARM64**: `@deflex.net/qudag-exchange-linux-arm64-gnu`
- **macOS x64**: `@deflex.net/qudag-exchange-darwin-x64`
- **macOS ARM64**: `@deflex.net/qudag-exchange-darwin-arm64`
- **Windows x64**: `@deflex.net/qudag-exchange-win32-x64-msvc`
- **WebAssembly**: `@deflex.net/qudag-exchange-wasm32` (fallback)
...
```typescript
import { QudagExchange } from '@deflex.net/qudag-exchange'

// Create an instance
const client = new QudagExchange({
...
```typescript
import { QudagExchange, Config } from '@deflex.net/qudag-exchange'
...
const client = new QudagExchange(config)
```
...
// CommonJS
const { QudagExchange } = require('@deflex.net/qudag-exchange')
```
...
try {
  ...
  if (error instanceof QudagExchangeError) {
...
Creates a new instance of `QudagExchange`.

**Parameters:**
- `config` (optional): Configuration object

**Returns:**
- Instance of `QudagExchange`
...
```typescript
class QudagExchangeError extends Error {
  code: string
  details?: any
}
```
...
```typescript
import { QudagExchange, QudagExchangeError } from '@deflex.net/qudag-exchange'
...
```typescript
import { QudagExchange, Config, LogLevel } from '@deflex.net/qudag-exchange'
...
cd deflex.net/packages/qudag-exchange
...
- **NPM Package**: [@deflex.net/qudag-exchange](https://www.npmjs.com/package/@deflex.net/qudag-exchange)
- **GitHub Repository**: [flexnetos/deflex.net](https://github.com/flexnetos/deflex.net)
- **Rust Crate**: [qudag-exchange](https://crates.io/crates/qudag-exchange)
- **Documentation**: [docs.deflex.net/qudag-exchange](https://docs.deflex.net/qudag-exchange)
...
- Original crate by the [qudag-exchange](https://crates.io/crates/qudag-exchange) authors

---

## 📊 Stats

![NPM](https://nodei.co/npm/@deflex.net/qudag-exchange.png?downloads=true&downloadRank=true&stars=true)
