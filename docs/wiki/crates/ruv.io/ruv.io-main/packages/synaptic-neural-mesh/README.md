# 🧠 @deflex.net/synaptic-neural-mesh

> Neural mesh coordination layer for distributed AI agents in Synaptic Neural Mesh

[![npm version](https://img.shields.io/npm/v/@deflex.net/synaptic-neural-mesh.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/synaptic-neural-mesh)
[![npm downloads](https://img.shields.io/npm/dm/@deflex.net/synaptic-neural-mesh.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/synaptic-neural-mesh)
[![license](https://img.shields.io/npm/l/@deflex.net/synaptic-neural-mesh.svg?style=flat-square)](https://github.com/flexnetos/deflex.net/blob/main/LICENSE)
...
`@deflex.net/synaptic-neural-mesh` is a high-performance Node.js native addon that provides TypeScript bindings for the [`synaptic-neural-mesh`](https://crates.io/crates/synaptic-neural-mesh) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
- **License**: MIT
- **Rust Crate**: [synaptic-neural-mesh](https://crates.io/crates/synaptic-neural-mesh)
...
```bash
npm install @deflex.net/synaptic-neural-mesh
```

### Using yarn

```bash
yarn add @deflex.net/synaptic-neural-mesh
```

### Using pnpm

```bash
pnpm add @deflex.net/synaptic-neural-mesh
```
...
- **Linux x64**: `@deflex.net/synaptic-neural-mesh-linux-x64-gnu`
- **Linux ARM64**: `@deflex.net/synaptic-neural-mesh-linux-arm64-gnu`
- **macOS x64**: `@deflex.net/synaptic-neural-mesh-darwin-x64`
- **macOS ARM64**: `@deflex.net/synaptic-neural-mesh-darwin-arm64`
- **Windows x64**: `@deflex.net/synaptic-neural-mesh-win32-x64-msvc`
- **WebAssembly**: `@deflex.net/synaptic-neural-mesh-wasm32` (fallback)
...
```typescript
import { SynapticNeuralMesh } from '@deflex.net/synaptic-neural-mesh'

// Create an instance
const client = new SynapticNeuralMesh({
...
```typescript
import { SynapticNeuralMesh, configs } from '@deflex.net/synaptic-neural-mesh'
...
const client = new SynapticNeuralMesh(configs)
```
...
// Train a model
const model = new SynapticNeuralMesh({
  layers: [64, 128, 64],
  activation: 'relu'
})
...
// CommonJS
const { SynapticNeuralMesh } = require('@deflex.net/synaptic-neural-mesh')
```
...
try {
  ...
  if (error instanceof SynapticNeuralMeshError) {
...
Creates a new instance of `SynapticNeuralMesh`.

**Parameters:**
- `configs` (optional): configsuration object

**Returns:**
- Instance of `SynapticNeuralMesh`
...
#### `SynapticNeuralMeshError`

Base error class for all errors thrown by this package.

```typescript
class SynapticNeuralMeshError extends Error {
  code: string
  details?: any
}
```
...
```typescript
import { SynapticNeuralMesh, SynapticNeuralMeshError } from '@deflex.net/synaptic-neural-mesh'
...
```typescript
import { SynapticNeuralMesh, configs, LogLevel } from '@deflex.net/synaptic-neural-mesh'
...
cd deflex.net/packages/synaptic-neural-mesh
...
- **NPM Package**: [@deflex.net/synaptic-neural-mesh](https://www.npmjs.com/package/@deflex.net/synaptic-neural-mesh)
- **GitHub Repository**: [flexnetos/deflex.net](https://github.com/flexnetos/deflex.net)
- **Rust Crate**: [synaptic-neural-mesh](https://crates.io/crates/synaptic-neural-mesh)
- **Documentation**: [docs.deflex.net/synaptic-neural-mesh](https://docs.deflex.net/synaptic-neural-mesh)
...
- Original crate by the [synaptic-neural-mesh](https://crates.io/crates/synaptic-neural-mesh) authors

---

## 📊 Stats

![NPM](https://nodei.co/npm/@deflex.net/synaptic-neural-mesh.png?downloads=true&downloadRank=true&stars=true)
