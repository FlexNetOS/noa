# 🧠 @deflex.net/neuro-divergent-registry

> Model factory and registry system for dynamic neural network model creation and management

[![npm version](https://img.shields.io/npm/v/@deflex.net/neuro-divergent-registry.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/neuro-divergent-registry)
[![npm downloads](https://img.shields.io/npm/dm/@deflex.net/neuro-divergent-registry.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/neuro-divergent-registry)
[![license](https://img.shields.io/npm/l/@deflex.net/neuro-divergent-registry.svg?style=flat-square)](https://github.com/flexnetos/deflex.net/blob/main/LICENSE)
...
`@deflex.net/neuro-divergent-registry` is a high-performance Node.js native addon that provides TypeScript bindings for the [`neuro-divergent-registry`](https://crates.io/crates/neuro-divergent-registry) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
- **License**: MIT
- **Rust Crate**: [neuro-divergent-registry](https://crates.io/crates/neuro-divergent-registry)
...
```bash
npm install @deflex.net/neuro-divergent-registry
```

### Using yarn

```bash
yarn add @deflex.net/neuro-divergent-registry
```

### Using pnpm

```bash
pnpm add @deflex.net/neuro-divergent-registry
```
...
- **Linux x64**: `@deflex.net/neuro-divergent-registry-linux-x64-gnu`
- **Linux ARM64**: `@deflex.net/neuro-divergent-registry-linux-arm64-gnu`
- **macOS x64**: `@deflex.net/neuro-divergent-registry-darwin-x64`
- **macOS ARM64**: `@deflex.net/neuro-divergent-registry-darwin-arm64`
- **Windows x64**: `@deflex.net/neuro-divergent-registry-win32-x64-msvc`
- **WebAssembly**: `@deflex.net/neuro-divergent-registry-wasm32` (fallback)
...
```typescript
import { NeuroDivergentRegistry } from '@deflex.net/neuro-divergent-registry'

// Create an instance
const client = new NeuroDivergentRegistry({
...
```typescript
import { NeuroDivergentRegistry, Config } from '@deflex.net/neuro-divergent-registry'
...
const client = new NeuroDivergentRegistry(config)
```
...
// Train a model
const model = new NeuroDivergentRegistry({
  layers: [64, 128, 64],
  activation: 'relu'
})
...
// CommonJS
const { NeuroDivergentRegistry } = require('@deflex.net/neuro-divergent-registry')
```
...
try {
  ...
  if (error instanceof NeuroDivergentRegistryError) {
...
### Main Class: `NeuroDivergentRegistry`
...
Creates a new instance of `NeuroDivergentRegistry`.

**Parameters:**
- `config` (optional): Configuration object

**Returns:**
- Instance of `NeuroDivergentRegistry`
...
#### `NeuroDivergentRegistryError`

Base error class for all errors thrown by this package.

```typescript
class NeuroDivergentRegistryError extends Error {
  code: string
  details?: any
}
```
...
```typescript
import { NeuroDivergentRegistry, NeuroDivergentRegistryError } from '@deflex.net/neuro-divergent-registry'
...
```typescript
import { NeuroDivergentRegistry, Config, LogLevel } from '@deflex.net/neuro-divergent-registry'
...
cd deflex.net/packages/neuro-divergent-registry
...
- **NPM Package**: [@deflex.net/neuro-divergent-registry](https://www.npmjs.com/package/@deflex.net/neuro-divergent-registry)
- **GitHub Repository**: [flexnetos/deflex.net](https://github.com/flexnetos/deflex.net)
- **Rust Crate**: [neuro-divergent-registry](https://crates.io/crates/neuro-divergent-registry)
- **Documentation**: [docs.deflex.net/neuro-divergent-registry](https://docs.deflex.net/neuro-divergent-registry)
...
- Original crate by the [neuro-divergent-registry](https://crates.io/crates/neuro-divergent-registry) authors

---

## 📊 Stats

![NPM](https://nodei.co/npm/@deflex.net/neuro-divergent-registry.png?downloads=true&downloadRank=true&stars=true)
