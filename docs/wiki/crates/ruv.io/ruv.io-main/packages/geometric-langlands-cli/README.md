# 📐 @deflex.net/geometric-langlands-cli

> User-friendly CLI for the Geometric Langlands computational framework

[![npm version](https://img.shields.io/npm/v/@deflex.net/geometric-langlands-cli.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/geometric-langlands-cli)
[![npm downloads](https://img.shields.io/npm/dm/@deflex.net/geometric-langlands-cli.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/geometric-langlands-cli)
[![license](https://img.shields.io/npm/l/@deflex.net/geometric-langlands-cli.svg?style=flat-square)](https://github.com/flexnetos/deflex.net/blob/main/LICENSE)
...
`@deflex.net/geometric-langlands-cli` is a high-performance Node.js native addon that provides TypeScript bindings for the [`geometric-langlands-cli`](https://crates.io/crates/geometric-langlands-cli) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.

**Key Information:**
- **Version**: 0.2.0
- **Downloads**: 429+
- **Categories**: Cli Tools, Mathematical
- **License**: MIT
- **Rust Crate**: [geometric-langlands-cli](https://crates.io/crates/geometric-langlands-cli)
...
```bash
npm install @deflex.net/geometric-langlands-cli
```

### Using yarn

```bash
yarn add @deflex.net/geometric-langlands-cli
```

### Using pnpm

```bash
pnpm add @deflex.net/geometric-langlands-cli
```
...
- **Linux x64**: `@deflex.net/geometric-langlands-cli-linux-x64-gnu`
- **Linux ARM64**: `@deflex.net/geometric-langlands-cli-linux-arm64-gnu`
- **macOS x64**: `@deflex.net/geometric-langlands-cli-darwin-x64`
- **macOS ARM64**: `@deflex.net/geometric-langlands-cli-darwin-arm64`
- **Windows x64**: `@deflex.net/geometric-langlands-cli-win32-x64-msvc`
- **WebAssembly**: `@deflex.net/geometric-langlands-cli-wasm32` (fallback)
...
```typescript
import { GeometricLanglandsCli } from '@deflex.net/geometric-langlands-cli'

// Create an instance
const client = new GeometricLanglandsCli({
...
```typescript
import { GeometricLanglandsCli, Config } from '@deflex.net/geometric-langlands-cli'
...
const client = new GeometricLanglandsCli(config)
```
...
// CommonJS
const { GeometricLanglandsCli } = require('@deflex.net/geometric-langlands-cli')
```
...
try {
  ...
  if (error instanceof GeometricLanglandsCliError) {
...
### Main Class: `GeometricLanglandsCli`
...
Creates a new instance of `GeometricLanglandsCli`.

**Parameters:**
- `config` (optional): Configuration object

**Returns:**
- Instance of `GeometricLanglandsCli`
...
#### `GeometricLanglandsCliError`

Base error class for all errors thrown by this package.

```typescript
class GeometricLanglandsCliError extends Error {
  code: string
  details?: any
}
```
...
```typescript
import { GeometricLanglandsCli, GeometricLanglandsCliError } from '@deflex.net/geometric-langlands-cli'
...
```typescript
import { GeometricLanglandsCli, Config, LogLevel } from '@deflex.net/geometric-langlands-cli'
...
cd deflex.net/packages/geometric-langlands-cli
...
- **NPM Package**: [@deflex.net/geometric-langlands-cli](https://www.npmjs.com/package/@deflex.net/geometric-langlands-cli)
- **GitHub Repository**: [flexnetos/deflex.net](https://github.com/flexnetos/deflex.net)
- **Rust Crate**: [geometric-langlands-cli](https://crates.io/crates/geometric-langlands-cli)
- **Documentation**: [docs.deflex.net/geometric-langlands-cli](https://docs.deflex.net/geometric-langlands-cli)
...
- Original crate by the [geometric-langlands-cli](https://crates.io/crates/geometric-langlands-cli) authors

---

## 📊 Stats

![NPM](https://nodei.co/npm/@deflex.net/geometric-langlands-cli.png?downloads=true&downloadRank=true&stars=true)
