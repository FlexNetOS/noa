# 🐝 @deflex.net/ruv-swarm-transport

> Transport layer for RUV-FANN swarm communication with WebSocket and SharedMemory support

[![npm version](https://img.shields.io/npm/v/@deflex.net/ruv-swarm-transport.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/ruv-swarm-transport)
[![npm downloads](https://img.shields.io/npm/dm/@deflex.net/ruv-swarm-transport.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/ruv-swarm-transport)
[![license](https://img.shields.io/npm/l/@deflex.net/ruv-swarm-transport.svg?style=flat-square)](https://github.com/flexnetos/deflex.net/blob/main/LICENSE)
...
`@deflex.net/ruv-swarm-transport` is a high-performance Node.js native addon that provides TypeScript bindings for the [`ruv-swarm-transport`](https://crates.io/crates/ruv-swarm-transport) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
- **License**: MIT
- **Rust Crate**: [ruv-swarm-transport](https://crates.io/crates/ruv-swarm-transport)
...
```bash
npm install @deflex.net/ruv-swarm-transport
```

### Using yarn

```bash
yarn add @deflex.net/ruv-swarm-transport
```

### Using pnpm

```bash
pnpm add @deflex.net/ruv-swarm-transport
```
...
- **Linux x64**: `@deflex.net/ruv-swarm-transport-linux-x64-gnu`
- **Linux ARM64**: `@deflex.net/ruv-swarm-transport-linux-arm64-gnu`
- **macOS x64**: `@deflex.net/ruv-swarm-transport-darwin-x64`
- **macOS ARM64**: `@deflex.net/ruv-swarm-transport-darwin-arm64`
- **Windows x64**: `@deflex.net/ruv-swarm-transport-win32-x64-msvc`
- **WebAssembly**: `@deflex.net/ruv-swarm-transport-wasm32` (fallback)
...
```typescript
import { RuvSwarmTransport } from '@deflex.net/ruv-swarm-transport'

// Create an instance
const client = new RuvSwarmTransport({
...
```typescript
import { RuvSwarmTransport, configs } from '@deflex.net/ruv-swarm-transport'
...
const client = new RuvSwarmTransport(configs)
```
...
// CommonJS
const { RuvSwarmTransport } = require('@deflex.net/ruv-swarm-transport')
```
...
try {
  ...
  if (error instanceof RuvSwarmTransportError) {
...
Creates a new instance of `RuvSwarmTransport`.

**Parameters:**
- `configs` (optional): configsuration object

**Returns:**
- Instance of `RuvSwarmTransport`
...
#### `RuvSwarmTransportError`

Base error class for all errors thrown by this package.

```typescript
class RuvSwarmTransportError extends Error {
  code: string
  details?: any
}
```
...
```typescript
import { RuvSwarmTransport, RuvSwarmTransportError } from '@deflex.net/ruv-swarm-transport'
...
```typescript
import { RuvSwarmTransport, configs, LogLevel } from '@deflex.net/ruv-swarm-transport'
...
cd deflex.net/packages/ruv-swarm-transport
...
- **NPM Package**: [@deflex.net/ruv-swarm-transport](https://www.npmjs.com/package/@deflex.net/ruv-swarm-transport)
- **GitHub Repository**: [flexnetos/deflex.net](https://github.com/flexnetos/deflex.net)
- **Rust Crate**: [ruv-swarm-transport](https://crates.io/crates/ruv-swarm-transport)
- **Documentation**: [docs.deflex.net/ruv-swarm-transport](https://docs.deflex.net/ruv-swarm-transport)
...
- Original crate by the [ruv-swarm-transport](https://crates.io/crates/ruv-swarm-transport) authors

---

## 📊 Stats

![NPM](https://nodei.co/npm/@deflex.net/ruv-swarm-transport.png?downloads=true&downloadRank=true&stars=true)
