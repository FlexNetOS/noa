# 📦 @deflex.net/aimds-core

> Core types and abstractions for AI Manipulation Defense System (AIMDS)

[![npm version](https://img.shields.io/npm/v/@deflex.net/aimds-core.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/aimds-core)
[![npm downloads](https://img.shields.io/npm/dm/@deflex.net/aimds-core.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/aimds-core)
[![license](https://img.shields.io/npm/l/@deflex.net/aimds-core.svg?style=flat-square)](https://github.com/flexnetos/deflex.net/blob/main/LICENSE)
...
`@deflex.net/aimds-core` is a high-performance Node.js native addon that provides TypeScript bindings for the [`aimds-core`](https://crates.io/crates/aimds-core) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
- **License**: MIT
- **Rust Crate**: [aimds-core](https://crates.io/crates/aimds-core)
...
```bash
npm install @deflex.net/aimds-core
```

### Using yarn

```bash
yarn add @deflex.net/aimds-core
```

### Using pnpm

```bash
pnpm add @deflex.net/aimds-core
```
...
- **Linux x64**: `@deflex.net/aimds-core-linux-x64-gnu`
- **Linux ARM64**: `@deflex.net/aimds-core-linux-arm64-gnu`
- **macOS x64**: `@deflex.net/aimds-core-darwin-x64`
- **macOS ARM64**: `@deflex.net/aimds-core-darwin-arm64`
- **Windows x64**: `@deflex.net/aimds-core-win32-x64-msvc`
- **WebAssembly**: `@deflex.net/aimds-core-wasm32` (fallback)
...
```typescript
import { AimdsCore } from '@deflex.net/aimds-core'
...
```typescript
import { AimdsCore, Config } from '@deflex.net/aimds-core'
...
const client = new AimdsCore(config)
```
...
// CommonJS
const { AimdsCore } = require('@deflex.net/aimds-core')
```
...
try {
  ...
  if (error instanceof AimdsCoreError) {
...
Creates a new instance of `AimdsCore`.

**Parameters:**
- `config` (optional): Configuration object

**Returns:**
- Instance of `AimdsCore`
...
```typescript
class AimdsCoreError extends Error {
  code: string
  details?: any
}
```
...
```typescript
import { AimdsCore, AimdsCoreError } from '@deflex.net/aimds-core'
...
```typescript
import { AimdsCore, Config, LogLevel } from '@deflex.net/aimds-core'
...
cd deflex.net/packages/aimds-core
...
- **NPM Package**: [@deflex.net/aimds-core](https://www.npmjs.com/package/@deflex.net/aimds-core)
- **GitHub Repository**: [flexnetos/deflex.net](https://github.com/flexnetos/deflex.net)
- **Rust Crate**: [aimds-core](https://crates.io/crates/aimds-core)
- **Documentation**: [docs.deflex.net/aimds-core](https://docs.deflex.net/aimds-core)
...
- Original crate by the [aimds-core](https://crates.io/crates/aimds-core) authors

---

## 📊 Stats

![NPM](https://nodei.co/npm/@deflex.net/aimds-core.png?downloads=true&downloadRank=true&stars=true)
