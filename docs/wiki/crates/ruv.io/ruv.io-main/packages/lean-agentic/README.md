# 📝 @deflex.net/lean-agentic

> Core library for Lean-Agentic: hash-consed dependent types with 150x faster equality

[![npm version](https://img.shields.io/npm/v/@deflex.net/lean-agentic.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/lean-agentic)
[![npm downloads](https://img.shields.io/npm/dm/@deflex.net/lean-agentic.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/lean-agentic)
[![license](https://img.shields.io/npm/l/@deflex.net/lean-agentic.svg?style=flat-square)](https://github.com/flexnetos/deflex.net/blob/main/LICENSE)
...
`@deflex.net/lean-agentic` is a high-performance Node.js native addon that provides TypeScript bindings for the [`lean-agentic`](https://crates.io/crates/lean-agentic) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
- **License**: MIT
- **Rust Crate**: [lean-agentic](https://crates.io/crates/lean-agentic)
...
```bash
npm install @deflex.net/lean-agentic
```

### Using yarn

```bash
yarn add @deflex.net/lean-agentic
```

### Using pnpm

```bash
pnpm add @deflex.net/lean-agentic
```
...
- **Linux x64**: `@deflex.net/lean-agentic-linux-x64-gnu`
- **Linux ARM64**: `@deflex.net/lean-agentic-linux-arm64-gnu`
- **macOS x64**: `@deflex.net/lean-agentic-darwin-x64`
- **macOS ARM64**: `@deflex.net/lean-agentic-darwin-arm64`
- **Windows x64**: `@deflex.net/lean-agentic-win32-x64-msvc`
- **WebAssembly**: `@deflex.net/lean-agentic-wasm32` (fallback)
...
```typescript
import { LeanAgentic } from '@deflex.net/lean-agentic'

// Create an instance
const client = new LeanAgentic({
...
```typescript
import { LeanAgentic, configs } from '@deflex.net/lean-agentic'
...
const client = new LeanAgentic(configs)
```
...
// CommonJS
const { LeanAgentic } = require('@deflex.net/lean-agentic')
```
...
try {
  ...
  if (error instanceof LeanAgenticError) {
...
Creates a new instance of `LeanAgentic`.

**Parameters:**
- `configs` (optional): configsuration object

**Returns:**
- Instance of `LeanAgentic`
...
```typescript
class LeanAgenticError extends Error {
  code: string
  details?: any
}
```
...
```typescript
import { LeanAgentic, LeanAgenticError } from '@deflex.net/lean-agentic'
...
```typescript
import { LeanAgentic, configs, LogLevel } from '@deflex.net/lean-agentic'
...
cd deflex.net/packages/lean-agentic
...
- **NPM Package**: [@deflex.net/lean-agentic](https://www.npmjs.com/package/@deflex.net/lean-agentic)
- **GitHub Repository**: [flexnetos/deflex.net](https://github.com/flexnetos/deflex.net)
- **Rust Crate**: [lean-agentic](https://crates.io/crates/lean-agentic)
- **Documentation**: [docs.deflex.net/lean-agentic](https://docs.deflex.net/lean-agentic)
...
- Original crate by the [lean-agentic](https://crates.io/crates/lean-agentic) authors

---

## 📊 Stats

![NPM](https://nodei.co/npm/@deflex.net/lean-agentic.png?downloads=true&downloadRank=true&stars=true)
