...
```typescript
import { LeanAgentic, Config } from '@deflex.net/lean-agentic'
...
const client = new LeanAgentic(config)
```
...
```typescript
import { LeanAgentic, Config, LogLevel } from '@deflex.net/lean-agentic'
