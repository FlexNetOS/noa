# 🛠️ @deflex.net/agentic-jujutsu

> AI-powered Jujutsu VCS wrapper for multi-agent collaboration - 10-100x faster than Git with MCP protocol support

[![npm version](https://img.shields.io/npm/v/@deflex.net/agentic-jujutsu.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/agentic-jujutsu)
[![npm downloads](https://img.shields.io/npm/dm/@deflex.net/agentic-jujutsu.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/agentic-jujutsu)
[![license](https://img.shields.io/npm/l/@deflex.net/agentic-jujutsu.svg?style=flat-square)](https://github.com/flexnetos/deflex.net/blob/main/LICENSE)
...
`@deflex.net/agentic-jujutsu` is a high-performance Node.js native addon that provides TypeScript bindings for the [`agentic-jujutsu`](https://crates.io/crates/agentic-jujutsu) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.

**Key Information:**
- **Version**: 1.0.1
- **Downloads**: 42+
- **Categories**: Mcp Protocol, Dev Tools
- **License**: MIT
- **Rust Crate**: [agentic-jujutsu](https://crates.io/crates/agentic-jujutsu)
...
```bash
npm install @deflex.net/agentic-jujutsu
```

### Using yarn

```bash
yarn add @deflex.net/agentic-jujutsu
```

### Using pnpm

```bash
pnpm add @deflex.net/agentic-jujutsu
```
...
- **Linux x64**: `@deflex.net/agentic-jujutsu-linux-x64-gnu`
- **Linux ARM64**: `@deflex.net/agentic-jujutsu-linux-arm64-gnu`
- **macOS x64**: `@deflex.net/agentic-jujutsu-darwin-x64`
- **macOS ARM64**: `@deflex.net/agentic-jujutsu-darwin-arm64`
- **Windows x64**: `@deflex.net/agentic-jujutsu-win32-x64-msvc`
- **WebAssembly**: `@deflex.net/agentic-jujutsu-wasm32` (fallback)
...
```typescript
import { AgenticJujutsu } from '@deflex.net/agentic-jujutsu'

// Create an instance
const client = new AgenticJujutsu({
...
```typescript
import { AgenticJujutsu, Config } from '@deflex.net/agentic-jujutsu'
...
const client = new AgenticJujutsu(config)
```
...
// CommonJS
const { AgenticJujutsu } = require('@deflex.net/agentic-jujutsu')
```
...
try {
  ...
  if (error instanceof AgenticJujutsuError) {
...
Creates a new instance of `AgenticJujutsu`.

**Parameters:**
- `config` (optional): Configuration object

**Returns:**
- Instance of `AgenticJujutsu`
...
```typescript
class AgenticJujutsuError extends Error {
  code: string
  details?: any
}
```
...
```typescript
import { AgenticJujutsu, AgenticJujutsuError } from '@deflex.net/agentic-jujutsu'
...
```typescript
import { AgenticJujutsu, Config, LogLevel } from '@deflex.net/agentic-jujutsu'
...
cd deflex.net/packages/agentic-jujutsu
...
- **NPM Package**: [@deflex.net/agentic-jujutsu](https://www.npmjs.com/package/@deflex.net/agentic-jujutsu)
- **GitHub Repository**: [flexnetos/deflex.net](https://github.com/flexnetos/deflex.net)
- **Rust Crate**: [agentic-jujutsu](https://crates.io/crates/agentic-jujutsu)
- **Documentation**: [docs.deflex.net/agentic-jujutsu](https://docs.deflex.net/agentic-jujutsu)
...
- Original crate by the [agentic-jujutsu](https://crates.io/crates/agentic-jujutsu) authors

---

## 📊 Stats

![NPM](https://nodei.co/npm/@deflex.net/agentic-jujutsu.png?downloads=true&downloadRank=true&stars=true)
