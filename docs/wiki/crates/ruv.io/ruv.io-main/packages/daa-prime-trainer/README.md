# 📦 @deflex.net/daa-prime-trainer

> Distributed SGD/FSDP trainer for Prime ML framework

[![npm version](https://img.shields.io/npm/v/@deflex.net/daa-prime-trainer.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/daa-prime-trainer)
[![npm downloads](https://img.shields.io/npm/dm/@deflex.net/daa-prime-trainer.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/daa-prime-trainer)
[![license](https://img.shields.io/npm/l/@deflex.net/daa-prime-trainer.svg?style=flat-square)](https://github.com/flexnetos/deflex.net/blob/main/LICENSE)
...
`@deflex.net/daa-prime-trainer` is a high-performance Node.js native addon that provides TypeScript bindings for the [`daa-prime-trainer`](https://crates.io/crates/daa-prime-trainer) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
- **Categories**: General
- **License**: MIT
- **Rust Crate**: [daa-prime-trainer](https://crates.io/crates/daa-prime-trainer)
...
```bash
npm install @deflex.net/daa-prime-trainer
```

### Using yarn

```bash
yarn add @deflex.net/daa-prime-trainer
```

### Using pnpm

```bash
pnpm add @deflex.net/daa-prime-trainer
```
...
- **Linux x64**: `@deflex.net/daa-prime-trainer-linux-x64-gnu`
- **Linux ARM64**: `@deflex.net/daa-prime-trainer-linux-arm64-gnu`
- **macOS x64**: `@deflex.net/daa-prime-trainer-darwin-x64`
- **macOS ARM64**: `@deflex.net/daa-prime-trainer-darwin-arm64`
- **Windows x64**: `@deflex.net/daa-prime-trainer-win32-x64-msvc`
- **WebAssembly**: `@deflex.net/daa-prime-trainer-wasm32` (fallback)
...
```typescript
import { DaaPrimeTrainer } from '@deflex.net/daa-prime-trainer'

// Create an instance
const client = new DaaPrimeTrainer({
...
```typescript
import { DaaPrimeTrainer, Config } from '@deflex.net/daa-prime-trainer'
...
const client = new DaaPrimeTrainer(config)
```
...
// CommonJS
const { DaaPrimeTrainer } = require('@deflex.net/daa-prime-trainer')
```
...
try {
  ...
  if (error instanceof DaaPrimeTrainerError) {
...
Creates a new instance of `DaaPrimeTrainer`.

**Parameters:**
- `config` (optional): Configuration object

**Returns:**
- Instance of `DaaPrimeTrainer`
...
#### `DaaPrimeTrainerError`

Base error class for all errors thrown by this package.

```typescript
class DaaPrimeTrainerError extends Error {
  code: string
  details?: any
}
```
...
```typescript
import { DaaPrimeTrainer, DaaPrimeTrainerError } from '@deflex.net/daa-prime-trainer'
...
```typescript
import { DaaPrimeTrainer, Config, LogLevel } from '@deflex.net/daa-prime-trainer'
...
cd deflex.net/packages/daa-prime-trainer
...
- **NPM Package**: [@deflex.net/daa-prime-trainer](https://www.npmjs.com/package/@deflex.net/daa-prime-trainer)
- **GitHub Repository**: [flexnetos/deflex.net](https://github.com/flexnetos/deflex.net)
- **Rust Crate**: [daa-prime-trainer](https://crates.io/crates/daa-prime-trainer)
- **Documentation**: [docs.deflex.net/daa-prime-trainer](https://docs.deflex.net/daa-prime-trainer)
...
- Original crate by the [daa-prime-trainer](https://crates.io/crates/daa-prime-trainer) authors

---

## 📊 Stats

![NPM](https://nodei.co/npm/@deflex.net/daa-prime-trainer.png?downloads=true&downloadRank=true&stars=true)
