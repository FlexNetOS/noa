# ⏰ @deflex.net/midstreamer-quic

> QUIC multi-stream support for native and WASM targets

[![npm version](https://img.shields.io/npm/v/@deflex.net/midstreamer-quic.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/midstreamer-quic)
[![npm downloads](https://img.shields.io/npm/dm/@deflex.net/midstreamer-quic.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/midstreamer-quic)
[![license](https://img.shields.io/npm/l/@deflex.net/midstreamer-quic.svg?style=flat-square)](https://github.com/flexnetos/deflex.net/blob/main/LICENSE)
...
`@deflex.net/midstreamer-quic` is a high-performance Node.js native addon that provides TypeScript bindings for the [`midstreamer-quic`](https://crates.io/crates/midstreamer-quic) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
- **License**: MIT
- **Rust Crate**: [midstreamer-quic](https://crates.io/crates/midstreamer-quic)
...
```bash
npm install @deflex.net/midstreamer-quic
```

### Using yarn

```bash
yarn add @deflex.net/midstreamer-quic
```

### Using pnpm

```bash
pnpm add @deflex.net/midstreamer-quic
```
...
- **Linux x64**: `@deflex.net/midstreamer-quic-linux-x64-gnu`
- **Linux ARM64**: `@deflex.net/midstreamer-quic-linux-arm64-gnu`
- **macOS x64**: `@deflex.net/midstreamer-quic-darwin-x64`
- **macOS ARM64**: `@deflex.net/midstreamer-quic-darwin-arm64`
- **Windows x64**: `@deflex.net/midstreamer-quic-win32-x64-msvc`
- **WebAssembly**: `@deflex.net/midstreamer-quic-wasm32` (fallback)
...
```typescript
import { MidstreamerQuic } from '@deflex.net/midstreamer-quic'

// Create an instance
const client = new MidstreamerQuic({
...
```typescript
import { MidstreamerQuic, configs } from '@deflex.net/midstreamer-quic'
...
const client = new MidstreamerQuic(configs)
```
...
// CommonJS
const { MidstreamerQuic } = require('@deflex.net/midstreamer-quic')
```
...
try {
  ...
  if (error instanceof MidstreamerQuicError) {
...
Creates a new instance of `MidstreamerQuic`.

**Parameters:**
- `configs` (optional): configsuration object

**Returns:**
- Instance of `MidstreamerQuic`
...
#### `MidstreamerQuicError`

Base error class for all errors thrown by this package.

```typescript
class MidstreamerQuicError extends Error {
  code: string
  details?: any
}
```
...
```typescript
import { MidstreamerQuic, MidstreamerQuicError } from '@deflex.net/midstreamer-quic'
...
```typescript
import { MidstreamerQuic, configs, LogLevel } from '@deflex.net/midstreamer-quic'
...
cd deflex.net/packages/midstreamer-quic
...
- **NPM Package**: [@deflex.net/midstreamer-quic](https://www.npmjs.com/package/@deflex.net/midstreamer-quic)
- **GitHub Repository**: [flexnetos/deflex.net](https://github.com/flexnetos/deflex.net)
- **Rust Crate**: [midstreamer-quic](https://crates.io/crates/midstreamer-quic)
- **Documentation**: [docs.deflex.net/midstreamer-quic](https://docs.deflex.net/midstreamer-quic)
...
- Original crate by the [midstreamer-quic](https://crates.io/crates/midstreamer-quic) authors

---

## 📊 Stats

![NPM](https://nodei.co/npm/@deflex.net/midstreamer-quic.png?downloads=true&downloadRank=true&stars=true)
