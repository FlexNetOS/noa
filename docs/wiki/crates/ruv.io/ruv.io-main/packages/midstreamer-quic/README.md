...
```typescript
import { MidstreamerQuic, Config } from '@deflex.net/midstreamer-quic'
...
const client = new MidstreamerQuic(config)
```
...
```typescript
import { MidstreamerQuic, Config, LogLevel } from '@deflex.net/midstreamer-quic'
