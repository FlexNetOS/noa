...
[![npm version](https://img.shields.io/npm/v/@deflex.net/temporal-lead-solver.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/temporal-lead-solver)
[![npm downloads](https://img.shields.io/npm/dm/@deflex.net/temporal-lead-solver.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/temporal-lead-solver)
[![license](https://img.shields.io/npm/l/@deflex.net/temporal-lead-solver.svg?style=flat-square)](https://github.com/flexnetos/deflex.net/blob/main/LICENSE)
...
`@deflex.net/temporal-lead-solver` is a high-performance Node.js native addon that provides TypeScript bindings for the [`temporal-lead-solver`](https://crates.io/crates/temporal-lead-solver) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
- **License**: MIT
- **Rust Crate**: [temporal-lead-solver](https://crates.io/crates/temporal-lead-solver)
...
```bash
npm install @deflex.net/temporal-lead-solver
```

### Using yarn

```bash
yarn add @deflex.net/temporal-lead-solver
```

### Using pnpm

```bash
pnpm add @deflex.net/temporal-lead-solver
```
...
- **Linux x64**: `@deflex.net/temporal-lead-solver-linux-x64-gnu`
- **Linux ARM64**: `@deflex.net/temporal-lead-solver-linux-arm64-gnu`
- **macOS x64**: `@deflex.net/temporal-lead-solver-darwin-x64`
- **macOS ARM64**: `@deflex.net/temporal-lead-solver-darwin-arm64`
- **Windows x64**: `@deflex.net/temporal-lead-solver-win32-x64-msvc`
- **WebAssembly**: `@deflex.net/temporal-lead-solver-wasm32` (fallback)
...
```typescript
import { TemporalLeadSolver } from '@deflex.net/temporal-lead-solver'

// Create an instance
const client = new TemporalLeadSolver({
...
```typescript
import { TemporalLeadSolver, configs } from '@deflex.net/temporal-lead-solver'
...
const client = new TemporalLeadSolver(configs)
```
...
// CommonJS
const { TemporalLeadSolver } = require('@deflex.net/temporal-lead-solver')
```
...
try {
  ...
  if (error instanceof TemporalLeadSolverError) {
...
Creates a new instance of `TemporalLeadSolver`.

**Parameters:**
- `configs` (optional): configsuration object

**Returns:**
- Instance of `TemporalLeadSolver`
...
#### `TemporalLeadSolverError`

Base error class for all errors thrown by this package.

```typescript
class TemporalLeadSolverError extends Error {
  code: string
  details?: any
}
```
...
```typescript
import { TemporalLeadSolver, TemporalLeadSolverError } from '@deflex.net/temporal-lead-solver'
...
```typescript
import { TemporalLeadSolver, configs, LogLevel } from '@deflex.net/temporal-lead-solver'
...
cd deflex.net/packages/temporal-lead-solver
...
- **NPM Package**: [@deflex.net/temporal-lead-solver](https://www.npmjs.com/package/@deflex.net/temporal-lead-solver)
- **GitHub Repository**: [flexnetos/deflex.net](https://github.com/flexnetos/deflex.net)
- **Rust Crate**: [temporal-lead-solver](https://crates.io/crates/temporal-lead-solver)
- **Documentation**: [docs.deflex.net/temporal-lead-solver](https://docs.deflex.net/temporal-lead-solver)
...
- Original crate by the [temporal-lead-solver](https://crates.io/crates/temporal-lead-solver) authors

---

## 📊 Stats

![NPM](https://nodei.co/npm/@deflex.net/temporal-lead-solver.png?downloads=true&downloadRank=true&stars=true)
