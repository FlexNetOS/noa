...
```typescript
import { TemporalLeadSolver, Config } from '@deflex.net/temporal-lead-solver'
...
const client = new TemporalLeadSolver(config)
```
...
```typescript
import { TemporalLeadSolver, Config, LogLevel } from '@deflex.net/temporal-lead-solver'
