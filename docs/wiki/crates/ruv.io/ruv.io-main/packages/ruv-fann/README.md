...
[![npm version](https://img.shields.io/npm/v/@deflex.net/ruv-fann.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/ruv-fann)
[![npm downloads](https://img.shields.io/npm/dm/@deflex.net/ruv-fann.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/ruv-fann)
[![license](https://img.shields.io/npm/l/@deflex.net/ruv-fann.svg?style=flat-square)](https://github.com/flexnetos/deflex.net/blob/main/LICENSE)
...
`@deflex.net/ruv-fann` is a high-performance Node.js native addon that provides TypeScript bindings for the [`ruv-fann`](https://crates.io/crates/ruv-fann) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
- **License**: MIT
- **Rust Crate**: [ruv-fann](https://crates.io/crates/ruv-fann)
...
```bash
npm install @deflex.net/ruv-fann
```

### Using yarn

```bash
yarn add @deflex.net/ruv-fann
```

### Using pnpm

```bash
pnpm add @deflex.net/ruv-fann
```
...
- **Linux x64**: `@deflex.net/ruv-fann-linux-x64-gnu`
- **Linux ARM64**: `@deflex.net/ruv-fann-linux-arm64-gnu`
- **macOS x64**: `@deflex.net/ruv-fann-darwin-x64`
- **macOS ARM64**: `@deflex.net/ruv-fann-darwin-arm64`
- **Windows x64**: `@deflex.net/ruv-fann-win32-x64-msvc`
- **WebAssembly**: `@deflex.net/ruv-fann-wasm32` (fallback)
...
```typescript
import { RuvFann } from '@deflex.net/ruv-fann'

// Create an instance
const client = new RuvFann({
...
```typescript
import { RuvFann, Config } from '@deflex.net/ruv-fann'
...
const client = new RuvFann(config)
```
...
// CommonJS
const { RuvFann } = require('@deflex.net/ruv-fann')
```
...
try {
  ...
  if (error instanceof RuvFannError) {
...
Creates a new instance of `RuvFann`.
...
```typescript
class RuvFannError extends Error {
  code: string
  details?: any
}
```
...
```typescript
import { RuvFann, RuvFannError } from '@deflex.net/ruv-fann'
...
```typescript
import { RuvFann, Config, LogLevel } from '@deflex.net/ruv-fann'
...
cd deflex.net/packages/ruv-fann
...
- **NPM Package**: [@deflex.net/ruv-fann](https://www.npmjs.com/package/@deflex.net/ruv-fann)
- **GitHub Repository**: [flexnetos/deflex.net](https://github.com/flexnetos/deflex.net)
- **Rust Crate**: [ruv-fann](https://crates.io/crates/ruv-fann)
- **Documentation**: [docs.deflex.net/ruv-fann](https://docs.deflex.net/ruv-fann)
...
- Original crate by the [ruv-fann](https://crates.io/crates/ruv-fann) authors

---

## 📊 Stats

![NPM](https://nodei.co/npm/@deflex.net/ruv-fann.png?downloads=true&downloadRank=true&stars=true)
