# 📦 @deflex.net/nt-streaming

> Real-time market data streaming for Neural Trader - WebSocket connections to exchanges

[![npm version](https://img.shields.io/npm/v/@deflex.net/nt-streaming.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/nt-streaming)
[![npm downloads](https://img.shields.io/npm/dm/@deflex.net/nt-streaming.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/nt-streaming)
[![license](https://img.shields.io/npm/l/@deflex.net/nt-streaming.svg?style=flat-square)](https://github.com/flexnetos/deflex.net/blob/main/LICENSE)
...
`@deflex.net/nt-streaming` is a high-performance Node.js native addon that provides TypeScript bindings for the [`nt-streaming`](https://crates.io/crates/nt-streaming) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
- **License**: MIT
- **Rust Crate**: [nt-streaming](https://crates.io/crates/nt-streaming)
...
```bash
npm install @deflex.net/nt-streaming
```

### Using yarn

```bash
yarn add @deflex.net/nt-streaming
```

### Using pnpm

```bash
pnpm add @deflex.net/nt-streaming
```
...
- **Linux x64**: `@deflex.net/nt-streaming-linux-x64-gnu`
- **Linux ARM64**: `@deflex.net/nt-streaming-linux-arm64-gnu`
- **macOS x64**: `@deflex.net/nt-streaming-darwin-x64`
- **macOS ARM64**: `@deflex.net/nt-streaming-darwin-arm64`
- **Windows x64**: `@deflex.net/nt-streaming-win32-x64-msvc`
- **WebAssembly**: `@deflex.net/nt-streaming-wasm32` (fallback)
...
```typescript
import { NtStreaming } from '@deflex.net/nt-streaming'

// Create an instance
const client = new NtStreaming({
...
```typescript
import { NtStreaming, Config } from '@deflex.net/nt-streaming'
...
const client = new NtStreaming(config)
```
...
// CommonJS
const { NtStreaming } = require('@deflex.net/nt-streaming')
```
...
try {
  ...
  if (error instanceof NtStreamingError) {
...
Creates a new instance of `NtStreaming`.

**Parameters:**
- `config` (optional): Configuration object

**Returns:**
- Instance of `NtStreaming`
...
```typescript
class NtStreamingError extends Error {
  code: string
  details?: any
}
```
...
```typescript
import { NtStreaming, NtStreamingError } from '@deflex.net/nt-streaming'
...
```typescript
import { NtStreaming, Config, LogLevel } from '@deflex.net/nt-streaming'
...
cd deflex.net/packages/nt-streaming
...
- **NPM Package**: [@deflex.net/nt-streaming](https://www.npmjs.com/package/@deflex.net/nt-streaming)
- **GitHub Repository**: [flexnetos/deflex.net](https://github.com/flexnetos/deflex.net)
- **Rust Crate**: [nt-streaming](https://crates.io/crates/nt-streaming)
- **Documentation**: [docs.deflex.net/nt-streaming](https://docs.deflex.net/nt-streaming)
...
- Original crate by the [nt-streaming](https://crates.io/crates/nt-streaming) authors

---

## 📊 Stats

![NPM](https://nodei.co/npm/@deflex.net/nt-streaming.png?downloads=true&downloadRank=true&stars=true)
