# 📦 @deflex.net/aimds-detection

> Fast-path detection layer for AIMDS with pattern matching and anomaly detection

[![npm version](https://img.shields.io/npm/v/@deflex.net/aimds-detection.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/aimds-detection)
[![npm downloads](https://img.shields.io/npm/dm/@deflex.net/aimds-detection.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/aimds-detection)
[![license](https://img.shields.io/npm/l/@deflex.net/aimds-detection.svg?style=flat-square)](https://github.com/flexnetos/deflex.net/blob/main/LICENSE)
...
`@deflex.net/aimds-detection` is a high-performance Node.js native addon that provides TypeScript bindings for the [`aimds-detection`](https://crates.io/crates/aimds-detection) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
- **License**: MIT
- **Rust Crate**: [aimds-detection](https://crates.io/crates/aimds-detection)
...
```bash
npm install @deflex.net/aimds-detection
```

### Using yarn

```bash
yarn add @deflex.net/aimds-detection
```

### Using pnpm

```bash
pnpm add @deflex.net/aimds-detection
```
...
- **Linux x64**: `@deflex.net/aimds-detection-linux-x64-gnu`
- **Linux ARM64**: `@deflex.net/aimds-detection-linux-arm64-gnu`
- **macOS x64**: `@deflex.net/aimds-detection-darwin-x64`
- **macOS ARM64**: `@deflex.net/aimds-detection-darwin-arm64`
- **Windows x64**: `@deflex.net/aimds-detection-win32-x64-msvc`
- **WebAssembly**: `@deflex.net/aimds-detection-wasm32` (fallback)
...
```typescript
import { AimdsDetection } from '@deflex.net/aimds-detection'

// Create an instance
const client = new AimdsDetection({
...
```typescript
import { AimdsDetection, Config } from '@deflex.net/aimds-detection'
...
const client = new AimdsDetection(config)
```
...
// CommonJS
const { AimdsDetection } = require('@deflex.net/aimds-detection')
```
...
try {
  ...
  if (error instanceof AimdsDetectionError) {
...
Creates a new instance of `AimdsDetection`.

**Parameters:**
- `config` (optional): Configuration object

**Returns:**
- Instance of `AimdsDetection`
...
```typescript
class AimdsDetectionError extends Error {
  code: string
  details?: any
}
```
...
```typescript
import { AimdsDetection, AimdsDetectionError } from '@deflex.net/aimds-detection'
...
```typescript
import { AimdsDetection, Config, LogLevel } from '@deflex.net/aimds-detection'
...
cd deflex.net/packages/aimds-detection
...
- **NPM Package**: [@deflex.net/aimds-detection](https://www.npmjs.com/package/@deflex.net/aimds-detection)
- **GitHub Repository**: [flexnetos/deflex.net](https://github.com/flexnetos/deflex.net)
- **Rust Crate**: [aimds-detection](https://crates.io/crates/aimds-detection)
- **Documentation**: [docs.deflex.net/aimds-detection](https://docs.deflex.net/aimds-detection)
...
- Original crate by the [aimds-detection](https://crates.io/crates/aimds-detection) authors

---

## 📊 Stats

![NPM](https://nodei.co/npm/@deflex.net/aimds-detection.png?downloads=true&downloadRank=true&stars=true)
