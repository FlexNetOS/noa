...
[![npm version](https://img.shields.io/npm/v/@deflex.net/nt-utils.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/nt-utils)
[![npm downloads](https://img.shields.io/npm/dm/@deflex.net/nt-utils.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/nt-utils)
[![license](https://img.shields.io/npm/l/@deflex.net/nt-utils.svg?style=flat-square)](https://github.com/flexnetos/deflex.net/blob/main/LICENSE)
...
`@deflex.net/nt-utils` is a high-performance Node.js native addon that provides TypeScript bindings for the [`nt-utils`](https://crates.io/crates/nt-utils) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
- **License**: MIT
- **Rust Crate**: [nt-utils](https://crates.io/crates/nt-utils)
...
```bash
npm install @deflex.net/nt-utils
```

### Using yarn

```bash
yarn add @deflex.net/nt-utils
```

### Using pnpm

```bash
pnpm add @deflex.net/nt-utils
```
...
- **Linux x64**: `@deflex.net/nt-utils-linux-x64-gnu`
- **Linux ARM64**: `@deflex.net/nt-utils-linux-arm64-gnu`
- **macOS x64**: `@deflex.net/nt-utils-darwin-x64`
- **macOS ARM64**: `@deflex.net/nt-utils-darwin-arm64`
- **Windows x64**: `@deflex.net/nt-utils-win32-x64-msvc`
- **WebAssembly**: `@deflex.net/nt-utils-wasm32` (fallback)
...
```typescript
import { NtUtils } from '@deflex.net/nt-utils'

// Create an instance
const client = new NtUtils({
...
```typescript
import { NtUtils, Config } from '@deflex.net/nt-utils'
...
const client = new NtUtils(config)
```
...
// CommonJS
const { NtUtils } = require('@deflex.net/nt-utils')
```
...
try {
  ...
  if (error instanceof NtUtilsError) {
...
Creates a new instance of `NtUtils`.
...
```typescript
class NtUtilsError extends Error {
  code: string
  details?: any
}
```
...
```typescript
import { NtUtils, NtUtilsError } from '@deflex.net/nt-utils'
...
```typescript
import { NtUtils, Config, LogLevel } from '@deflex.net/nt-utils'
...
cd deflex.net/packages/nt-utils
...
- **NPM Package**: [@deflex.net/nt-utils](https://www.npmjs.com/package/@deflex.net/nt-utils)
- **GitHub Repository**: [flexnetos/deflex.net](https://github.com/flexnetos/deflex.net)
- **Rust Crate**: [nt-utils](https://crates.io/crates/nt-utils)
- **Documentation**: [docs.deflex.net/nt-utils](https://docs.deflex.net/nt-utils)
...
- Original crate by the [nt-utils](https://crates.io/crates/nt-utils) authors

---

## 📊 Stats

![NPM](https://nodei.co/npm/@deflex.net/nt-utils.png?downloads=true&downloadRank=true&stars=true)
