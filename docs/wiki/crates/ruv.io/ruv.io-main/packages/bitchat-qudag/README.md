# ⚛️ @deflex.net/bitchat-qudag

> BitChat messaging integration for QuDAG with WASM support

[![npm version](https://img.shields.io/npm/v/@deflex.net/bitchat-qudag.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/bitchat-qudag)
[![npm downloads](https://img.shields.io/npm/dm/@deflex.net/bitchat-qudag.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/bitchat-qudag)
[![license](https://img.shields.io/npm/l/@deflex.net/bitchat-qudag.svg?style=flat-square)](https://github.com/flexnetos/deflex.net/blob/main/LICENSE)
...
`@deflex.net/bitchat-qudag` is a high-performance Node.js native addon that provides TypeScript bindings for the [`bitchat-qudag`](https://crates.io/crates/bitchat-qudag) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
- **License**: MIT
- **Rust Crate**: [bitchat-qudag](https://crates.io/crates/bitchat-qudag)
...
```bash
npm install @deflex.net/bitchat-qudag
```

### Using yarn

```bash
yarn add @deflex.net/bitchat-qudag
```

### Using pnpm

```bash
pnpm add @deflex.net/bitchat-qudag
```
...
- **Linux x64**: `@deflex.net/bitchat-qudag-linux-x64-gnu`
- **Linux ARM64**: `@deflex.net/bitchat-qudag-linux-arm64-gnu`
- **macOS x64**: `@deflex.net/bitchat-qudag-darwin-x64`
- **macOS ARM64**: `@deflex.net/bitchat-qudag-darwin-arm64`
- **Windows x64**: `@deflex.net/bitchat-qudag-win32-x64-msvc`
- **WebAssembly**: `@deflex.net/bitchat-qudag-wasm32` (fallback)
...
```typescript
import { BitchatQudag } from '@deflex.net/bitchat-qudag'

// Create an instance
const client = new BitchatQudag({
...
```typescript
import { BitchatQudag, Config } from '@deflex.net/bitchat-qudag'
...
const client = new BitchatQudag(config)
```
...
// CommonJS
const { BitchatQudag } = require('@deflex.net/bitchat-qudag')
```
...
try {
  ...
  if (error instanceof BitchatQudagError) {
...
Creates a new instance of `BitchatQudag`.

**Parameters:**
- `config` (optional): Configuration object

**Returns:**
- Instance of `BitchatQudag`
...
```typescript
class BitchatQudagError extends Error {
  code: string
  details?: any
}
```
...
```typescript
import { BitchatQudag, BitchatQudagError } from '@deflex.net/bitchat-qudag'
...
```typescript
import { BitchatQudag, Config, LogLevel } from '@deflex.net/bitchat-qudag'
...
cd deflex.net/packages/bitchat-qudag
...
- **NPM Package**: [@deflex.net/bitchat-qudag](https://www.npmjs.com/package/@deflex.net/bitchat-qudag)
- **GitHub Repository**: [flexnetos/deflex.net](https://github.com/flexnetos/deflex.net)
- **Rust Crate**: [bitchat-qudag](https://crates.io/crates/bitchat-qudag)
- **Documentation**: [docs.deflex.net/bitchat-qudag](https://docs.deflex.net/bitchat-qudag)
...
- Original crate by the [bitchat-qudag](https://crates.io/crates/bitchat-qudag) authors

---

## 📊 Stats

![NPM](https://nodei.co/npm/@deflex.net/bitchat-qudag.png?downloads=true&downloadRank=true&stars=true)
