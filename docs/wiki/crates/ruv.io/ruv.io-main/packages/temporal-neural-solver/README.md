# 🧠 @deflex.net/temporal-neural-solver

> Ultra-fast neural network inference with sub-microsecond latency

[![npm version](https://img.shields.io/npm/v/@deflex.net/temporal-neural-solver.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/temporal-neural-solver)
[![npm downloads](https://img.shields.io/npm/dm/@deflex.net/temporal-neural-solver.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/temporal-neural-solver)
[![license](https://img.shields.io/npm/l/@deflex.net/temporal-neural-solver.svg?style=flat-square)](https://github.com/flexnetos/deflex.net/blob/main/LICENSE)
...
`@deflex.net/temporal-neural-solver` is a high-performance Node.js native addon that provides TypeScript bindings for the [`temporal-neural-solver`](https://crates.io/crates/temporal-neural-solver) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
- **License**: MIT
- **Rust Crate**: [temporal-neural-solver](https://crates.io/crates/temporal-neural-solver)
...
```bash
npm install @deflex.net/temporal-neural-solver
```

### Using yarn

```bash
yarn add @deflex.net/temporal-neural-solver
```

### Using pnpm

```bash
pnpm add @deflex.net/temporal-neural-solver
```
...
- **Linux x64**: `@deflex.net/temporal-neural-solver-linux-x64-gnu`
- **Linux ARM64**: `@deflex.net/temporal-neural-solver-linux-arm64-gnu`
- **macOS x64**: `@deflex.net/temporal-neural-solver-darwin-x64`
- **macOS ARM64**: `@deflex.net/temporal-neural-solver-darwin-arm64`
- **Windows x64**: `@deflex.net/temporal-neural-solver-win32-x64-msvc`
- **WebAssembly**: `@deflex.net/temporal-neural-solver-wasm32` (fallback)
...
```typescript
import { TemporalNeuralSolver } from '@deflex.net/temporal-neural-solver'

// Create an instance
const client = new TemporalNeuralSolver({
...
```typescript
import { TemporalNeuralSolver, configs } from '@deflex.net/temporal-neural-solver'
...
const client = new TemporalNeuralSolver(configs)
```
...
// Train a model
const model = new TemporalNeuralSolver({
  layers: [64, 128, 64],
  activation: 'relu'
})
...
// CommonJS
const { TemporalNeuralSolver } = require('@deflex.net/temporal-neural-solver')
```
...
try {
  ...
  if (error instanceof TemporalNeuralSolverError) {
...
### Main Class: `TemporalNeuralSolver`
...
Creates a new instance of `TemporalNeuralSolver`.

**Parameters:**
- `configs` (optional): configsuration object

**Returns:**
- Instance of `TemporalNeuralSolver`
...
#### `TemporalNeuralSolverError`

Base error class for all errors thrown by this package.

```typescript
class TemporalNeuralSolverError extends Error {
  code: string
  details?: any
}
```
...
```typescript
import { TemporalNeuralSolver, TemporalNeuralSolverError } from '@deflex.net/temporal-neural-solver'
...
```typescript
import { TemporalNeuralSolver, configs, LogLevel } from '@deflex.net/temporal-neural-solver'
...
cd deflex.net/packages/temporal-neural-solver
...
- **NPM Package**: [@deflex.net/temporal-neural-solver](https://www.npmjs.com/package/@deflex.net/temporal-neural-solver)
- **GitHub Repository**: [flexnetos/deflex.net](https://github.com/flexnetos/deflex.net)
- **Rust Crate**: [temporal-neural-solver](https://crates.io/crates/temporal-neural-solver)
- **Documentation**: [docs.deflex.net/temporal-neural-solver](https://docs.deflex.net/temporal-neural-solver)
...
- Original crate by the [temporal-neural-solver](https://crates.io/crates/temporal-neural-solver) authors

---

## 📊 Stats

![NPM](https://nodei.co/npm/@deflex.net/temporal-neural-solver.png?downloads=true&downloadRank=true&stars=true)
