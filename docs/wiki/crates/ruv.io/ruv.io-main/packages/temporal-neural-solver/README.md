...
```typescript
import { TemporalNeuralSolver, Config } from '@deflex.net/temporal-neural-solver'
...
const client = new TemporalNeuralSolver(config)
```
...
```typescript
import { TemporalNeuralSolver, Config, LogLevel } from '@deflex.net/temporal-neural-solver'
