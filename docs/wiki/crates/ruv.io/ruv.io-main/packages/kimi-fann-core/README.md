# 🧠 @deflex.net/kimi-fann-core

> Optimized micro-expert neural architecture for Kimi-K2 WASM conversion with 5-10x performance improvements

[![npm version](https://img.shields.io/npm/v/@deflex.net/kimi-fann-core.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/kimi-fann-core)
[![npm downloads](https://img.shields.io/npm/dm/@deflex.net/kimi-fann-core.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/kimi-fann-core)
[![license](https://img.shields.io/npm/l/@deflex.net/kimi-fann-core.svg?style=flat-square)](https://github.com/flexnetos/deflex.net/blob/main/LICENSE)
...
`@deflex.net/kimi-fann-core` is a high-performance Node.js native addon that provides TypeScript bindings for the [`kimi-fann-core`](https://crates.io/crates/kimi-fann-core) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
- **License**: MIT
- **Rust Crate**: [kimi-fann-core](https://crates.io/crates/kimi-fann-core)
...
```bash
npm install @deflex.net/kimi-fann-core
```

### Using yarn

```bash
yarn add @deflex.net/kimi-fann-core
```

### Using pnpm

```bash
pnpm add @deflex.net/kimi-fann-core
```
...
- **Linux x64**: `@deflex.net/kimi-fann-core-linux-x64-gnu`
- **Linux ARM64**: `@deflex.net/kimi-fann-core-linux-arm64-gnu`
- **macOS x64**: `@deflex.net/kimi-fann-core-darwin-x64`
- **macOS ARM64**: `@deflex.net/kimi-fann-core-darwin-arm64`
- **Windows x64**: `@deflex.net/kimi-fann-core-win32-x64-msvc`
- **WebAssembly**: `@deflex.net/kimi-fann-core-wasm32` (fallback)
...
```typescript
import { KimiFannCore } from '@deflex.net/kimi-fann-core'
...
```typescript
import { KimiFannCore, configs } from '@deflex.net/kimi-fann-core'
...
const client = new KimiFannCore(configs)
```
...
// CommonJS
const { KimiFannCore } = require('@deflex.net/kimi-fann-core')
```
...
try {
  ...
  if (error instanceof KimiFannCoreError) {
...
Creates a new instance of `KimiFannCore`.

**Parameters:**
- `configs` (optional): configsuration object

**Returns:**
- Instance of `KimiFannCore`
...
```typescript
class KimiFannCoreError extends Error {
  code: string
  details?: any
}
```
...
```typescript
import { KimiFannCore, KimiFannCoreError } from '@deflex.net/kimi-fann-core'
...
```typescript
import { KimiFannCore, configs, LogLevel } from '@deflex.net/kimi-fann-core'
...
cd deflex.net/packages/kimi-fann-core
...
- **NPM Package**: [@deflex.net/kimi-fann-core](https://www.npmjs.com/package/@deflex.net/kimi-fann-core)
- **GitHub Repository**: [flexnetos/deflex.net](https://github.com/flexnetos/deflex.net)
- **Rust Crate**: [kimi-fann-core](https://crates.io/crates/kimi-fann-core)
- **Documentation**: [docs.deflex.net/kimi-fann-core](https://docs.deflex.net/kimi-fann-core)
...
- Original crate by the [kimi-fann-core](https://crates.io/crates/kimi-fann-core) authors

---

## 📊 Stats

![NPM](https://nodei.co/npm/@deflex.net/kimi-fann-core.png?downloads=true&downloadRank=true&stars=true)
