...
```typescript
import { KimiFannCore, Config } from '@deflex.net/kimi-fann-core'
...
const client = new KimiFannCore(config)
```
...
```typescript
import { KimiFannCore, Config, LogLevel } from '@deflex.net/kimi-fann-core'
