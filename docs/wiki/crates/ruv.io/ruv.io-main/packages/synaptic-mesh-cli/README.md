...
```typescript
import { SynapticMeshCli, Config } from '@deflex.net/synaptic-mesh-cli'
...
const client = new SynapticMeshCli(config)
```
...
```typescript
import { SynapticMeshCli, Config, LogLevel } from '@deflex.net/synaptic-mesh-cli'
