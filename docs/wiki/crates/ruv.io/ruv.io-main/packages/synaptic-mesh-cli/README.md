# 📦 @deflex.net/synaptic-mesh-cli

> CLI library for Synaptic Neural Mesh - complete integration with Synaptic Market

[![npm version](https://img.shields.io/npm/v/@deflex.net/synaptic-mesh-cli.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/synaptic-mesh-cli)
[![npm downloads](https://img.shields.io/npm/dm/@deflex.net/synaptic-mesh-cli.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/synaptic-mesh-cli)
[![license](https://img.shields.io/npm/l/@deflex.net/synaptic-mesh-cli.svg?style=flat-square)](https://github.com/flexnetos/deflex.net/blob/main/LICENSE)
...
`@deflex.net/synaptic-mesh-cli` is a high-performance Node.js native addon that provides TypeScript bindings for the [`synaptic-mesh-cli`](https://crates.io/crates/synaptic-mesh-cli) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
- **License**: MIT
- **Rust Crate**: [synaptic-mesh-cli](https://crates.io/crates/synaptic-mesh-cli)
...
```bash
npm install @deflex.net/synaptic-mesh-cli
```

### Using yarn

```bash
yarn add @deflex.net/synaptic-mesh-cli
```

### Using pnpm

```bash
pnpm add @deflex.net/synaptic-mesh-cli
```
...
- **Linux x64**: `@deflex.net/synaptic-mesh-cli-linux-x64-gnu`
- **Linux ARM64**: `@deflex.net/synaptic-mesh-cli-linux-arm64-gnu`
- **macOS x64**: `@deflex.net/synaptic-mesh-cli-darwin-x64`
- **macOS ARM64**: `@deflex.net/synaptic-mesh-cli-darwin-arm64`
- **Windows x64**: `@deflex.net/synaptic-mesh-cli-win32-x64-msvc`
- **WebAssembly**: `@deflex.net/synaptic-mesh-cli-wasm32` (fallback)
...
```typescript
import { SynapticMeshCli } from '@deflex.net/synaptic-mesh-cli'

// Create an instance
const client = new SynapticMeshCli({
...
```typescript
import { SynapticMeshCli, configs } from '@deflex.net/synaptic-mesh-cli'
...
const client = new SynapticMeshCli(configs)
```
...
// CommonJS
const { SynapticMeshCli } = require('@deflex.net/synaptic-mesh-cli')
```
...
try {
  ...
  if (error instanceof SynapticMeshCliError) {
...
Creates a new instance of `SynapticMeshCli`.

**Parameters:**
- `configs` (optional): configsuration object

**Returns:**
- Instance of `SynapticMeshCli`
...
#### `SynapticMeshCliError`

Base error class for all errors thrown by this package.

```typescript
class SynapticMeshCliError extends Error {
  code: string
  details?: any
}
```
...
```typescript
import { SynapticMeshCli, SynapticMeshCliError } from '@deflex.net/synaptic-mesh-cli'
...
```typescript
import { SynapticMeshCli, configs, LogLevel } from '@deflex.net/synaptic-mesh-cli'
...
cd deflex.net/packages/synaptic-mesh-cli
...
- **NPM Package**: [@deflex.net/synaptic-mesh-cli](https://www.npmjs.com/package/@deflex.net/synaptic-mesh-cli)
- **GitHub Repository**: [flexnetos/deflex.net](https://github.com/flexnetos/deflex.net)
- **Rust Crate**: [synaptic-mesh-cli](https://crates.io/crates/synaptic-mesh-cli)
- **Documentation**: [docs.deflex.net/synaptic-mesh-cli](https://docs.deflex.net/synaptic-mesh-cli)
...
- Original crate by the [synaptic-mesh-cli](https://crates.io/crates/synaptic-mesh-cli) authors

---

## 📊 Stats

![NPM](https://nodei.co/npm/@deflex.net/synaptic-mesh-cli.png?downloads=true&downloadRank=true&stars=true)
