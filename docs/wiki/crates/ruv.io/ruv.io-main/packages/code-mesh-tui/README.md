# 🐝 @deflex.net/code-mesh-tui

> Interactive Terminal User Interface for the Code-Mesh distributed swarm intelligence system

[![npm version](https://img.shields.io/npm/v/@deflex.net/code-mesh-tui.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/code-mesh-tui)
[![npm downloads](https://img.shields.io/npm/dm/@deflex.net/code-mesh-tui.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/code-mesh-tui)
[![license](https://img.shields.io/npm/l/@deflex.net/code-mesh-tui.svg?style=flat-square)](https://github.com/flexnetos/deflex.net/blob/main/LICENSE)
...
`@deflex.net/code-mesh-tui` is a high-performance Node.js native addon that provides TypeScript bindings for the [`code-mesh-tui`](https://crates.io/crates/code-mesh-tui) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
- **License**: MIT
- **Rust Crate**: [code-mesh-tui](https://crates.io/crates/code-mesh-tui)
...
```bash
npm install @deflex.net/code-mesh-tui
```

### Using yarn

```bash
yarn add @deflex.net/code-mesh-tui
```

### Using pnpm

```bash
pnpm add @deflex.net/code-mesh-tui
```
...
- **Linux x64**: `@deflex.net/code-mesh-tui-linux-x64-gnu`
- **Linux ARM64**: `@deflex.net/code-mesh-tui-linux-arm64-gnu`
- **macOS x64**: `@deflex.net/code-mesh-tui-darwin-x64`
- **macOS ARM64**: `@deflex.net/code-mesh-tui-darwin-arm64`
- **Windows x64**: `@deflex.net/code-mesh-tui-win32-x64-msvc`
- **WebAssembly**: `@deflex.net/code-mesh-tui-wasm32` (fallback)
...
```typescript
import { CodeMeshTui } from '@deflex.net/code-mesh-tui'

// Create an instance
const client = new CodeMeshTui({
...
```typescript
import { CodeMeshTui, Config } from '@deflex.net/code-mesh-tui'
...
const client = new CodeMeshTui(config)
```
...
// CommonJS
const { CodeMeshTui } = require('@deflex.net/code-mesh-tui')
```
...
try {
  ...
  if (error instanceof CodeMeshTuiError) {
...
Creates a new instance of `CodeMeshTui`.

**Parameters:**
- `config` (optional): Configuration object

**Returns:**
- Instance of `CodeMeshTui`
...
```typescript
class CodeMeshTuiError extends Error {
  code: string
  details?: any
}
```
...
```typescript
import { CodeMeshTui, CodeMeshTuiError } from '@deflex.net/code-mesh-tui'
...
```typescript
import { CodeMeshTui, Config, LogLevel } from '@deflex.net/code-mesh-tui'
...
cd deflex.net/packages/code-mesh-tui
...
- **NPM Package**: [@deflex.net/code-mesh-tui](https://www.npmjs.com/package/@deflex.net/code-mesh-tui)
- **GitHub Repository**: [flexnetos/deflex.net](https://github.com/flexnetos/deflex.net)
- **Rust Crate**: [code-mesh-tui](https://crates.io/crates/code-mesh-tui)
- **Documentation**: [docs.deflex.net/code-mesh-tui](https://docs.deflex.net/code-mesh-tui)
...
- Original crate by the [code-mesh-tui](https://crates.io/crates/code-mesh-tui) authors

---

## 📊 Stats

![NPM](https://nodei.co/npm/@deflex.net/code-mesh-tui.png?downloads=true&downloadRank=true&stars=true)
