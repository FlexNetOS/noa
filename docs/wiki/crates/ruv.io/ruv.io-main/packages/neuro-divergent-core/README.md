# 🧠 @deflex.net/neuro-divergent-core

> Core foundation for neuro-divergent neural forecasting library

[![npm version](https://img.shields.io/npm/v/@deflex.net/neuro-divergent-core.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/neuro-divergent-core)
[![npm downloads](https://img.shields.io/npm/dm/@deflex.net/neuro-divergent-core.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/neuro-divergent-core)
[![license](https://img.shields.io/npm/l/@deflex.net/neuro-divergent-core.svg?style=flat-square)](https://github.com/flexnetos/deflex.net/blob/main/LICENSE)
...
`@deflex.net/neuro-divergent-core` is a high-performance Node.js native addon that provides TypeScript bindings for the [`neuro-divergent-core`](https://crates.io/crates/neuro-divergent-core) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
- **License**: MIT
- **Rust Crate**: [neuro-divergent-core](https://crates.io/crates/neuro-divergent-core)
...
```bash
npm install @deflex.net/neuro-divergent-core
```

### Using yarn

```bash
yarn add @deflex.net/neuro-divergent-core
```

### Using pnpm

```bash
pnpm add @deflex.net/neuro-divergent-core
```
...
- **Linux x64**: `@deflex.net/neuro-divergent-core-linux-x64-gnu`
- **Linux ARM64**: `@deflex.net/neuro-divergent-core-linux-arm64-gnu`
- **macOS x64**: `@deflex.net/neuro-divergent-core-darwin-x64`
- **macOS ARM64**: `@deflex.net/neuro-divergent-core-darwin-arm64`
- **Windows x64**: `@deflex.net/neuro-divergent-core-win32-x64-msvc`
- **WebAssembly**: `@deflex.net/neuro-divergent-core-wasm32` (fallback)
...
```typescript
import { NeuroDivergentCore } from '@deflex.net/neuro-divergent-core'

// Create an instance
const client = new NeuroDivergentCore({
...
```typescript
import { NeuroDivergentCore, Config } from '@deflex.net/neuro-divergent-core'
...
const client = new NeuroDivergentCore(config)
```
...
// Train a model
const model = new NeuroDivergentCore({
  layers: [64, 128, 64],
  activation: 'relu'
})
...
// CommonJS
const { NeuroDivergentCore } = require('@deflex.net/neuro-divergent-core')
```
...
try {
  ...
  if (error instanceof NeuroDivergentCoreError) {
...
Creates a new instance of `NeuroDivergentCore`.

**Parameters:**
- `config` (optional): Configuration object

**Returns:**
- Instance of `NeuroDivergentCore`
...
#### `NeuroDivergentCoreError`

Base error class for all errors thrown by this package.

```typescript
class NeuroDivergentCoreError extends Error {
  code: string
  details?: any
}
```
...
```typescript
import { NeuroDivergentCore, NeuroDivergentCoreError } from '@deflex.net/neuro-divergent-core'
...
```typescript
import { NeuroDivergentCore, Config, LogLevel } from '@deflex.net/neuro-divergent-core'
...
cd deflex.net/packages/neuro-divergent-core
...
- **NPM Package**: [@deflex.net/neuro-divergent-core](https://www.npmjs.com/package/@deflex.net/neuro-divergent-core)
- **GitHub Repository**: [flexnetos/deflex.net](https://github.com/flexnetos/deflex.net)
- **Rust Crate**: [neuro-divergent-core](https://crates.io/crates/neuro-divergent-core)
- **Documentation**: [docs.deflex.net/neuro-divergent-core](https://docs.deflex.net/neuro-divergent-core)
...
- Original crate by the [neuro-divergent-core](https://crates.io/crates/neuro-divergent-core) authors

---

## 📊 Stats

![NPM](https://nodei.co/npm/@deflex.net/neuro-divergent-core.png?downloads=true&downloadRank=true&stars=true)
