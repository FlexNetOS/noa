# 🌐 @deflex.net/claude_market

> P2P marketplace for trading Claude API tokens with escrow and reputation

[![npm version](https://img.shields.io/npm/v/@deflex.net/claude_market.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/claude_market)
[![npm downloads](https://img.shields.io/npm/dm/@deflex.net/claude_market.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/claude_market)
[![license](https://img.shields.io/npm/l/@deflex.net/claude_market.svg?style=flat-square)](https://github.com/flexnetos/deflex.net/blob/main/LICENSE)
...
`@deflex.net/claude_market` is a high-performance Node.js native addon that provides TypeScript bindings for the [`claude_market`](https://crates.io/crates/claude_market) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.

**Key Information:**
- **Version**: 0.1.1
- **Downloads**: 540+
- **Categories**: Blockchain Crypto, Networking
- **License**: MIT
- **Rust Crate**: [claude_market](https://crates.io/crates/claude_market)
...
```bash
npm install @deflex.net/claude_market
```

### Using yarn

```bash
yarn add @deflex.net/claude_market
```

### Using pnpm

```bash
pnpm add @deflex.net/claude_market
```
...
- **Linux x64**: `@deflex.net/claude_market-linux-x64-gnu`
- **Linux ARM64**: `@deflex.net/claude_market-linux-arm64-gnu`
- **macOS x64**: `@deflex.net/claude_market-darwin-x64`
- **macOS ARM64**: `@deflex.net/claude_market-darwin-arm64`
- **Windows x64**: `@deflex.net/claude_market-win32-x64-msvc`
- **WebAssembly**: `@deflex.net/claude_market-wasm32` (fallback)
...
```typescript
import { Claude_market } from '@deflex.net/claude_market'

// Create an instance
const client = new Claude_market({
...
```typescript
import { Claude_market, Config } from '@deflex.net/claude_market'
...
const client = new Claude_market(config)
```
...
// CommonJS
const { Claude_market } = require('@deflex.net/claude_market')
```
...
try {
  ...
  if (error instanceof Claude_marketError) {
...
Creates a new instance of `Claude_market`.

**Parameters:**
- `config` (optional): Configuration object

**Returns:**
- Instance of `Claude_market`
...
```typescript
class Claude_marketError extends Error {
  code: string
  details?: any
}
```
...
```typescript
import { Claude_market, Claude_marketError } from '@deflex.net/claude_market'
...
```typescript
import { Claude_market, Config, LogLevel } from '@deflex.net/claude_market'
...
cd deflex.net/packages/claude_market
...
- **NPM Package**: [@deflex.net/claude_market](https://www.npmjs.com/package/@deflex.net/claude_market)
- **GitHub Repository**: [flexnetos/deflex.net](https://github.com/flexnetos/deflex.net)
- **Rust Crate**: [claude_market](https://crates.io/crates/claude_market)
- **Documentation**: [docs.deflex.net/claude_market](https://docs.deflex.net/claude_market)
...
- Original crate by the [claude_market](https://crates.io/crates/claude_market) authors

---

## 📊 Stats

![NPM](https://nodei.co/npm/@deflex.net/claude_market.png?downloads=true&downloadRank=true&stars=true)
