# 📦 @deflex.net/agentic-payments

> Autonomous multi-agent Ed25519 signature verification with Byzantine fault tolerance

[![npm version](https://img.shields.io/npm/v/@deflex.net/agentic-payments.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/agentic-payments)
[![npm downloads](https://img.shields.io/npm/dm/@deflex.net/agentic-payments.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/agentic-payments)
[![license](https://img.shields.io/npm/l/@deflex.net/agentic-payments.svg?style=flat-square)](https://github.com/flexnetos/deflex.net/blob/main/LICENSE)
...
`@deflex.net/agentic-payments` is a high-performance Node.js native addon that provides TypeScript bindings for the [`agentic-payments`](https://crates.io/crates/agentic-payments) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
- **License**: MIT
- **Rust Crate**: [agentic-payments](https://crates.io/crates/agentic-payments)
...
```bash
npm install @deflex.net/agentic-payments
```

### Using yarn

```bash
yarn add @deflex.net/agentic-payments
```

### Using pnpm

```bash
pnpm add @deflex.net/agentic-payments
```
...
- **Linux x64**: `@deflex.net/agentic-payments-linux-x64-gnu`
- **Linux ARM64**: `@deflex.net/agentic-payments-linux-arm64-gnu`
- **macOS x64**: `@deflex.net/agentic-payments-darwin-x64`
- **macOS ARM64**: `@deflex.net/agentic-payments-darwin-arm64`
- **Windows x64**: `@deflex.net/agentic-payments-win32-x64-msvc`
- **WebAssembly**: `@deflex.net/agentic-payments-wasm32` (fallback)
...
```typescript
import { AgenticPayments } from '@deflex.net/agentic-payments'
...
```typescript
import { AgenticPayments, Config } from '@deflex.net/agentic-payments'
...
const client = new AgenticPayments(config)
```
...
// CommonJS
const { AgenticPayments } = require('@deflex.net/agentic-payments')
```
...
try {
  ...
  if (error instanceof AgenticPaymentsError) {
...
Creates a new instance of `AgenticPayments`.

**Parameters:**
- `config` (optional): Configuration object

**Returns:**
- Instance of `AgenticPayments`
...
#### `AgenticPaymentsError`

Base error class for all errors thrown by this package.

```typescript
class AgenticPaymentsError extends Error {
  code: string
  details?: any
}
```
...
```typescript
import { AgenticPayments, AgenticPaymentsError } from '@deflex.net/agentic-payments'
...
```typescript
import { AgenticPayments, Config, LogLevel } from '@deflex.net/agentic-payments'
...
cd deflex.net/packages/agentic-payments
...
- **NPM Package**: [@deflex.net/agentic-payments](https://www.npmjs.com/package/@deflex.net/agentic-payments)
- **GitHub Repository**: [flexnetos/deflex.net](https://github.com/flexnetos/deflex.net)
- **Rust Crate**: [agentic-payments](https://crates.io/crates/agentic-payments)
- **Documentation**: [docs.deflex.net/agentic-payments](https://docs.deflex.net/agentic-payments)
...
- Original crate by the [agentic-payments](https://crates.io/crates/agentic-payments) authors

---

## 📊 Stats

![NPM](https://nodei.co/npm/@deflex.net/agentic-payments.png?downloads=true&downloadRank=true&stars=true)
