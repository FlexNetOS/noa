# 👁️ @deflex.net/opencv-sdk

> OpenCV SDK with C/C++/Python API compatibility layer

[![npm version](https://img.shields.io/npm/v/@deflex.net/opencv-sdk.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/opencv-sdk)
[![npm downloads](https://img.shields.io/npm/dm/@deflex.net/opencv-sdk.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/opencv-sdk)
[![license](https://img.shields.io/npm/l/@deflex.net/opencv-sdk.svg?style=flat-square)](https://github.com/flexnetos/deflex.net/blob/main/LICENSE)
...
`@deflex.net/opencv-sdk` is a high-performance Node.js native addon that provides TypeScript bindings for the [`opencv-sdk`](https://crates.io/crates/opencv-sdk) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
```bash
npm install @deflex.net/opencv-sdk
```

### Using yarn

```bash
yarn add @deflex.net/opencv-sdk
```

### Using pnpm

```bash
pnpm add @deflex.net/opencv-sdk
```
...
- **Linux x64**: `@deflex.net/opencv-sdk-linux-x64-gnu`
- **Linux ARM64**: `@deflex.net/opencv-sdk-linux-arm64-gnu`
- **macOS x64**: `@deflex.net/opencv-sdk-darwin-x64`
- **macOS ARM64**: `@deflex.net/opencv-sdk-darwin-arm64`
- **Windows x64**: `@deflex.net/opencv-sdk-win32-x64-msvc`
- **WebAssembly**: `@deflex.net/opencv-sdk-wasm32` (fallback)
...
```typescript
import { OpencvSdk } from '@deflex.net/opencv-sdk'
...
```typescript
import { OpencvSdk, Config } from '@deflex.net/opencv-sdk'
...
// CommonJS
const { OpencvSdk } = require('@deflex.net/opencv-sdk')
```
...
try {
  ...
  if (error instanceof OpencvSdkError) {
...
Creates a new instance of `OpencvSdk`.

**Parameters:**
- `config` (optional): Configuration object

**Returns:**
- Instance of `OpencvSdk`
...
```typescript
class OpencvSdkError extends Error {
  code: string
  details?: any
}
```
...
```typescript
import { OpencvSdk, OpencvSdkError } from '@deflex.net/opencv-sdk'
...
```typescript
import { OpencvSdk, Config, LogLevel } from '@deflex.net/opencv-sdk'
...
cd deflex.net/packages/opencv-sdk
...
- **NPM Package**: [@deflex.net/opencv-sdk](https://www.npmjs.com/package/@deflex.net/opencv-sdk)
- **GitHub Repository**: [flexnetos/deflex.net](https://github.com/flexnetos/deflex.net)
- **Rust Crate**: [opencv-sdk](https://crates.io/crates/opencv-sdk)
- **Documentation**: [docs.deflex.net/opencv-sdk](https://docs.deflex.net/opencv-sdk)
...
- Original crate by the [opencv-sdk](https://crates.io/crates/opencv-sdk) authors

---

## 📊 Stats

![NPM](https://nodei.co/npm/@deflex.net/opencv-sdk.png?downloads=true&downloadRank=true&stars=true)
