# ⏰ @deflex.net/temporal-compare

> High-performance framework for benchmarking temporal prediction algorithms inspired by Time-R1

[![npm version](https://img.shields.io/npm/v/@deflex.net/temporal-compare.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/temporal-compare)
[![npm downloads](https://img.shields.io/npm/dm/@deflex.net/temporal-compare.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/temporal-compare)
[![license](https://img.shields.io/npm/l/@deflex.net/temporal-compare.svg?style=flat-square)](https://github.com/flexnetos/deflex.net/blob/main/LICENSE)
...
`@deflex.net/temporal-compare` is a high-performance Node.js native addon that provides TypeScript bindings for the [`temporal-compare`](https://crates.io/crates/temporal-compare) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
- **License**: MIT
- **Rust Crate**: [temporal-compare](https://crates.io/crates/temporal-compare)
...
```bash
npm install @deflex.net/temporal-compare
```

### Using yarn

```bash
yarn add @deflex.net/temporal-compare
```

### Using pnpm

```bash
pnpm add @deflex.net/temporal-compare
```
...
- **Linux x64**: `@deflex.net/temporal-compare-linux-x64-gnu`
- **Linux ARM64**: `@deflex.net/temporal-compare-linux-arm64-gnu`
- **macOS x64**: `@deflex.net/temporal-compare-darwin-x64`
- **macOS ARM64**: `@deflex.net/temporal-compare-darwin-arm64`
- **Windows x64**: `@deflex.net/temporal-compare-win32-x64-msvc`
- **WebAssembly**: `@deflex.net/temporal-compare-wasm32` (fallback)
...
```typescript
import { TemporalCompare } from '@deflex.net/temporal-compare'

// Create an instance
const client = new TemporalCompare({
...
```typescript
import { TemporalCompare, configs } from '@deflex.net/temporal-compare'
...
const client = new TemporalCompare(configs)
```
...
// CommonJS
const { TemporalCompare } = require('@deflex.net/temporal-compare')
```
...
try {
  ...
  if (error instanceof TemporalCompareError) {
...
Creates a new instance of `TemporalCompare`.

**Parameters:**
- `configs` (optional): configsuration object

**Returns:**
- Instance of `TemporalCompare`
...
#### `TemporalCompareError`

Base error class for all errors thrown by this package.

```typescript
class TemporalCompareError extends Error {
  code: string
  details?: any
}
```
...
```typescript
import { TemporalCompare, TemporalCompareError } from '@deflex.net/temporal-compare'
...
```typescript
import { TemporalCompare, configs, LogLevel } from '@deflex.net/temporal-compare'
...
cd deflex.net/packages/temporal-compare
...
- **NPM Package**: [@deflex.net/temporal-compare](https://www.npmjs.com/package/@deflex.net/temporal-compare)
- **GitHub Repository**: [flexnetos/deflex.net](https://github.com/flexnetos/deflex.net)
- **Rust Crate**: [temporal-compare](https://crates.io/crates/temporal-compare)
- **Documentation**: [docs.deflex.net/temporal-compare](https://docs.deflex.net/temporal-compare)
...
- Original crate by the [temporal-compare](https://crates.io/crates/temporal-compare) authors

---

## 📊 Stats

![NPM](https://nodei.co/npm/@deflex.net/temporal-compare.png?downloads=true&downloadRank=true&stars=true)
