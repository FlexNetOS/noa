...
```typescript
import { TemporalCompare, Config } from '@deflex.net/temporal-compare'
...
const client = new TemporalCompare(config)
```
...
```typescript
import { TemporalCompare, Config, LogLevel } from '@deflex.net/temporal-compare'
