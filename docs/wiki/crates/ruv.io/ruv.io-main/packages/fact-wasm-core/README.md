# 🛠️ @deflex.net/fact-wasm-core

> FACT WASM Core - High-performance WebAssembly cognitive processing engine with advanced caching and template optimization

[![npm version](https://img.shields.io/npm/v/@deflex.net/fact-wasm-core.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/fact-wasm-core)
[![npm downloads](https://img.shields.io/npm/dm/@deflex.net/fact-wasm-core.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/fact-wasm-core)
[![license](https://img.shields.io/npm/l/@deflex.net/fact-wasm-core.svg?style=flat-square)](https://github.com/flexnetos/deflex.net/blob/main/LICENSE)
...
`@deflex.net/fact-wasm-core` is a high-performance Node.js native addon that provides TypeScript bindings for the [`fact-wasm-core`](https://crates.io/crates/fact-wasm-core) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.

**Key Information:**
- **Version**: 1.0.0
- **Downloads**: 406+
- **Categories**: Wasm Bindings, Dev Tools
- **License**: MIT
- **Rust Crate**: [fact-wasm-core](https://crates.io/crates/fact-wasm-core)
...
```bash
npm install @deflex.net/fact-wasm-core
```

### Using yarn

```bash
yarn add @deflex.net/fact-wasm-core
```

### Using pnpm

```bash
pnpm add @deflex.net/fact-wasm-core
```
...
- **Linux x64**: `@deflex.net/fact-wasm-core-linux-x64-gnu`
- **Linux ARM64**: `@deflex.net/fact-wasm-core-linux-arm64-gnu`
- **macOS x64**: `@deflex.net/fact-wasm-core-darwin-x64`
- **macOS ARM64**: `@deflex.net/fact-wasm-core-darwin-arm64`
- **Windows x64**: `@deflex.net/fact-wasm-core-win32-x64-msvc`
- **WebAssembly**: `@deflex.net/fact-wasm-core-wasm32` (fallback)
...
```typescript
import { FactWasmCore } from '@deflex.net/fact-wasm-core'

// Create an instance
const client = new FactWasmCore({
...
```typescript
import { FactWasmCore, Config } from '@deflex.net/fact-wasm-core'
...
const client = new FactWasmCore(config)
```
...
// CommonJS
const { FactWasmCore } = require('@deflex.net/fact-wasm-core')
```
...
try {
  ...
  if (error instanceof FactWasmCoreError) {
...
Creates a new instance of `FactWasmCore`.

**Parameters:**
- `config` (optional): Configuration object

**Returns:**
- Instance of `FactWasmCore`
...
```typescript
class FactWasmCoreError extends Error {
  code: string
  details?: any
}
```
...
```typescript
import { FactWasmCore, FactWasmCoreError } from '@deflex.net/fact-wasm-core'
...
```typescript
import { FactWasmCore, Config, LogLevel } from '@deflex.net/fact-wasm-core'
...
cd deflex.net/packages/fact-wasm-core
...
- **NPM Package**: [@deflex.net/fact-wasm-core](https://www.npmjs.com/package/@deflex.net/fact-wasm-core)
- **GitHub Repository**: [flexnetos/deflex.net](https://github.com/flexnetos/deflex.net)
- **Rust Crate**: [fact-wasm-core](https://crates.io/crates/fact-wasm-core)
- **Documentation**: [docs.deflex.net/fact-wasm-core](https://docs.deflex.net/fact-wasm-core)
...
- Original crate by the [fact-wasm-core](https://crates.io/crates/fact-wasm-core) authors

---

## 📊 Stats

![NPM](https://nodei.co/npm/@deflex.net/fact-wasm-core.png?downloads=true&downloadRank=true&stars=true)
