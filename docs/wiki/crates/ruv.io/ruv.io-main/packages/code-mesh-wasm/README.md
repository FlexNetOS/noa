# 🐝 @deflex.net/code-mesh-wasm

> WebAssembly bindings for the Code-Mesh distributed swarm intelligence system

[![npm version](https://img.shields.io/npm/v/@deflex.net/code-mesh-wasm.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/code-mesh-wasm)
[![npm downloads](https://img.shields.io/npm/dm/@deflex.net/code-mesh-wasm.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/code-mesh-wasm)
[![license](https://img.shields.io/npm/l/@deflex.net/code-mesh-wasm.svg?style=flat-square)](https://github.com/flexnetos/deflex.net/blob/main/LICENSE)
...
`@deflex.net/code-mesh-wasm` is a high-performance Node.js native addon that provides TypeScript bindings for the [`code-mesh-wasm`](https://crates.io/crates/code-mesh-wasm) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
- **License**: MIT
- **Rust Crate**: [code-mesh-wasm](https://crates.io/crates/code-mesh-wasm)
...
```bash
npm install @deflex.net/code-mesh-wasm
```

### Using yarn

```bash
yarn add @deflex.net/code-mesh-wasm
```

### Using pnpm

```bash
pnpm add @deflex.net/code-mesh-wasm
```
...
- **Linux x64**: `@deflex.net/code-mesh-wasm-linux-x64-gnu`
- **Linux ARM64**: `@deflex.net/code-mesh-wasm-linux-arm64-gnu`
- **macOS x64**: `@deflex.net/code-mesh-wasm-darwin-x64`
- **macOS ARM64**: `@deflex.net/code-mesh-wasm-darwin-arm64`
- **Windows x64**: `@deflex.net/code-mesh-wasm-win32-x64-msvc`
- **WebAssembly**: `@deflex.net/code-mesh-wasm-wasm32` (fallback)
...
```typescript
import { CodeMeshWasm } from '@deflex.net/code-mesh-wasm'

// Create an instance
const client = new CodeMeshWasm({
...
```typescript
import { CodeMeshWasm, Config } from '@deflex.net/code-mesh-wasm'
...
const client = new CodeMeshWasm(config)
```
...
// CommonJS
const { CodeMeshWasm } = require('@deflex.net/code-mesh-wasm')
```
...
try {
  ...
  if (error instanceof CodeMeshWasmError) {
...
Creates a new instance of `CodeMeshWasm`.

**Parameters:**
- `config` (optional): Configuration object

**Returns:**
- Instance of `CodeMeshWasm`
...
```typescript
class CodeMeshWasmError extends Error {
  code: string
  details?: any
}
```
...
```typescript
import { CodeMeshWasm, CodeMeshWasmError } from '@deflex.net/code-mesh-wasm'
...
```typescript
import { CodeMeshWasm, Config, LogLevel } from '@deflex.net/code-mesh-wasm'
...
cd deflex.net/packages/code-mesh-wasm
...
- **NPM Package**: [@deflex.net/code-mesh-wasm](https://www.npmjs.com/package/@deflex.net/code-mesh-wasm)
- **GitHub Repository**: [flexnetos/deflex.net](https://github.com/flexnetos/deflex.net)
- **Rust Crate**: [code-mesh-wasm](https://crates.io/crates/code-mesh-wasm)
- **Documentation**: [docs.deflex.net/code-mesh-wasm](https://docs.deflex.net/code-mesh-wasm)
...
- Original crate by the [code-mesh-wasm](https://crates.io/crates/code-mesh-wasm) authors

---

## 📊 Stats

![NPM](https://nodei.co/npm/@deflex.net/code-mesh-wasm.png?downloads=true&downloadRank=true&stars=true)
