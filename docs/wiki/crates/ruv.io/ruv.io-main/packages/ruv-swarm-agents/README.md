# 🐝 @deflex.net/ruv-swarm-agents

> Specialized AI agents for RUV Swarm

[![npm version](https://img.shields.io/npm/v/@deflex.net/ruv-swarm-agents.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/ruv-swarm-agents)
[![npm downloads](https://img.shields.io/npm/dm/@deflex.net/ruv-swarm-agents.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/ruv-swarm-agents)
[![license](https://img.shields.io/npm/l/@deflex.net/ruv-swarm-agents.svg?style=flat-square)](https://github.com/flexnetos/deflex.net/blob/main/LICENSE)
...
`@deflex.net/ruv-swarm-agents` is a high-performance Node.js native addon that provides TypeScript bindings for the [`ruv-swarm-agents`](https://crates.io/crates/ruv-swarm-agents) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
```bash
npm install @deflex.net/ruv-swarm-agents
```

### Using yarn

```bash
yarn add @deflex.net/ruv-swarm-agents
```

### Using pnpm

```bash
pnpm add @deflex.net/ruv-swarm-agents
```
...
- **Linux x64**: `@deflex.net/ruv-swarm-agents-linux-x64-gnu`
- **Linux ARM64**: `@deflex.net/ruv-swarm-agents-linux-arm64-gnu`
- **macOS x64**: `@deflex.net/ruv-swarm-agents-darwin-x64`
- **macOS ARM64**: `@deflex.net/ruv-swarm-agents-darwin-arm64`
- **Windows x64**: `@deflex.net/ruv-swarm-agents-win32-x64-msvc`
- **WebAssembly**: `@deflex.net/ruv-swarm-agents-wasm32` (fallback)
...
```typescript
import { RuvSwarmAgents } from '@deflex.net/ruv-swarm-agents'
...
```typescript
import { RuvSwarmAgents, Config } from '@deflex.net/ruv-swarm-agents'
...
// CommonJS
const { RuvSwarmAgents } = require('@deflex.net/ruv-swarm-agents')
```
...
```typescript
import { RuvSwarmAgents, RuvSwarmAgentsError } from '@deflex.net/ruv-swarm-agents'
...
```typescript
import { RuvSwarmAgents, Config, LogLevel } from '@deflex.net/ruv-swarm-agents'
...
cd deflex.net/packages/ruv-swarm-agents
...
- **NPM Package**: [@deflex.net/ruv-swarm-agents](https://www.npmjs.com/package/@deflex.net/ruv-swarm-agents)
- **GitHub Repository**: [flexnetos/deflex.net](https://github.com/flexnetos/deflex.net)
- **Rust Crate**: [ruv-swarm-agents](https://crates.io/crates/ruv-swarm-agents)
- **Documentation**: [docs.deflex.net/ruv-swarm-agents](https://docs.deflex.net/ruv-swarm-agents)
...
![NPM](https://nodei.co/npm/@deflex.net/ruv-swarm-agents.png?downloads=true&downloadRank=true&stars=true)
