...
```typescript
import { RuvSwarmWasm, Config } from '@deflex.net/ruv-swarm-wasm'
...
const client = new RuvSwarmWasm(config)
```
...
```typescript
import { RuvSwarmWasm, Config, LogLevel } from '@deflex.net/ruv-swarm-wasm'
