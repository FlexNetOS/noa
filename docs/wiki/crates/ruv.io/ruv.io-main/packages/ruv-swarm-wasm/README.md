# 🐝 @deflex.net/ruv-swarm-wasm

> WebAssembly bindings for ruv-swarm neural network orchestration

[![npm version](https://img.shields.io/npm/v/@deflex.net/ruv-swarm-wasm.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/ruv-swarm-wasm)
[![npm downloads](https://img.shields.io/npm/dm/@deflex.net/ruv-swarm-wasm.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/ruv-swarm-wasm)
[![license](https://img.shields.io/npm/l/@deflex.net/ruv-swarm-wasm.svg?style=flat-square)](https://github.com/flexnetos/deflex.net/blob/main/LICENSE)
...
`@deflex.net/ruv-swarm-wasm` is a high-performance Node.js native addon that provides TypeScript bindings for the [`ruv-swarm-wasm`](https://crates.io/crates/ruv-swarm-wasm) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.

**Key Information:**
- **Version**: 1.0.5
- **Downloads**: 1,217+
- **Categories**: Swarm Orchestration, Wasm Bindings
- **License**: MIT
- **Rust Crate**: [ruv-swarm-wasm](https://crates.io/crates/ruv-swarm-wasm)
...
```bash
npm install @deflex.net/ruv-swarm-wasm
```

### Using yarn

```bash
yarn add @deflex.net/ruv-swarm-wasm
```

### Using pnpm

```bash
pnpm add @deflex.net/ruv-swarm-wasm
```
...
- **Linux x64**: `@deflex.net/ruv-swarm-wasm-linux-x64-gnu`
- **Linux ARM64**: `@deflex.net/ruv-swarm-wasm-linux-arm64-gnu`
- **macOS x64**: `@deflex.net/ruv-swarm-wasm-darwin-x64`
- **macOS ARM64**: `@deflex.net/ruv-swarm-wasm-darwin-arm64`
- **Windows x64**: `@deflex.net/ruv-swarm-wasm-win32-x64-msvc`
- **WebAssembly**: `@deflex.net/ruv-swarm-wasm-wasm32` (fallback)
...
```typescript
import { RuvSwarmWasm } from '@deflex.net/ruv-swarm-wasm'

// Create an instance
const client = new RuvSwarmWasm({
...
```typescript
import { RuvSwarmWasm, configs } from '@deflex.net/ruv-swarm-wasm'
...
const client = new RuvSwarmWasm(configs)
```
...
// CommonJS
const { RuvSwarmWasm } = require('@deflex.net/ruv-swarm-wasm')
```
...
try {
  ...
  if (error instanceof RuvSwarmWasmError) {
...
Creates a new instance of `RuvSwarmWasm`.

**Parameters:**
- `configs` (optional): configsuration object

**Returns:**
- Instance of `RuvSwarmWasm`
...
```typescript
class RuvSwarmWasmError extends Error {
  code: string
  details?: any
}
```
...
```typescript
import { RuvSwarmWasm, RuvSwarmWasmError } from '@deflex.net/ruv-swarm-wasm'
...
```typescript
import { RuvSwarmWasm, configs, LogLevel } from '@deflex.net/ruv-swarm-wasm'
...
cd deflex.net/packages/ruv-swarm-wasm
...
- **NPM Package**: [@deflex.net/ruv-swarm-wasm](https://www.npmjs.com/package/@deflex.net/ruv-swarm-wasm)
- **GitHub Repository**: [flexnetos/deflex.net](https://github.com/flexnetos/deflex.net)
- **Rust Crate**: [ruv-swarm-wasm](https://crates.io/crates/ruv-swarm-wasm)
- **Documentation**: [docs.deflex.net/ruv-swarm-wasm](https://docs.deflex.net/ruv-swarm-wasm)
...
- Original crate by the [ruv-swarm-wasm](https://crates.io/crates/ruv-swarm-wasm) authors

---

## 📊 Stats

![NPM](https://nodei.co/npm/@deflex.net/ruv-swarm-wasm.png?downloads=true&downloadRank=true&stars=true)
