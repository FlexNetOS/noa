# 🧠 @deflex.net/nt-neural

> Neural network integration for Neural Trader - LSTM, transformers, and deep learning models with Candle

[![npm version](https://img.shields.io/npm/v/@deflex.net/nt-neural.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/nt-neural)
[![npm downloads](https://img.shields.io/npm/dm/@deflex.net/nt-neural.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/nt-neural)
[![license](https://img.shields.io/npm/l/@deflex.net/nt-neural.svg?style=flat-square)](https://github.com/flexnetos/deflex.net/blob/main/LICENSE)
...
`@deflex.net/nt-neural` is a high-performance Node.js native addon that provides TypeScript bindings for the [`nt-neural`](https://crates.io/crates/nt-neural) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.

**Key Information:**
- **Version**: 1.0.0
- **Downloads**: 0+
- **Categories**: Neural Networks, Trading Finance
- **License**: MIT
- **Rust Crate**: [nt-neural](https://crates.io/crates/nt-neural)
...
```bash
npm install @deflex.net/nt-neural
```

### Using yarn

```bash
yarn add @deflex.net/nt-neural
```

### Using pnpm

```bash
pnpm add @deflex.net/nt-neural
```
...
- **Linux x64**: `@deflex.net/nt-neural-linux-x64-gnu`
- **Linux ARM64**: `@deflex.net/nt-neural-linux-arm64-gnu`
- **macOS x64**: `@deflex.net/nt-neural-darwin-x64`
- **macOS ARM64**: `@deflex.net/nt-neural-darwin-arm64`
- **Windows x64**: `@deflex.net/nt-neural-win32-x64-msvc`
- **WebAssembly**: `@deflex.net/nt-neural-wasm32` (fallback)
...
```typescript
import { NtNeural } from '@deflex.net/nt-neural'

// Create an instance
const client = new NtNeural({
...
```typescript
import { NtNeural, Config } from '@deflex.net/nt-neural'
...
const client = new NtNeural(config)
```
...
// CommonJS
const { NtNeural } = require('@deflex.net/nt-neural')
```
...
try {
  ...
  if (error instanceof NtNeuralError) {
...
Creates a new instance of `NtNeural`.

**Parameters:**
- `config` (optional): Configuration object

**Returns:**
- Instance of `NtNeural`
...
```typescript
class NtNeuralError extends Error {
  code: string
  details?: any
}
```
...
```typescript
import { NtNeural, NtNeuralError } from '@deflex.net/nt-neural'
...
```typescript
import { NtNeural, Config, LogLevel } from '@deflex.net/nt-neural'
...
cd deflex.net/packages/nt-neural
...
- **NPM Package**: [@deflex.net/nt-neural](https://www.npmjs.com/package/@deflex.net/nt-neural)
- **GitHub Repository**: [flexnetos/deflex.net](https://github.com/flexnetos/deflex.net)
- **Rust Crate**: [nt-neural](https://crates.io/crates/nt-neural)
- **Documentation**: [docs.deflex.net/nt-neural](https://docs.deflex.net/nt-neural)
...
- Original crate by the [nt-neural](https://crates.io/crates/nt-neural) authors

---

## 📊 Stats

![NPM](https://nodei.co/npm/@deflex.net/nt-neural.png?downloads=true&downloadRank=true&stars=true)
