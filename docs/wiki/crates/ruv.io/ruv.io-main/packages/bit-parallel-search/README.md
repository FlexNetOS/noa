# 🛠️ @deflex.net/bit-parallel-search

> Blazing fast string search using bit-parallel algorithms - up to 8x faster than naive search

[![npm version](https://img.shields.io/npm/v/@deflex.net/bit-parallel-search.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/bit-parallel-search)
[![npm downloads](https://img.shields.io/npm/dm/@deflex.net/bit-parallel-search.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/bit-parallel-search)
[![license](https://img.shields.io/npm/l/@deflex.net/bit-parallel-search.svg?style=flat-square)](https://github.com/flexnetos/deflex.net/blob/main/LICENSE)
...
`@deflex.net/bit-parallel-search` is a high-performance Node.js native addon that provides TypeScript bindings for the [`bit-parallel-search`](https://crates.io/crates/bit-parallel-search) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
- **License**: MIT
- **Rust Crate**: [bit-parallel-search](https://crates.io/crates/bit-parallel-search)
...
```bash
npm install @deflex.net/bit-parallel-search
```

### Using yarn

```bash
yarn add @deflex.net/bit-parallel-search
```

### Using pnpm

```bash
pnpm add @deflex.net/bit-parallel-search
```
...
- **Linux x64**: `@deflex.net/bit-parallel-search-linux-x64-gnu`
- **Linux ARM64**: `@deflex.net/bit-parallel-search-linux-arm64-gnu`
- **macOS x64**: `@deflex.net/bit-parallel-search-darwin-x64`
- **macOS ARM64**: `@deflex.net/bit-parallel-search-darwin-arm64`
- **Windows x64**: `@deflex.net/bit-parallel-search-win32-x64-msvc`
- **WebAssembly**: `@deflex.net/bit-parallel-search-wasm32` (fallback)
...
```typescript
import { BitParallelSearch } from '@deflex.net/bit-parallel-search'

// Create an instance
const client = new BitParallelSearch({
...
```typescript
import { BitParallelSearch, Config } from '@deflex.net/bit-parallel-search'
...
const client = new BitParallelSearch(config)
```
...
// CommonJS
const { BitParallelSearch } = require('@deflex.net/bit-parallel-search')
```
...
try {
  ...
  if (error instanceof BitParallelSearchError) {
...
Creates a new instance of `BitParallelSearch`.

**Parameters:**
- `config` (optional): Configuration object

**Returns:**
- Instance of `BitParallelSearch`
...
#### `BitParallelSearchError`

Base error class for all errors thrown by this package.

```typescript
class BitParallelSearchError extends Error {
  code: string
  details?: any
}
```
...
```typescript
import { BitParallelSearch, BitParallelSearchError } from '@deflex.net/bit-parallel-search'
...
```typescript
import { BitParallelSearch, Config, LogLevel } from '@deflex.net/bit-parallel-search'
...
cd deflex.net/packages/bit-parallel-search
...
- **NPM Package**: [@deflex.net/bit-parallel-search](https://www.npmjs.com/package/@deflex.net/bit-parallel-search)
- **GitHub Repository**: [flexnetos/deflex.net](https://github.com/flexnetos/deflex.net)
- **Rust Crate**: [bit-parallel-search](https://crates.io/crates/bit-parallel-search)
- **Documentation**: [docs.deflex.net/bit-parallel-search](https://docs.deflex.net/bit-parallel-search)
...
- Original crate by the [bit-parallel-search](https://crates.io/crates/bit-parallel-search) authors

---

## 📊 Stats

![NPM](https://nodei.co/npm/@deflex.net/bit-parallel-search.png?downloads=true&downloadRank=true&stars=true)
