# 🐝 @deflex.net/ruv-swarm-core

> Core orchestration and agent traits for RUV Swarm

[![npm version](https://img.shields.io/npm/v/@deflex.net/ruv-swarm-core.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/ruv-swarm-core)
[![npm downloads](https://img.shields.io/npm/dm/@deflex.net/ruv-swarm-core.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/ruv-swarm-core)
[![license](https://img.shields.io/npm/l/@deflex.net/ruv-swarm-core.svg?style=flat-square)](https://github.com/flexnetos/deflex.net/blob/main/LICENSE)
...
`@deflex.net/ruv-swarm-core` is a high-performance Node.js native addon that provides TypeScript bindings for the [`ruv-swarm-core`](https://crates.io/crates/ruv-swarm-core) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
- **License**: MIT
- **Rust Crate**: [ruv-swarm-core](https://crates.io/crates/ruv-swarm-core)
...
```bash
npm install @deflex.net/ruv-swarm-core
```

### Using yarn

```bash
yarn add @deflex.net/ruv-swarm-core
```

### Using pnpm

```bash
pnpm add @deflex.net/ruv-swarm-core
```
...
- **Linux x64**: `@deflex.net/ruv-swarm-core-linux-x64-gnu`
- **Linux ARM64**: `@deflex.net/ruv-swarm-core-linux-arm64-gnu`
- **macOS x64**: `@deflex.net/ruv-swarm-core-darwin-x64`
- **macOS ARM64**: `@deflex.net/ruv-swarm-core-darwin-arm64`
- **Windows x64**: `@deflex.net/ruv-swarm-core-win32-x64-msvc`
- **WebAssembly**: `@deflex.net/ruv-swarm-core-wasm32` (fallback)
...
```typescript
import { RuvSwarmCore } from '@deflex.net/ruv-swarm-core'

// Create an instance
const client = new RuvSwarmCore({
...
```typescript
import { RuvSwarmCore, Config } from '@deflex.net/ruv-swarm-core'
...
// CommonJS
const { RuvSwarmCore } = require('@deflex.net/ruv-swarm-core')
```
...
try {
  ...
  if (error instanceof RuvSwarmCoreError) {
...
Creates a new instance of `RuvSwarmCore`.

**Parameters:**
- `config` (optional): Configuration object

**Returns:**
- Instance of `RuvSwarmCore`
...
```typescript
class RuvSwarmCoreError extends Error {
  code: string
  details?: any
}
```
...
```typescript
import { RuvSwarmCore, RuvSwarmCoreError } from '@deflex.net/ruv-swarm-core'
...
```typescript
import { RuvSwarmCore, Config, LogLevel } from '@deflex.net/ruv-swarm-core'
...
cd deflex.net/packages/ruv-swarm-core
...
- **NPM Package**: [@deflex.net/ruv-swarm-core](https://www.npmjs.com/package/@deflex.net/ruv-swarm-core)
- **GitHub Repository**: [flexnetos/deflex.net](https://github.com/flexnetos/deflex.net)
- **Rust Crate**: [ruv-swarm-core](https://crates.io/crates/ruv-swarm-core)
- **Documentation**: [docs.deflex.net/ruv-swarm-core](https://docs.deflex.net/ruv-swarm-core)
...
- Original crate by the [ruv-swarm-core](https://crates.io/crates/ruv-swarm-core) authors

---

## 📊 Stats

![NPM](https://nodei.co/npm/@deflex.net/ruv-swarm-core.png?downloads=true&downloadRank=true&stars=true)
