# ⚛️ @deflex.net/qudag-crypto

> Quantum-resistant cryptography library for QuDAG - includes ML-KEM-768, ML-DSA, HQC, and BLAKE3

[![npm version](https://img.shields.io/npm/v/@deflex.net/qudag-crypto.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/qudag-crypto)
[![npm downloads](https://img.shields.io/npm/dm/@deflex.net/qudag-crypto.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/qudag-crypto)
[![license](https://img.shields.io/npm/l/@deflex.net/qudag-crypto.svg?style=flat-square)](https://github.com/flexnetos/deflex.net/blob/main/LICENSE)
...
`@deflex.net/qudag-crypto` is a high-performance Node.js native addon that provides TypeScript bindings for the [`qudag-crypto`](https://crates.io/crates/qudag-crypto) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
- **License**: MIT
- **Rust Crate**: [qudag-crypto](https://crates.io/crates/qudag-crypto)
...
```bash
npm install @deflex.net/qudag-crypto
```

### Using yarn

```bash
yarn add @deflex.net/qudag-crypto
```

### Using pnpm

```bash
pnpm add @deflex.net/qudag-crypto
```
...
- **Linux x64**: `@deflex.net/qudag-crypto-linux-x64-gnu`
- **Linux ARM64**: `@deflex.net/qudag-crypto-linux-arm64-gnu`
- **macOS x64**: `@deflex.net/qudag-crypto-darwin-x64`
- **macOS ARM64**: `@deflex.net/qudag-crypto-darwin-arm64`
- **Windows x64**: `@deflex.net/qudag-crypto-win32-x64-msvc`
- **WebAssembly**: `@deflex.net/qudag-crypto-wasm32` (fallback)
...
```typescript
import { QudagCrypto } from '@deflex.net/qudag-crypto'

// Create an instance
const client = new QudagCrypto({
...
```typescript
import { QudagCrypto, Config } from '@deflex.net/qudag-crypto'
...
const client = new QudagCrypto(config)
```
...
// CommonJS
const { QudagCrypto } = require('@deflex.net/qudag-crypto')
```
...
try {
  ...
  if (error instanceof QudagCryptoError) {
...
Creates a new instance of `QudagCrypto`.

**Parameters:**
- `config` (optional): Configuration object

**Returns:**
- Instance of `QudagCrypto`
...
```typescript
class QudagCryptoError extends Error {
  code: string
  details?: any
}
```
...
```typescript
import { QudagCrypto, QudagCryptoError } from '@deflex.net/qudag-crypto'
...
```typescript
import { QudagCrypto, Config, LogLevel } from '@deflex.net/qudag-crypto'
...
cd deflex.net/packages/qudag-crypto
...
- **NPM Package**: [@deflex.net/qudag-crypto](https://www.npmjs.com/package/@deflex.net/qudag-crypto)
- **GitHub Repository**: [flexnetos/deflex.net](https://github.com/flexnetos/deflex.net)
- **Rust Crate**: [qudag-crypto](https://crates.io/crates/qudag-crypto)
- **Documentation**: [docs.deflex.net/qudag-crypto](https://docs.deflex.net/qudag-crypto)
...
- Original crate by the [qudag-crypto](https://crates.io/crates/qudag-crypto) authors

---

## 📊 Stats

![NPM](https://nodei.co/npm/@deflex.net/qudag-crypto.png?downloads=true&downloadRank=true&stars=true)
