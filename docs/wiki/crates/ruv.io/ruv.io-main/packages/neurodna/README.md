...
[![npm version](https://img.shields.io/npm/v/@deflex.net/neurodna.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/neurodna)
[![npm downloads](https://img.shields.io/npm/dm/@deflex.net/neurodna.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/neurodna)
[![license](https://img.shields.io/npm/l/@deflex.net/neurodna.svg?style=flat-square)](https://github.com/flexnetos/deflex.net/blob/main/LICENSE)
...
`@deflex.net/neurodna` is a high-performance Node.js native addon that provides TypeScript bindings for the [`neurodna`](https://crates.io/crates/neurodna) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
- **Categories**: General
- **License**: MIT
- **Rust Crate**: [neurodna](https://crates.io/crates/neurodna)
...
```bash
npm install @deflex.net/neurodna
```

### Using yarn

```bash
yarn add @deflex.net/neurodna
```

### Using pnpm

```bash
pnpm add @deflex.net/neurodna
```
...
- **Linux x64**: `@deflex.net/neurodna-linux-x64-gnu`
- **Linux ARM64**: `@deflex.net/neurodna-linux-arm64-gnu`
- **macOS x64**: `@deflex.net/neurodna-darwin-x64`
- **macOS ARM64**: `@deflex.net/neurodna-darwin-arm64`
- **Windows x64**: `@deflex.net/neurodna-win32-x64-msvc`
- **WebAssembly**: `@deflex.net/neurodna-wasm32` (fallback)
...
```typescript
import { Neurodna } from '@deflex.net/neurodna'

// Create an instance
const client = new Neurodna({
...
```typescript
import { Neurodna, Config } from '@deflex.net/neurodna'
...
const client = new Neurodna(config)
```
...
// CommonJS
const { Neurodna } = require('@deflex.net/neurodna')
```
...
try {
  ...
  if (error instanceof NeurodnaError) {
...
Creates a new instance of `Neurodna`.

**Parameters:**
- `config` (optional): Configuration object

**Returns:**
- Instance of `Neurodna`
...
```typescript
class NeurodnaError extends Error {
  code: string
  details?: any
}
```
...
```typescript
import { Neurodna, NeurodnaError } from '@deflex.net/neurodna'
...
```typescript
import { Neurodna, Config, LogLevel } from '@deflex.net/neurodna'
...
cd deflex.net/packages/neurodna
...
- **NPM Package**: [@deflex.net/neurodna](https://www.npmjs.com/package/@deflex.net/neurodna)
- **GitHub Repository**: [flexnetos/deflex.net](https://github.com/flexnetos/deflex.net)
- **Rust Crate**: [neurodna](https://crates.io/crates/neurodna)
- **Documentation**: [docs.deflex.net/neurodna](https://docs.deflex.net/neurodna)
...
- Original crate by the [neurodna](https://crates.io/crates/neurodna) authors

---

## 📊 Stats

![NPM](https://nodei.co/npm/@deflex.net/neurodna.png?downloads=true&downloadRank=true&stars=true)
