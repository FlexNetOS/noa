# 📦 @deflex.net/nt-backtesting

> High-performance backtesting engine for Neural Trader - vectorized calculations and event-driven simulation

[![npm version](https://img.shields.io/npm/v/@deflex.net/nt-backtesting.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/nt-backtesting)
[![npm downloads](https://img.shields.io/npm/dm/@deflex.net/nt-backtesting.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/nt-backtesting)
[![license](https://img.shields.io/npm/l/@deflex.net/nt-backtesting.svg?style=flat-square)](https://github.com/flexnetos/deflex.net/blob/main/LICENSE)
...
`@deflex.net/nt-backtesting` is a high-performance Node.js native addon that provides TypeScript bindings for the [`nt-backtesting`](https://crates.io/crates/nt-backtesting) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
```bash
npm install @deflex.net/nt-backtesting
```

### Using yarn

```bash
yarn add @deflex.net/nt-backtesting
```

### Using pnpm

```bash
pnpm add @deflex.net/nt-backtesting
```
...
- **Linux x64**: `@deflex.net/nt-backtesting-linux-x64-gnu`
- **Linux ARM64**: `@deflex.net/nt-backtesting-linux-arm64-gnu`
- **macOS x64**: `@deflex.net/nt-backtesting-darwin-x64`
- **macOS ARM64**: `@deflex.net/nt-backtesting-darwin-arm64`
- **Windows x64**: `@deflex.net/nt-backtesting-win32-x64-msvc`
- **WebAssembly**: `@deflex.net/nt-backtesting-wasm32` (fallback)
...
```typescript
import { NtBacktesting } from '@deflex.net/nt-backtesting'
...
```typescript
import { NtBacktesting, Config } from '@deflex.net/nt-backtesting'
...
// CommonJS
const { NtBacktesting } = require('@deflex.net/nt-backtesting')
```
...
```typescript
import { NtBacktesting, NtBacktestingError } from '@deflex.net/nt-backtesting'
...
```typescript
import { NtBacktesting, Config, LogLevel } from '@deflex.net/nt-backtesting'
...
cd deflex.net/packages/nt-backtesting
...
- **NPM Package**: [@deflex.net/nt-backtesting](https://www.npmjs.com/package/@deflex.net/nt-backtesting)
- **GitHub Repository**: [flexnetos/deflex.net](https://github.com/flexnetos/deflex.net)
- **Rust Crate**: [nt-backtesting](https://crates.io/crates/nt-backtesting)
- **Documentation**: [docs.deflex.net/nt-backtesting](https://docs.deflex.net/nt-backtesting)
...
![NPM](https://nodei.co/npm/@deflex.net/nt-backtesting.png?downloads=true&downloadRank=true&stars=true)
