...
[![npm version](https://img.shields.io/npm/v/@deflex.net/nt-core.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/nt-core)
[![npm downloads](https://img.shields.io/npm/dm/@deflex.net/nt-core.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/nt-core)
[![license](https://img.shields.io/npm/l/@deflex.net/nt-core.svg?style=flat-square)](https://github.com/flexnetos/deflex.net/blob/main/LICENSE)
...
`@deflex.net/nt-core` is a high-performance Node.js native addon that provides TypeScript bindings for the [`nt-core`](https://crates.io/crates/nt-core) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
- **License**: MIT
- **Rust Crate**: [nt-core](https://crates.io/crates/nt-core)
...
```bash
npm install @deflex.net/nt-core
```

### Using yarn

```bash
yarn add @deflex.net/nt-core
```

### Using pnpm

```bash
pnpm add @deflex.net/nt-core
```
...
- **Linux x64**: `@deflex.net/nt-core-linux-x64-gnu`
- **Linux ARM64**: `@deflex.net/nt-core-linux-arm64-gnu`
- **macOS x64**: `@deflex.net/nt-core-darwin-x64`
- **macOS ARM64**: `@deflex.net/nt-core-darwin-arm64`
- **Windows x64**: `@deflex.net/nt-core-win32-x64-msvc`
- **WebAssembly**: `@deflex.net/nt-core-wasm32` (fallback)
...
```typescript
import { NtCore } from '@deflex.net/nt-core'

// Create an instance
const client = new NtCore({
...
```typescript
import { NtCore, Config } from '@deflex.net/nt-core'
...
const client = new NtCore(config)
```
...
// CommonJS
const { NtCore } = require('@deflex.net/nt-core')
```
...
try {
  ...
  if (error instanceof NtCoreError) {
...
Creates a new instance of `NtCore`.
...
```typescript
class NtCoreError extends Error {
  code: string
  details?: any
}
```
...
```typescript
import { NtCore, NtCoreError } from '@deflex.net/nt-core'
...
```typescript
import { NtCore, Config, LogLevel } from '@deflex.net/nt-core'
...
cd deflex.net/packages/nt-core
...
- **NPM Package**: [@deflex.net/nt-core](https://www.npmjs.com/package/@deflex.net/nt-core)
- **GitHub Repository**: [flexnetos/deflex.net](https://github.com/flexnetos/deflex.net)
- **Rust Crate**: [nt-core](https://crates.io/crates/nt-core)
- **Documentation**: [docs.deflex.net/nt-core](https://docs.deflex.net/nt-core)
...
- Original crate by the [nt-core](https://crates.io/crates/nt-core) authors

---

## 📊 Stats

![NPM](https://nodei.co/npm/@deflex.net/nt-core.png?downloads=true&downloadRank=true&stars=true)
