...
```typescript
import { Micro_routing, Config } from '@deflex.net/micro_routing'
...
const client = new Micro_routing(config)
```
...
```typescript
import { Micro_routing, Config, LogLevel } from '@deflex.net/micro_routing'
