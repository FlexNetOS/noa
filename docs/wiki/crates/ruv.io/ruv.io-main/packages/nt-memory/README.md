# 📦 @deflex.net/nt-memory

> Hierarchical memory system for Neural Trader - ReasoningBank-compatible with L1/L2/L3 caching

[![npm version](https://img.shields.io/npm/v/@deflex.net/nt-memory.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/nt-memory)
[![npm downloads](https://img.shields.io/npm/dm/@deflex.net/nt-memory.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/nt-memory)
[![license](https://img.shields.io/npm/l/@deflex.net/nt-memory.svg?style=flat-square)](https://github.com/flexnetos/deflex.net/blob/main/LICENSE)
...
`@deflex.net/nt-memory` is a high-performance Node.js native addon that provides TypeScript bindings for the [`nt-memory`](https://crates.io/crates/nt-memory) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
- **License**: MIT
- **Rust Crate**: [nt-memory](https://crates.io/crates/nt-memory)
...
```bash
npm install @deflex.net/nt-memory
```

### Using yarn

```bash
yarn add @deflex.net/nt-memory
```

### Using pnpm

```bash
pnpm add @deflex.net/nt-memory
```
...
- **Linux x64**: `@deflex.net/nt-memory-linux-x64-gnu`
- **Linux ARM64**: `@deflex.net/nt-memory-linux-arm64-gnu`
- **macOS x64**: `@deflex.net/nt-memory-darwin-x64`
- **macOS ARM64**: `@deflex.net/nt-memory-darwin-arm64`
- **Windows x64**: `@deflex.net/nt-memory-win32-x64-msvc`
- **WebAssembly**: `@deflex.net/nt-memory-wasm32` (fallback)
...
```typescript
import { NtMemory } from '@deflex.net/nt-memory'

// Create an instance
const client = new NtMemory({
...
```typescript
import { NtMemory, Config } from '@deflex.net/nt-memory'
...
const client = new NtMemory(config)
```
...
// CommonJS
const { NtMemory } = require('@deflex.net/nt-memory')
```
...
try {
  ...
  if (error instanceof NtMemoryError) {
...
Creates a new instance of `NtMemory`.

**Parameters:**
- `config` (optional): Configuration object

**Returns:**
- Instance of `NtMemory`
...
```typescript
class NtMemoryError extends Error {
  code: string
  details?: any
}
```
...
```typescript
import { NtMemory, NtMemoryError } from '@deflex.net/nt-memory'
...
```typescript
import { NtMemory, Config, LogLevel } from '@deflex.net/nt-memory'
...
cd deflex.net/packages/nt-memory
...
- **NPM Package**: [@deflex.net/nt-memory](https://www.npmjs.com/package/@deflex.net/nt-memory)
- **GitHub Repository**: [flexnetos/deflex.net](https://github.com/flexnetos/deflex.net)
- **Rust Crate**: [nt-memory](https://crates.io/crates/nt-memory)
- **Documentation**: [docs.deflex.net/nt-memory](https://docs.deflex.net/nt-memory)
...
- Original crate by the [nt-memory](https://crates.io/crates/nt-memory) authors

---

## 📊 Stats

![NPM](https://nodei.co/npm/@deflex.net/nt-memory.png?downloads=true&downloadRank=true&stars=true)
