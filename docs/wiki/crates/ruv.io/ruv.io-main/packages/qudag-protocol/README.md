# ⚛️ @deflex.net/qudag-protocol

> Protocol implementation for QuDAG - Orchestrates crypto, DAG, and network components

[![npm version](https://img.shields.io/npm/v/@deflex.net/qudag-protocol.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/qudag-protocol)
[![npm downloads](https://img.shields.io/npm/dm/@deflex.net/qudag-protocol.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/qudag-protocol)
[![license](https://img.shields.io/npm/l/@deflex.net/qudag-protocol.svg?style=flat-square)](https://github.com/flexnetos/deflex.net/blob/main/LICENSE)
...
`@deflex.net/qudag-protocol` is a high-performance Node.js native addon that provides TypeScript bindings for the [`qudag-protocol`](https://crates.io/crates/qudag-protocol) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
- **License**: MIT
- **Rust Crate**: [qudag-protocol](https://crates.io/crates/qudag-protocol)
...
```bash
npm install @deflex.net/qudag-protocol
```

### Using yarn

```bash
yarn add @deflex.net/qudag-protocol
```

### Using pnpm

```bash
pnpm add @deflex.net/qudag-protocol
```
...
- **Linux x64**: `@deflex.net/qudag-protocol-linux-x64-gnu`
- **Linux ARM64**: `@deflex.net/qudag-protocol-linux-arm64-gnu`
- **macOS x64**: `@deflex.net/qudag-protocol-darwin-x64`
- **macOS ARM64**: `@deflex.net/qudag-protocol-darwin-arm64`
- **Windows x64**: `@deflex.net/qudag-protocol-win32-x64-msvc`
- **WebAssembly**: `@deflex.net/qudag-protocol-wasm32` (fallback)
...
```typescript
import { QudagProtocol } from '@deflex.net/qudag-protocol'

// Create an instance
const client = new QudagProtocol({
...
```typescript
import { QudagProtocol, Config } from '@deflex.net/qudag-protocol'
...
const client = new QudagProtocol(config)
```
...
// CommonJS
const { QudagProtocol } = require('@deflex.net/qudag-protocol')
```
...
try {
  ...
  if (error instanceof QudagProtocolError) {
...
Creates a new instance of `QudagProtocol`.

**Parameters:**
- `config` (optional): Configuration object

**Returns:**
- Instance of `QudagProtocol`
...
```typescript
class QudagProtocolError extends Error {
  code: string
  details?: any
}
```
...
```typescript
import { QudagProtocol, QudagProtocolError } from '@deflex.net/qudag-protocol'
...
```typescript
import { QudagProtocol, Config, LogLevel } from '@deflex.net/qudag-protocol'
...
cd deflex.net/packages/qudag-protocol
...
- **NPM Package**: [@deflex.net/qudag-protocol](https://www.npmjs.com/package/@deflex.net/qudag-protocol)
- **GitHub Repository**: [flexnetos/deflex.net](https://github.com/flexnetos/deflex.net)
- **Rust Crate**: [qudag-protocol](https://crates.io/crates/qudag-protocol)
- **Documentation**: [docs.deflex.net/qudag-protocol](https://docs.deflex.net/qudag-protocol)
...
- Original crate by the [qudag-protocol](https://crates.io/crates/qudag-protocol) authors

---

## 📊 Stats

![NPM](https://nodei.co/npm/@deflex.net/qudag-protocol.png?downloads=true&downloadRank=true&stars=true)
