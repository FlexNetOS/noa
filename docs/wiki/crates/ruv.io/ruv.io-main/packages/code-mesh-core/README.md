...
[![npm version](https://img.shields.io/npm/v/@deflex.net/code-mesh-core.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/code-mesh-core)
[![npm downloads](https://img.shields.io/npm/dm/@deflex.net/code-mesh-core.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/code-mesh-core)
[![license](https://img.shields.io/npm/l/@deflex.net/code-mesh-core.svg?style=flat-square)](https://github.com/flexnetos/deflex.net/blob/main/LICENSE)
...
`@deflex.net/code-mesh-core` is a high-performance Node.js native addon that provides TypeScript bindings for the [`code-mesh-core`](https://crates.io/crates/code-mesh-core) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
- **License**: MIT
- **Rust Crate**: [code-mesh-core](https://crates.io/crates/code-mesh-core)
...
```bash
npm install @deflex.net/code-mesh-core
```

### Using yarn

```bash
yarn add @deflex.net/code-mesh-core
```

### Using pnpm

```bash
pnpm add @deflex.net/code-mesh-core
```
...
- **Linux x64**: `@deflex.net/code-mesh-core-linux-x64-gnu`
- **Linux ARM64**: `@deflex.net/code-mesh-core-linux-arm64-gnu`
- **macOS x64**: `@deflex.net/code-mesh-core-darwin-x64`
- **macOS ARM64**: `@deflex.net/code-mesh-core-darwin-arm64`
- **Windows x64**: `@deflex.net/code-mesh-core-win32-x64-msvc`
- **WebAssembly**: `@deflex.net/code-mesh-core-wasm32` (fallback)
...
```typescript
import { CodeMeshCore } from '@deflex.net/code-mesh-core'

// Create an instance
const client = new CodeMeshCore({
...
```typescript
import { CodeMeshCore, Config } from '@deflex.net/code-mesh-core'
...
const client = new CodeMeshCore(config)
```
...
// CommonJS
const { CodeMeshCore } = require('@deflex.net/code-mesh-core')
```
...
try {
  ...
  if (error instanceof CodeMeshCoreError) {
...
Creates a new instance of `CodeMeshCore`.

**Parameters:**
- `config` (optional): Configuration object

**Returns:**
- Instance of `CodeMeshCore`
...
```typescript
class CodeMeshCoreError extends Error {
  code: string
  details?: any
}
```
...
```typescript
import { CodeMeshCore, CodeMeshCoreError } from '@deflex.net/code-mesh-core'
...
```typescript
import { CodeMeshCore, Config, LogLevel } from '@deflex.net/code-mesh-core'
...
cd deflex.net/packages/code-mesh-core
...
- **NPM Package**: [@deflex.net/code-mesh-core](https://www.npmjs.com/package/@deflex.net/code-mesh-core)
- **GitHub Repository**: [flexnetos/deflex.net](https://github.com/flexnetos/deflex.net)
- **Rust Crate**: [code-mesh-core](https://crates.io/crates/code-mesh-core)
- **Documentation**: [docs.deflex.net/code-mesh-core](https://docs.deflex.net/code-mesh-core)
...
- Original crate by the [code-mesh-core](https://crates.io/crates/code-mesh-core) authors

---

## 📊 Stats

![NPM](https://nodei.co/npm/@deflex.net/code-mesh-core.png?downloads=true&downloadRank=true&stars=true)
