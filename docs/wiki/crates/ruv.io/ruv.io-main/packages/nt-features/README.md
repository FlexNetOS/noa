# 📦 @deflex.net/nt-features

> Feature extraction and engineering for Neural Trader - technical indicators and market signals

[![npm version](https://img.shields.io/npm/v/@deflex.net/nt-features.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/nt-features)
[![npm downloads](https://img.shields.io/npm/dm/@deflex.net/nt-features.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/nt-features)
[![license](https://img.shields.io/npm/l/@deflex.net/nt-features.svg?style=flat-square)](https://github.com/flexnetos/deflex.net/blob/main/LICENSE)
...
`@deflex.net/nt-features` is a high-performance Node.js native addon that provides TypeScript bindings for the [`nt-features`](https://crates.io/crates/nt-features) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
- **License**: MIT
- **Rust Crate**: [nt-features](https://crates.io/crates/nt-features)
...
```bash
npm install @deflex.net/nt-features
```

### Using yarn

```bash
yarn add @deflex.net/nt-features
```

### Using pnpm

```bash
pnpm add @deflex.net/nt-features
```
...
- **Linux x64**: `@deflex.net/nt-features-linux-x64-gnu`
- **Linux ARM64**: `@deflex.net/nt-features-linux-arm64-gnu`
- **macOS x64**: `@deflex.net/nt-features-darwin-x64`
- **macOS ARM64**: `@deflex.net/nt-features-darwin-arm64`
- **Windows x64**: `@deflex.net/nt-features-win32-x64-msvc`
- **WebAssembly**: `@deflex.net/nt-features-wasm32` (fallback)
...
```typescript
import { NtFeatures } from '@deflex.net/nt-features'

// Create an instance
const client = new NtFeatures({
...
```typescript
import { NtFeatures, Config } from '@deflex.net/nt-features'
...
const client = new NtFeatures(config)
```
...
// CommonJS
const { NtFeatures } = require('@deflex.net/nt-features')
```
...
try {
  ...
  if (error instanceof NtFeaturesError) {
...
Creates a new instance of `NtFeatures`.

**Parameters:**
- `config` (optional): Configuration object

**Returns:**
- Instance of `NtFeatures`
...
```typescript
class NtFeaturesError extends Error {
  code: string
  details?: any
}
```
...
```typescript
import { NtFeatures, NtFeaturesError } from '@deflex.net/nt-features'
...
```typescript
import { NtFeatures, Config, LogLevel } from '@deflex.net/nt-features'
...
cd deflex.net/packages/nt-features
...
- **NPM Package**: [@deflex.net/nt-features](https://www.npmjs.com/package/@deflex.net/nt-features)
- **GitHub Repository**: [flexnetos/deflex.net](https://github.com/flexnetos/deflex.net)
- **Rust Crate**: [nt-features](https://crates.io/crates/nt-features)
- **Documentation**: [docs.deflex.net/nt-features](https://docs.deflex.net/nt-features)
...
- Original crate by the [nt-features](https://crates.io/crates/nt-features) authors

---

## 📊 Stats

![NPM](https://nodei.co/npm/@deflex.net/nt-features.png?downloads=true&downloadRank=true&stars=true)
