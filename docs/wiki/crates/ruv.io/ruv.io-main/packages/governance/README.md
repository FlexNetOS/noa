# 📦 @deflex.net/governance

> Governance and voting system for Neural Trader - proposal management, voting mechanisms, and consensus protocols

[![npm version](https://img.shields.io/npm/v/@deflex.net/governance.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/governance)
[![npm downloads](https://img.shields.io/npm/dm/@deflex.net/governance.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/governance)
[![license](https://img.shields.io/npm/l/@deflex.net/governance.svg?style=flat-square)](https://github.com/flexnetos/deflex.net/blob/main/LICENSE)
...
`@deflex.net/governance` is a high-performance Node.js native addon that provides TypeScript bindings for the [`governance`](https://crates.io/crates/governance) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
- **Categories**: General
- **License**: MIT
- **Rust Crate**: [governance](https://crates.io/crates/governance)
...
```bash
npm install @deflex.net/governance
```

### Using yarn

```bash
yarn add @deflex.net/governance
```

### Using pnpm

```bash
pnpm add @deflex.net/governance
```
...
- **Linux x64**: `@deflex.net/governance-linux-x64-gnu`
- **Linux ARM64**: `@deflex.net/governance-linux-arm64-gnu`
- **macOS x64**: `@deflex.net/governance-darwin-x64`
- **macOS ARM64**: `@deflex.net/governance-darwin-arm64`
- **Windows x64**: `@deflex.net/governance-win32-x64-msvc`
- **WebAssembly**: `@deflex.net/governance-wasm32` (fallback)
...
```typescript
import { Governance } from '@deflex.net/governance'

// Create an instance
const client = new Governance({
...
```typescript
import { Governance, Config } from '@deflex.net/governance'
...
const client = new Governance(config)
```
...
// CommonJS
const { Governance } = require('@deflex.net/governance')
```
...
```typescript
import { Governance, GovernanceError } from '@deflex.net/governance'
...
```typescript
import { Governance, Config, LogLevel } from '@deflex.net/governance'
...
cd deflex.net/packages/governance
...
- **NPM Package**: [@deflex.net/governance](https://www.npmjs.com/package/@deflex.net/governance)
- **GitHub Repository**: [flexnetos/deflex.net](https://github.com/flexnetos/deflex.net)
- **Rust Crate**: [governance](https://crates.io/crates/governance)
- **Documentation**: [docs.deflex.net/governance](https://docs.deflex.net/governance)
...
- Original crate by the [governance](https://crates.io/crates/governance) authors

---

## 📊 Stats

![NPM](https://nodei.co/npm/@deflex.net/governance.png?downloads=true&downloadRank=true&stars=true)
