# 👁️ @deflex.net/opencv-wasm

> OpenCV WebAssembly bindings for browser deployment

[![npm version](https://img.shields.io/npm/v/@deflex.net/opencv-wasm.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/opencv-wasm)
[![npm downloads](https://img.shields.io/npm/dm/@deflex.net/opencv-wasm.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/opencv-wasm)
[![license](https://img.shields.io/npm/l/@deflex.net/opencv-wasm.svg?style=flat-square)](https://github.com/flexnetos/deflex.net/blob/main/LICENSE)
...
`@deflex.net/opencv-wasm` is a high-performance Node.js native addon that provides TypeScript bindings for the [`opencv-wasm`](https://crates.io/crates/opencv-wasm) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.

**Key Information:**
- **Version**: 4.8.1
- **Downloads**: 873+
- **Categories**: Wasm Bindings, Computer Vision
- **License**: MIT
- **Rust Crate**: [opencv-wasm](https://crates.io/crates/opencv-wasm)
...
```bash
npm install @deflex.net/opencv-wasm
```

### Using yarn

```bash
yarn add @deflex.net/opencv-wasm
```

### Using pnpm

```bash
pnpm add @deflex.net/opencv-wasm
```
...
- **Linux x64**: `@deflex.net/opencv-wasm-linux-x64-gnu`
- **Linux ARM64**: `@deflex.net/opencv-wasm-linux-arm64-gnu`
- **macOS x64**: `@deflex.net/opencv-wasm-darwin-x64`
- **macOS ARM64**: `@deflex.net/opencv-wasm-darwin-arm64`
- **Windows x64**: `@deflex.net/opencv-wasm-win32-x64-msvc`
- **WebAssembly**: `@deflex.net/opencv-wasm-wasm32` (fallback)
...
```typescript
import { OpencvWasm } from '@deflex.net/opencv-wasm'

// Create an instance
const client = new OpencvWasm({
...
```typescript
import { OpencvWasm, Config } from '@deflex.net/opencv-wasm'
...
const client = new OpencvWasm(config)
```
...
// CommonJS
const { OpencvWasm } = require('@deflex.net/opencv-wasm')
```
...
try {
  ...
  if (error instanceof OpencvWasmError) {
...
Creates a new instance of `OpencvWasm`.

**Parameters:**
- `config` (optional): Configuration object

**Returns:**
- Instance of `OpencvWasm`
...
```typescript
class OpencvWasmError extends Error {
  code: string
  details?: any
}
```
...
```typescript
import { OpencvWasm, OpencvWasmError } from '@deflex.net/opencv-wasm'
...
```typescript
import { OpencvWasm, Config, LogLevel } from '@deflex.net/opencv-wasm'
...
cd deflex.net/packages/opencv-wasm
...
- **NPM Package**: [@deflex.net/opencv-wasm](https://www.npmjs.com/package/@deflex.net/opencv-wasm)
- **GitHub Repository**: [flexnetos/deflex.net](https://github.com/flexnetos/deflex.net)
- **Rust Crate**: [opencv-wasm](https://crates.io/crates/opencv-wasm)
- **Documentation**: [docs.deflex.net/opencv-wasm](https://docs.deflex.net/opencv-wasm)
...
- Original crate by the [opencv-wasm](https://crates.io/crates/opencv-wasm) authors

---

## 📊 Stats

![NPM](https://nodei.co/npm/@deflex.net/opencv-wasm.png?downloads=true&downloadRank=true&stars=true)
