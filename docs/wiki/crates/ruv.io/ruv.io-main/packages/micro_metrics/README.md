...
```typescript
import { Micro_metrics, Config } from '@deflex.net/micro_metrics'
...
const client = new Micro_metrics(config)
```
...
```typescript
import { Micro_metrics, Config, LogLevel } from '@deflex.net/micro_metrics'
