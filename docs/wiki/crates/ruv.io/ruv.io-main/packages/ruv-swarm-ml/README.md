# 🐝 @deflex.net/ruv-swarm-ml

> Machine learning integration for RUV Swarm

[![npm version](https://img.shields.io/npm/v/@deflex.net/ruv-swarm-ml.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/ruv-swarm-ml)
[![npm downloads](https://img.shields.io/npm/dm/@deflex.net/ruv-swarm-ml.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/ruv-swarm-ml)
[![license](https://img.shields.io/npm/l/@deflex.net/ruv-swarm-ml.svg?style=flat-square)](https://github.com/flexnetos/deflex.net/blob/main/LICENSE)
...
`@deflex.net/ruv-swarm-ml` is a high-performance Node.js native addon that provides TypeScript bindings for the [`ruv-swarm-ml`](https://crates.io/crates/ruv-swarm-ml) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
- **License**: MIT
- **Rust Crate**: [ruv-swarm-ml](https://crates.io/crates/ruv-swarm-ml)
...
```bash
npm install @deflex.net/ruv-swarm-ml
```

### Using yarn

```bash
yarn add @deflex.net/ruv-swarm-ml
```

### Using pnpm

```bash
pnpm add @deflex.net/ruv-swarm-ml
```
...
- **Linux x64**: `@deflex.net/ruv-swarm-ml-linux-x64-gnu`
- **Linux ARM64**: `@deflex.net/ruv-swarm-ml-linux-arm64-gnu`
- **macOS x64**: `@deflex.net/ruv-swarm-ml-darwin-x64`
- **macOS ARM64**: `@deflex.net/ruv-swarm-ml-darwin-arm64`
- **Windows x64**: `@deflex.net/ruv-swarm-ml-win32-x64-msvc`
- **WebAssembly**: `@deflex.net/ruv-swarm-ml-wasm32` (fallback)
...
```typescript
import { RuvSwarmMl } from '@deflex.net/ruv-swarm-ml'

// Create an instance
const client = new RuvSwarmMl({
...
```typescript
import { RuvSwarmMl, Config } from '@deflex.net/ruv-swarm-ml'
...
const client = new RuvSwarmMl(config)
```
...
// CommonJS
const { RuvSwarmMl } = require('@deflex.net/ruv-swarm-ml')
```
...
try {
  ...
  if (error instanceof RuvSwarmMlError) {
...
Creates a new instance of `RuvSwarmMl`.

**Parameters:**
- `config` (optional): Configuration object

**Returns:**
- Instance of `RuvSwarmMl`
...
```typescript
class RuvSwarmMlError extends Error {
  code: string
  details?: any
}
```
...
```typescript
import { RuvSwarmMl, RuvSwarmMlError } from '@deflex.net/ruv-swarm-ml'
...
```typescript
import { RuvSwarmMl, Config, LogLevel } from '@deflex.net/ruv-swarm-ml'
...
cd deflex.net/packages/ruv-swarm-ml
...
- **NPM Package**: [@deflex.net/ruv-swarm-ml](https://www.npmjs.com/package/@deflex.net/ruv-swarm-ml)
- **GitHub Repository**: [flexnetos/deflex.net](https://github.com/flexnetos/deflex.net)
- **Rust Crate**: [ruv-swarm-ml](https://crates.io/crates/ruv-swarm-ml)
- **Documentation**: [docs.deflex.net/ruv-swarm-ml](https://docs.deflex.net/ruv-swarm-ml)
...
- Original crate by the [ruv-swarm-ml](https://crates.io/crates/ruv-swarm-ml) authors

---

## 📊 Stats

![NPM](https://nodei.co/npm/@deflex.net/ruv-swarm-ml.png?downloads=true&downloadRank=true&stars=true)
