...
```typescript
import { StrangeLoop, Config } from '@deflex.net/strange-loop'
...
const client = new StrangeLoop(config)
```
...
```typescript
import { StrangeLoop, Config, LogLevel } from '@deflex.net/strange-loop'
