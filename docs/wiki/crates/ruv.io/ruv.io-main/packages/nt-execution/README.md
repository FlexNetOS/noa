# 📦 @deflex.net/nt-execution

> Order execution and broker integration for Neural Trader - supports Alpaca, Interactive Brokers, and more

[![npm version](https://img.shields.io/npm/v/@deflex.net/nt-execution.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/nt-execution)
[![npm downloads](https://img.shields.io/npm/dm/@deflex.net/nt-execution.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/nt-execution)
[![license](https://img.shields.io/npm/l/@deflex.net/nt-execution.svg?style=flat-square)](https://github.com/flexnetos/deflex.net/blob/main/LICENSE)
...
`@deflex.net/nt-execution` is a high-performance Node.js native addon that provides TypeScript bindings for the [`nt-execution`](https://crates.io/crates/nt-execution) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
- **License**: MIT
- **Rust Crate**: [nt-execution](https://crates.io/crates/nt-execution)
...
```bash
npm install @deflex.net/nt-execution
```

### Using yarn

```bash
yarn add @deflex.net/nt-execution
```

### Using pnpm

```bash
pnpm add @deflex.net/nt-execution
```
...
- **Linux x64**: `@deflex.net/nt-execution-linux-x64-gnu`
- **Linux ARM64**: `@deflex.net/nt-execution-linux-arm64-gnu`
- **macOS x64**: `@deflex.net/nt-execution-darwin-x64`
- **macOS ARM64**: `@deflex.net/nt-execution-darwin-arm64`
- **Windows x64**: `@deflex.net/nt-execution-win32-x64-msvc`
- **WebAssembly**: `@deflex.net/nt-execution-wasm32` (fallback)
...
```typescript
import { NtExecution } from '@deflex.net/nt-execution'

// Create an instance
const client = new NtExecution({
...
```typescript
import { NtExecution, Config } from '@deflex.net/nt-execution'
...
const client = new NtExecution(config)
```
...
// CommonJS
const { NtExecution } = require('@deflex.net/nt-execution')
```
...
try {
  ...
  if (error instanceof NtExecutionError) {
...
Creates a new instance of `NtExecution`.

**Parameters:**
- `config` (optional): Configuration object

**Returns:**
- Instance of `NtExecution`
...
```typescript
class NtExecutionError extends Error {
  code: string
  details?: any
}
```
...
```typescript
import { NtExecution, NtExecutionError } from '@deflex.net/nt-execution'
...
```typescript
import { NtExecution, Config, LogLevel } from '@deflex.net/nt-execution'
...
cd deflex.net/packages/nt-execution
...
- **NPM Package**: [@deflex.net/nt-execution](https://www.npmjs.com/package/@deflex.net/nt-execution)
- **GitHub Repository**: [flexnetos/deflex.net](https://github.com/flexnetos/deflex.net)
- **Rust Crate**: [nt-execution](https://crates.io/crates/nt-execution)
- **Documentation**: [docs.deflex.net/nt-execution](https://docs.deflex.net/nt-execution)
...
- Original crate by the [nt-execution](https://crates.io/crates/nt-execution) authors

---

## 📊 Stats

![NPM](https://nodei.co/npm/@deflex.net/nt-execution.png?downloads=true&downloadRank=true&stars=true)
