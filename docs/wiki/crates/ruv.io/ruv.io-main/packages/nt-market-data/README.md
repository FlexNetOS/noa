# 📦 @deflex.net/nt-market-data

> Market data providers and streaming for Neural Trader - supports Alpaca, Polygon, IEX, and more

[![npm version](https://img.shields.io/npm/v/@deflex.net/nt-market-data.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/nt-market-data)
[![npm downloads](https://img.shields.io/npm/dm/@deflex.net/nt-market-data.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/nt-market-data)
[![license](https://img.shields.io/npm/l/@deflex.net/nt-market-data.svg?style=flat-square)](https://github.com/flexnetos/deflex.net/blob/main/LICENSE)
...
`@deflex.net/nt-market-data` is a high-performance Node.js native addon that provides TypeScript bindings for the [`nt-market-data`](https://crates.io/crates/nt-market-data) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
- **License**: MIT
- **Rust Crate**: [nt-market-data](https://crates.io/crates/nt-market-data)
...
```bash
npm install @deflex.net/nt-market-data
```

### Using yarn

```bash
yarn add @deflex.net/nt-market-data
```

### Using pnpm

```bash
pnpm add @deflex.net/nt-market-data
```
...
- **Linux x64**: `@deflex.net/nt-market-data-linux-x64-gnu`
- **Linux ARM64**: `@deflex.net/nt-market-data-linux-arm64-gnu`
- **macOS x64**: `@deflex.net/nt-market-data-darwin-x64`
- **macOS ARM64**: `@deflex.net/nt-market-data-darwin-arm64`
- **Windows x64**: `@deflex.net/nt-market-data-win32-x64-msvc`
- **WebAssembly**: `@deflex.net/nt-market-data-wasm32` (fallback)
...
```typescript
import { NtMarketData } from '@deflex.net/nt-market-data'

// Create an instance
const client = new NtMarketData({
...
```typescript
import { NtMarketData, Config } from '@deflex.net/nt-market-data'
...
const client = new NtMarketData(config)
```
...
// CommonJS
const { NtMarketData } = require('@deflex.net/nt-market-data')
```
...
try {
  ...
  if (error instanceof NtMarketDataError) {
...
Creates a new instance of `NtMarketData`.

**Parameters:**
- `config` (optional): Configuration object

**Returns:**
- Instance of `NtMarketData`
...
```typescript
class NtMarketDataError extends Error {
  code: string
  details?: any
}
```
...
```typescript
import { NtMarketData, NtMarketDataError } from '@deflex.net/nt-market-data'
...
```typescript
import { NtMarketData, Config, LogLevel } from '@deflex.net/nt-market-data'
...
cd deflex.net/packages/nt-market-data
...
- **NPM Package**: [@deflex.net/nt-market-data](https://www.npmjs.com/package/@deflex.net/nt-market-data)
- **GitHub Repository**: [flexnetos/deflex.net](https://github.com/flexnetos/deflex.net)
- **Rust Crate**: [nt-market-data](https://crates.io/crates/nt-market-data)
- **Documentation**: [docs.deflex.net/nt-market-data](https://docs.deflex.net/nt-market-data)
...
- Original crate by the [nt-market-data](https://crates.io/crates/nt-market-data) authors

---

## 📊 Stats

![NPM](https://nodei.co/npm/@deflex.net/nt-market-data.png?downloads=true&downloadRank=true&stars=true)
