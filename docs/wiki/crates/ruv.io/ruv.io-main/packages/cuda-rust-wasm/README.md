# 🛠️ @deflex.net/cuda-rust-wasm

> CUDA to Rust transpiler with WebGPU/WASM support

[![npm version](https://img.shields.io/npm/v/@deflex.net/cuda-rust-wasm.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/cuda-rust-wasm)
[![npm downloads](https://img.shields.io/npm/dm/@deflex.net/cuda-rust-wasm.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/cuda-rust-wasm)
[![license](https://img.shields.io/npm/l/@deflex.net/cuda-rust-wasm.svg?style=flat-square)](https://github.com/flexnetos/deflex.net/blob/main/LICENSE)
...
`@deflex.net/cuda-rust-wasm` is a high-performance Node.js native addon that provides TypeScript bindings for the [`cuda-rust-wasm`](https://crates.io/crates/cuda-rust-wasm) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
- **License**: MIT
- **Rust Crate**: [cuda-rust-wasm](https://crates.io/crates/cuda-rust-wasm)
...
```bash
npm install @deflex.net/cuda-rust-wasm
```

### Using yarn

```bash
yarn add @deflex.net/cuda-rust-wasm
```

### Using pnpm

```bash
pnpm add @deflex.net/cuda-rust-wasm
```
...
- **Linux x64**: `@deflex.net/cuda-rust-wasm-linux-x64-gnu`
- **Linux ARM64**: `@deflex.net/cuda-rust-wasm-linux-arm64-gnu`
- **macOS x64**: `@deflex.net/cuda-rust-wasm-darwin-x64`
- **macOS ARM64**: `@deflex.net/cuda-rust-wasm-darwin-arm64`
- **Windows x64**: `@deflex.net/cuda-rust-wasm-win32-x64-msvc`
- **WebAssembly**: `@deflex.net/cuda-rust-wasm-wasm32` (fallback)
...
```typescript
import { CudaRustWasm } from '@deflex.net/cuda-rust-wasm'
...
```typescript
import { CudaRustWasm, Config } from '@deflex.net/cuda-rust-wasm'
...
// CommonJS
const { CudaRustWasm } = require('@deflex.net/cuda-rust-wasm')
```
...
try {
  ...
  if (error instanceof CudaRustWasmError) {
...
Creates a new instance of `CudaRustWasm`.

**Parameters:**
- `config` (optional): Configuration object

**Returns:**
- Instance of `CudaRustWasm`
...
```typescript
class CudaRustWasmError extends Error {
  code: string
  details?: any
}
```
...
```typescript
import { CudaRustWasm, CudaRustWasmError } from '@deflex.net/cuda-rust-wasm'
...
```typescript
import { CudaRustWasm, Config, LogLevel } from '@deflex.net/cuda-rust-wasm'
...
cd deflex.net/packages/cuda-rust-wasm
...
- **NPM Package**: [@deflex.net/cuda-rust-wasm](https://www.npmjs.com/package/@deflex.net/cuda-rust-wasm)
- **GitHub Repository**: [flexnetos/deflex.net](https://github.com/flexnetos/deflex.net)
- **Rust Crate**: [cuda-rust-wasm](https://crates.io/crates/cuda-rust-wasm)
- **Documentation**: [docs.deflex.net/cuda-rust-wasm](https://docs.deflex.net/cuda-rust-wasm)
...
- Original crate by the [cuda-rust-wasm](https://crates.io/crates/cuda-rust-wasm) authors

---

## 📊 Stats

![NPM](https://nodei.co/npm/@deflex.net/cuda-rust-wasm.png?downloads=true&downloadRank=true&stars=true)
