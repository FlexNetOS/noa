# 📦 @deflex.net/nt-napi-bindings

> Node.js N-API bindings for Neural Trader - High-performance TypeScript/JavaScript interface

[![npm version](https://img.shields.io/npm/v/@deflex.net/nt-napi-bindings.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/nt-napi-bindings)
[![npm downloads](https://img.shields.io/npm/dm/@deflex.net/nt-napi-bindings.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/nt-napi-bindings)
[![license](https://img.shields.io/npm/l/@deflex.net/nt-napi-bindings.svg?style=flat-square)](https://github.com/flexnetos/deflex.net/blob/main/LICENSE)
...
`@deflex.net/nt-napi-bindings` is a high-performance Node.js native addon that provides TypeScript bindings for the [`nt-napi-bindings`](https://crates.io/crates/nt-napi-bindings) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
- **License**: MIT
- **Rust Crate**: [nt-napi-bindings](https://crates.io/crates/nt-napi-bindings)
...
```bash
npm install @deflex.net/nt-napi-bindings
```

### Using yarn

```bash
yarn add @deflex.net/nt-napi-bindings
```

### Using pnpm

```bash
pnpm add @deflex.net/nt-napi-bindings
```
...
- **Linux x64**: `@deflex.net/nt-napi-bindings-linux-x64-gnu`
- **Linux ARM64**: `@deflex.net/nt-napi-bindings-linux-arm64-gnu`
- **macOS x64**: `@deflex.net/nt-napi-bindings-darwin-x64`
- **macOS ARM64**: `@deflex.net/nt-napi-bindings-darwin-arm64`
- **Windows x64**: `@deflex.net/nt-napi-bindings-win32-x64-msvc`
- **WebAssembly**: `@deflex.net/nt-napi-bindings-wasm32` (fallback)
...
```typescript
import { NtNapiBindings } from '@deflex.net/nt-napi-bindings'

// Create an instance
const client = new NtNapiBindings({
...
```typescript
import { NtNapiBindings, Config } from '@deflex.net/nt-napi-bindings'
...
const client = new NtNapiBindings(config)
```
...
// CommonJS
const { NtNapiBindings } = require('@deflex.net/nt-napi-bindings')
```
...
try {
  ...
  if (error instanceof NtNapiBindingsError) {
...
Creates a new instance of `NtNapiBindings`.

**Parameters:**
- `config` (optional): Configuration object

**Returns:**
- Instance of `NtNapiBindings`
...
```typescript
class NtNapiBindingsError extends Error {
  code: string
  details?: any
}
```
...
```typescript
import { NtNapiBindings, NtNapiBindingsError } from '@deflex.net/nt-napi-bindings'
...
```typescript
import { NtNapiBindings, Config, LogLevel } from '@deflex.net/nt-napi-bindings'
...
cd deflex.net/packages/nt-napi-bindings
...
- **NPM Package**: [@deflex.net/nt-napi-bindings](https://www.npmjs.com/package/@deflex.net/nt-napi-bindings)
- **GitHub Repository**: [flexnetos/deflex.net](https://github.com/flexnetos/deflex.net)
- **Rust Crate**: [nt-napi-bindings](https://crates.io/crates/nt-napi-bindings)
- **Documentation**: [docs.deflex.net/nt-napi-bindings](https://docs.deflex.net/nt-napi-bindings)
...
- Original crate by the [nt-napi-bindings](https://crates.io/crates/nt-napi-bindings) authors

---

## 📊 Stats

![NPM](https://nodei.co/npm/@deflex.net/nt-napi-bindings.png?downloads=true&downloadRank=true&stars=true)
