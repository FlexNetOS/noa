...
[![npm version](https://img.shields.io/npm/v/@deflex.net/qudag.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/qudag)
[![npm downloads](https://img.shields.io/npm/dm/@deflex.net/qudag.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/qudag)
[![license](https://img.shields.io/npm/l/@deflex.net/qudag.svg?style=flat-square)](https://github.com/flexnetos/deflex.net/blob/main/LICENSE)
...
`@deflex.net/qudag` is a high-performance Node.js native addon that provides TypeScript bindings for the [`qudag`](https://crates.io/crates/qudag) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
- **License**: MIT
- **Rust Crate**: [qudag](https://crates.io/crates/qudag)
...
```bash
npm install @deflex.net/qudag
```

### Using yarn

```bash
yarn add @deflex.net/qudag
```

### Using pnpm

```bash
pnpm add @deflex.net/qudag
```
...
- **Linux x64**: `@deflex.net/qudag-linux-x64-gnu`
- **Linux ARM64**: `@deflex.net/qudag-linux-arm64-gnu`
- **macOS x64**: `@deflex.net/qudag-darwin-x64`
- **macOS ARM64**: `@deflex.net/qudag-darwin-arm64`
- **Windows x64**: `@deflex.net/qudag-win32-x64-msvc`
- **WebAssembly**: `@deflex.net/qudag-wasm32` (fallback)
...
```typescript
import { Qudag } from '@deflex.net/qudag'

// Create an instance
const client = new Qudag({
...
```typescript
import { Qudag, Config } from '@deflex.net/qudag'
...
// CommonJS
const { Qudag } = require('@deflex.net/qudag')
```
...
Creates a new instance of `Qudag`.
...
```typescript
import { Qudag, QudagError } from '@deflex.net/qudag'
...
```typescript
import { Qudag, Config, LogLevel } from '@deflex.net/qudag'
...
- **NPM Package**: [@deflex.net/qudag](https://www.npmjs.com/package/@deflex.net/qudag)
- **GitHub Repository**: [flexnetos/deflex.net](https://github.com/flexnetos/deflex.net)
- **Rust Crate**: [qudag](https://crates.io/crates/qudag)
- **Documentation**: [docs.deflex.net/qudag](https://docs.deflex.net/qudag)
...
- Original crate by the [qudag](https://crates.io/crates/qudag) authors

---

## 📊 Stats

![NPM](https://nodei.co/npm/@deflex.net/qudag.png?downloads=true&downloadRank=true&stars=true)
