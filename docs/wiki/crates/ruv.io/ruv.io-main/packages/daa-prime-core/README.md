# 📦 @deflex.net/daa-prime-core

> Core shared structures and protocol definitions for Prime distributed ML framework

[![npm version](https://img.shields.io/npm/v/@deflex.net/daa-prime-core.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/daa-prime-core)
[![npm downloads](https://img.shields.io/npm/dm/@deflex.net/daa-prime-core.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/daa-prime-core)
[![license](https://img.shields.io/npm/l/@deflex.net/daa-prime-core.svg?style=flat-square)](https://github.com/flexnetos/deflex.net/blob/main/LICENSE)
...
`@deflex.net/daa-prime-core` is a high-performance Node.js native addon that provides TypeScript bindings for the [`daa-prime-core`](https://crates.io/crates/daa-prime-core) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
- **Categories**: General
- **License**: MIT
- **Rust Crate**: [daa-prime-core](https://crates.io/crates/daa-prime-core)
...
```bash
npm install @deflex.net/daa-prime-core
```

### Using yarn

```bash
yarn add @deflex.net/daa-prime-core
```

### Using pnpm

```bash
pnpm add @deflex.net/daa-prime-core
```
...
- **Linux x64**: `@deflex.net/daa-prime-core-linux-x64-gnu`
- **Linux ARM64**: `@deflex.net/daa-prime-core-linux-arm64-gnu`
- **macOS x64**: `@deflex.net/daa-prime-core-darwin-x64`
- **macOS ARM64**: `@deflex.net/daa-prime-core-darwin-arm64`
- **Windows x64**: `@deflex.net/daa-prime-core-win32-x64-msvc`
- **WebAssembly**: `@deflex.net/daa-prime-core-wasm32` (fallback)
...
```typescript
import { DaaPrimeCore } from '@deflex.net/daa-prime-core'
...
```typescript
import { DaaPrimeCore, Config } from '@deflex.net/daa-prime-core'
...
const client = new DaaPrimeCore(config)
```
...
// CommonJS
const { DaaPrimeCore } = require('@deflex.net/daa-prime-core')
```
...
try {
  ...
  if (error instanceof DaaPrimeCoreError) {
...
Creates a new instance of `DaaPrimeCore`.

**Parameters:**
- `config` (optional): Configuration object

**Returns:**
- Instance of `DaaPrimeCore`
...
```typescript
class DaaPrimeCoreError extends Error {
  code: string
  details?: any
}
```
...
```typescript
import { DaaPrimeCore, DaaPrimeCoreError } from '@deflex.net/daa-prime-core'
...
```typescript
import { DaaPrimeCore, Config, LogLevel } from '@deflex.net/daa-prime-core'
...
cd deflex.net/packages/daa-prime-core
...
- **NPM Package**: [@deflex.net/daa-prime-core](https://www.npmjs.com/package/@deflex.net/daa-prime-core)
- **GitHub Repository**: [flexnetos/deflex.net](https://github.com/flexnetos/deflex.net)
- **Rust Crate**: [daa-prime-core](https://crates.io/crates/daa-prime-core)
- **Documentation**: [docs.deflex.net/daa-prime-core](https://docs.deflex.net/daa-prime-core)
...
- Original crate by the [daa-prime-core](https://crates.io/crates/daa-prime-core) authors

---

## 📊 Stats

![NPM](https://nodei.co/npm/@deflex.net/daa-prime-core.png?downloads=true&downloadRank=true&stars=true)
