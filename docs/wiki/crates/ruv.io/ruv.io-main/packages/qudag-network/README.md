# ⚛️ @deflex.net/qudag-network

> P2P networking layer for QuDAG - LibP2P with onion routing, dark addressing, and quantum encryption

[![npm version](https://img.shields.io/npm/v/@deflex.net/qudag-network.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/qudag-network)
[![npm downloads](https://img.shields.io/npm/dm/@deflex.net/qudag-network.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/qudag-network)
[![license](https://img.shields.io/npm/l/@deflex.net/qudag-network.svg?style=flat-square)](https://github.com/flexnetos/deflex.net/blob/main/LICENSE)
...
`@deflex.net/qudag-network` is a high-performance Node.js native addon that provides TypeScript bindings for the [`qudag-network`](https://crates.io/crates/qudag-network) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
```bash
npm install @deflex.net/qudag-network
```

### Using yarn

```bash
yarn add @deflex.net/qudag-network
```

### Using pnpm

```bash
pnpm add @deflex.net/qudag-network
```
...
- **Linux x64**: `@deflex.net/qudag-network-linux-x64-gnu`
- **Linux ARM64**: `@deflex.net/qudag-network-linux-arm64-gnu`
- **macOS x64**: `@deflex.net/qudag-network-darwin-x64`
- **macOS ARM64**: `@deflex.net/qudag-network-darwin-arm64`
- **Windows x64**: `@deflex.net/qudag-network-win32-x64-msvc`
- **WebAssembly**: `@deflex.net/qudag-network-wasm32` (fallback)
...
```typescript
import { QudagNetwork } from '@deflex.net/qudag-network'
...
```typescript
import { QudagNetwork, Config } from '@deflex.net/qudag-network'
...
// CommonJS
const { QudagNetwork } = require('@deflex.net/qudag-network')
```
...
```typescript
import { QudagNetwork, QudagNetworkError } from '@deflex.net/qudag-network'
...
```typescript
import { QudagNetwork, Config, LogLevel } from '@deflex.net/qudag-network'
...
cd deflex.net/packages/qudag-network
...
- **NPM Package**: [@deflex.net/qudag-network](https://www.npmjs.com/package/@deflex.net/qudag-network)
- **GitHub Repository**: [flexnetos/deflex.net](https://github.com/flexnetos/deflex.net)
- **Rust Crate**: [qudag-network](https://crates.io/crates/qudag-network)
- **Documentation**: [docs.deflex.net/qudag-network](https://docs.deflex.net/qudag-network)
...
![NPM](https://nodei.co/npm/@deflex.net/qudag-network.png?downloads=true&downloadRank=true&stars=true)
