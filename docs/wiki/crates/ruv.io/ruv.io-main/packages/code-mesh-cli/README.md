# 🐝 @deflex.net/code-mesh-cli

> Command-line interface for the Code-Mesh distributed swarm intelligence system

[![npm version](https://img.shields.io/npm/v/@deflex.net/code-mesh-cli.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/code-mesh-cli)
[![npm downloads](https://img.shields.io/npm/dm/@deflex.net/code-mesh-cli.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/code-mesh-cli)
[![license](https://img.shields.io/npm/l/@deflex.net/code-mesh-cli.svg?style=flat-square)](https://github.com/flexnetos/deflex.net/blob/main/LICENSE)
...
`@deflex.net/code-mesh-cli` is a high-performance Node.js native addon that provides TypeScript bindings for the [`code-mesh-cli`](https://crates.io/crates/code-mesh-cli) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
- **License**: MIT
- **Rust Crate**: [code-mesh-cli](https://crates.io/crates/code-mesh-cli)
...
```bash
npm install @deflex.net/code-mesh-cli
```

### Using yarn

```bash
yarn add @deflex.net/code-mesh-cli
```

### Using pnpm

```bash
pnpm add @deflex.net/code-mesh-cli
```
...
- **Linux x64**: `@deflex.net/code-mesh-cli-linux-x64-gnu`
- **Linux ARM64**: `@deflex.net/code-mesh-cli-linux-arm64-gnu`
- **macOS x64**: `@deflex.net/code-mesh-cli-darwin-x64`
- **macOS ARM64**: `@deflex.net/code-mesh-cli-darwin-arm64`
- **Windows x64**: `@deflex.net/code-mesh-cli-win32-x64-msvc`
- **WebAssembly**: `@deflex.net/code-mesh-cli-wasm32` (fallback)
...
```typescript
import { CodeMeshCli } from '@deflex.net/code-mesh-cli'

// Create an instance
const client = new CodeMeshCli({
...
```typescript
import { CodeMeshCli, Config } from '@deflex.net/code-mesh-cli'
...
const client = new CodeMeshCli(config)
```
...
// CommonJS
const { CodeMeshCli } = require('@deflex.net/code-mesh-cli')
```
...
try {
  ...
  if (error instanceof CodeMeshCliError) {
...
Creates a new instance of `CodeMeshCli`.

**Parameters:**
- `config` (optional): Configuration object

**Returns:**
- Instance of `CodeMeshCli`
...
```typescript
class CodeMeshCliError extends Error {
  code: string
  details?: any
}
```
...
```typescript
import { CodeMeshCli, CodeMeshCliError } from '@deflex.net/code-mesh-cli'
...
```typescript
import { CodeMeshCli, Config, LogLevel } from '@deflex.net/code-mesh-cli'
...
cd deflex.net/packages/code-mesh-cli
...
- **NPM Package**: [@deflex.net/code-mesh-cli](https://www.npmjs.com/package/@deflex.net/code-mesh-cli)
- **GitHub Repository**: [flexnetos/deflex.net](https://github.com/flexnetos/deflex.net)
- **Rust Crate**: [code-mesh-cli](https://crates.io/crates/code-mesh-cli)
- **Documentation**: [docs.deflex.net/code-mesh-cli](https://docs.deflex.net/code-mesh-cli)
...
- Original crate by the [code-mesh-cli](https://crates.io/crates/code-mesh-cli) authors

---

## 📊 Stats

![NPM](https://nodei.co/npm/@deflex.net/code-mesh-cli.png?downloads=true&downloadRank=true&stars=true)
