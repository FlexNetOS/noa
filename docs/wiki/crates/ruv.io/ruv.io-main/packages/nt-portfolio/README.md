# 📦 @deflex.net/nt-portfolio

> Portfolio management and tracking for Neural Trader - positions, P&L, performance analytics

[![npm version](https://img.shields.io/npm/v/@deflex.net/nt-portfolio.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/nt-portfolio)
[![npm downloads](https://img.shields.io/npm/dm/@deflex.net/nt-portfolio.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/nt-portfolio)
[![license](https://img.shields.io/npm/l/@deflex.net/nt-portfolio.svg?style=flat-square)](https://github.com/flexnetos/deflex.net/blob/main/LICENSE)
...
`@deflex.net/nt-portfolio` is a high-performance Node.js native addon that provides TypeScript bindings for the [`nt-portfolio`](https://crates.io/crates/nt-portfolio) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
- **License**: MIT
- **Rust Crate**: [nt-portfolio](https://crates.io/crates/nt-portfolio)
...
```bash
npm install @deflex.net/nt-portfolio
```

### Using yarn

```bash
yarn add @deflex.net/nt-portfolio
```

### Using pnpm

```bash
pnpm add @deflex.net/nt-portfolio
```
...
- **Linux x64**: `@deflex.net/nt-portfolio-linux-x64-gnu`
- **Linux ARM64**: `@deflex.net/nt-portfolio-linux-arm64-gnu`
- **macOS x64**: `@deflex.net/nt-portfolio-darwin-x64`
- **macOS ARM64**: `@deflex.net/nt-portfolio-darwin-arm64`
- **Windows x64**: `@deflex.net/nt-portfolio-win32-x64-msvc`
- **WebAssembly**: `@deflex.net/nt-portfolio-wasm32` (fallback)
...
```typescript
import { NtPortfolio } from '@deflex.net/nt-portfolio'

// Create an instance
const client = new NtPortfolio({
...
```typescript
import { NtPortfolio, Config } from '@deflex.net/nt-portfolio'
...
const client = new NtPortfolio(config)
```
...
// CommonJS
const { NtPortfolio } = require('@deflex.net/nt-portfolio')
```
...
try {
  ...
  if (error instanceof NtPortfolioError) {
...
Creates a new instance of `NtPortfolio`.

**Parameters:**
- `config` (optional): Configuration object

**Returns:**
- Instance of `NtPortfolio`
...
```typescript
class NtPortfolioError extends Error {
  code: string
  details?: any
}
```
...
```typescript
import { NtPortfolio, NtPortfolioError } from '@deflex.net/nt-portfolio'
...
```typescript
import { NtPortfolio, Config, LogLevel } from '@deflex.net/nt-portfolio'
...
cd deflex.net/packages/nt-portfolio
...
- **NPM Package**: [@deflex.net/nt-portfolio](https://www.npmjs.com/package/@deflex.net/nt-portfolio)
- **GitHub Repository**: [flexnetos/deflex.net](https://github.com/flexnetos/deflex.net)
- **Rust Crate**: [nt-portfolio](https://crates.io/crates/nt-portfolio)
- **Documentation**: [docs.deflex.net/nt-portfolio](https://docs.deflex.net/nt-portfolio)
...
- Original crate by the [nt-portfolio](https://crates.io/crates/nt-portfolio) authors

---

## 📊 Stats

![NPM](https://nodei.co/npm/@deflex.net/nt-portfolio.png?downloads=true&downloadRank=true&stars=true)
