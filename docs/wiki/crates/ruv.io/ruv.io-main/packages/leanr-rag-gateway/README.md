# 📝 @deflex.net/leanr-rag-gateway

> Multi-lane RAG gateway with cost routing and verified safety proofs using lean-agentic

[![npm version](https://img.shields.io/npm/v/@deflex.net/leanr-rag-gateway.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/leanr-rag-gateway)
[![npm downloads](https://img.shields.io/npm/dm/@deflex.net/leanr-rag-gateway.svg?style=flat-square)](https://www.npmjs.com/package/@deflex.net/leanr-rag-gateway)
[![license](https://img.shields.io/npm/l/@deflex.net/leanr-rag-gateway.svg?style=flat-square)](https://github.com/flexnetos/deflex.net/blob/main/LICENSE)
...
`@deflex.net/leanr-rag-gateway` is a high-performance Node.js native addon that provides TypeScript bindings for the [`leanr-rag-gateway`](https://crates.io/crates/leanr-rag-gateway) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
- **License**: MIT
- **Rust Crate**: [leanr-rag-gateway](https://crates.io/crates/leanr-rag-gateway)
...
```bash
npm install @deflex.net/leanr-rag-gateway
```

### Using yarn

```bash
yarn add @deflex.net/leanr-rag-gateway
```

### Using pnpm

```bash
pnpm add @deflex.net/leanr-rag-gateway
```
...
- **Linux x64**: `@deflex.net/leanr-rag-gateway-linux-x64-gnu`
- **Linux ARM64**: `@deflex.net/leanr-rag-gateway-linux-arm64-gnu`
- **macOS x64**: `@deflex.net/leanr-rag-gateway-darwin-x64`
- **macOS ARM64**: `@deflex.net/leanr-rag-gateway-darwin-arm64`
- **Windows x64**: `@deflex.net/leanr-rag-gateway-win32-x64-msvc`
- **WebAssembly**: `@deflex.net/leanr-rag-gateway-wasm32` (fallback)
...
```typescript
import { LeanrRagGateway } from '@deflex.net/leanr-rag-gateway'
...
try {
  ...
  if (error instanceof LeanrRagGatewayError) {
...
#### `LeanrRagGatewayError`

Base error class for all errors thrown by this package.

```typescript
class LeanrRagGatewayError extends Error {
  code: string
  details?: any
}
```
...
```typescript
import { LeanrRagGateway, LeanrRagGatewayError } from '@deflex.net/leanr-rag-gateway'
...
cd deflex.net/packages/leanr-rag-gateway
...
- **NPM Package**: [@deflex.net/leanr-rag-gateway](https://www.npmjs.com/package/@deflex.net/leanr-rag-gateway)
- **GitHub Repository**: [flexnetos/deflex.net](https://github.com/flexnetos/deflex.net)
- **Rust Crate**: [leanr-rag-gateway](https://crates.io/crates/leanr-rag-gateway)
- **Documentation**: [docs.deflex.net/leanr-rag-gateway](https://docs.deflex.net/leanr-rag-gateway)
...
- Original crate by the [leanr-rag-gateway](https://crates.io/crates/leanr-rag-gateway) authors

---

## 📊 Stats

![NPM](https://nodei.co/npm/@deflex.net/leanr-rag-gateway.png?downloads=true&downloadRank=true&stars=true)
