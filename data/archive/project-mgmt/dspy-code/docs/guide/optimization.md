...
DSPy Code automatically understands your intent and routes to the appropriate optimization command. See the [Natural Language Commands](./natural-language-commands.md) guide for more examples.
